...
dependencies {
    testImplementation(project(":dodo-payments-java"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../dodo-payments-java-core/src/main/resources/META-INF/proguard/dodo-payments-java-core.pro")
}
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../dodo-payments-java-core/src/main/resources/META-INF/proguard/dodo-payments-java-core.pro",
