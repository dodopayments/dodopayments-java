...
## [1.101.0](https://github.com/dodopayments/dodopayments-java/compare/v1.99.2...v1.101.0) (2026-06-01)


### Features

* **api:** regenerate SDK from latest OpenAPI spec (1.101.0) ([551092c](https://github.com/dodopayments/dodopayments-java/commit/551092c8a9d0e2445ae93d965f8d1905e4bb47ac))


### Chores

* re-seal custom code for 1.101.0 spec (python/go/typescript/kotlin/ruby/php) ([ed9d2bc](https://github.com/dodopayments/dodopayments-java/commit/ed9d2bc172caed9afefada35da2a61cb281b0b72))
* release 1.101.0 ([808dcdd](https://github.com/dodopayments/dodopayments-java/commit/808dcddad87b76c3a75fdbca3b5f6f7b91458522))
...
* **api:** manual updates ([94a10ae](https://github.com/dodopayments/dodopayments-java/commit/94a10aef2940188c97fb6ce97fedce16e516de20))
* **api:** updated openapi spec to 1.98.0 ([7019e4f](https://github.com/dodopayments/dodopayments-java/commit/7019e4f778a39dfb7b9e00814d4cd4802917743c))
* **api:** updated openapi spec to v1.97.10 ([546be52](https://github.com/dodopayments/dodopayments-java/commit/546be52be70e4da225471d599644bc0c2ec36bf7))


### Chores

* redact api-key headers in debug logs ([db22497](https://github.com/dodopayments/dodopayments-java/commit/db224975c2b9fe3160de35d094111f724037c141))

## 1.97.1 (2026-05-07)

Full Changelog: [v1.97.1...v1.97.1](https://github.com/dodopayments/dodopayments-java/compare/v1.97.1...v1.97.1)

### Features

* **client:** improve logging ([ca30396](https://github.com/dodopayments/dodopayments-java/commit/ca30396e866d44deb9b7a267eb0dfa5902b17fe5))
* **client:** more robust error parsing ([f21c80f](https://github.com/dodopayments/dodopayments-java/commit/f21c80ff1d4c5f37f237c087c7f192a73e5f9020))
* **client:** support proxy authentication ([6db7943](https://github.com/dodopayments/dodopayments-java/commit/6db7943a9a03acac5f6341a3dab2dd65e757e250))


### Performance Improvements

* **client:** create one json mapper ([9c7ea26](https://github.com/dodopayments/dodopayments-java/commit/9c7ea26fe12ea6ed718fc355e5a0a765d7b804d5))


### Chores

* remove duplicated dokka setup ([397a03e](https://github.com/dodopayments/dodopayments-java/commit/397a03ee97b04a87df35d11ee1252e752269595d))


### Documentation

* clarify forwards compat behavior ([7b03986](https://github.com/dodopayments/dodopayments-java/commit/7b03986bf2199cf2f6a82d5f9ac6a861eebdc7fc))

## 1.97.1 (2026-05-04)

Full Changelog: [v1.97.0...v1.97.1](https://github.com/dodopayments/dodopayments-java/compare/v1.97.0...v1.97.1)

### Features

* **api:** update openapi spec ([8537972](https://github.com/dodopayments/dodopayments-java/commit/8537972046344da02a8600c38385cb2961368b09))
...
* **internal:** codegen related update ([860231f](https://github.com/dodopayments/dodopayments-java/commit/860231fe3f3f7b7dcede3dfcf336d7605679a289))
...
* **api:** update openapi spec to v1.95.3 ([7ae842c](https://github.com/dodopayments/dodopayments-java/commit/7ae842cfdb50fac834bb62ee47b30827e3eca211))

## 1.94.0 (2026-04-08)

Full Changelog: [v1.93.0...v1.94.0](https://github.com/dodopayments/dodopayments-java/compare/v1.93.0...v1.94.0)

### Features

* **api:** updated openapi spec to v1.94.2 ([f9d3e4b](https://github.com/dodopayments/dodopayments-java/commit/f9d3e4bc4f34df1551c2ad4c0260e03af613c01b))
...
* **client:** allow updating header/query affecting fields in `toBuilder()` ([744b3bd](https://github.com/dodopayments/dodopayments-java/commit/744b3bda5dd8f136b4642a6287244ef67b53f62f))
...
* **internal:** bump ktfmt ([fe29bdb](https://github.com/dodopayments/dodopayments-java/commit/fe29bdb062d51c26f4ec5b92b88df516414c4424))
* **internal:** tweak CI branches ([74ac2e2](https://github.com/dodopayments/dodopayments-java/commit/74ac2e2fd9385664a71c3c413258c8fc735a4603))
* **internal:** update retry delay tests ([5ad7626](https://github.com/dodopayments/dodopayments-java/commit/5ad762695bc50e640be691a475fb577d034d30b2))
* **tests:** bump steady to v0.19.4 ([a477f87](https://github.com/dodopayments/dodopayments-java/commit/a477f87bc900ce6f2721a1d9eaa9e23d9300520e))
* **tests:** bump steady to v0.19.5 ([117e0f0](https://github.com/dodopayments/dodopayments-java/commit/117e0f07a0e9a92c4a08ed9d34bc73ea47ab83eb))


### Refactors

* **tests:** switch from prism to steady ([791fa37](https://github.com/dodopayments/dodopayments-java/commit/791fa3793caf737ef752fa3bf916326aad11a725))
...
* **internal:** bump palantir-java-format ([ddb93a7](https://github.com/dodopayments/dodopayments-java/commit/ddb93a75ef91cfdafdd3cbda93cfec14da9e0ba8))
* **internal:** codegen related update ([f433620](https://github.com/dodopayments/dodopayments-java/commit/f4336209ccb13c8973ddfe028d34fb77c02d7967))
* **test:** do not count install time for mock server timeout ([037b5fb](https://github.com/dodopayments/dodopayments-java/commit/037b5fb387df258b8a4da3aaef3f22c67ca59b0a))

## 1.87.0 (2026-03-05)

Full Changelog: [v1.86.3...v1.87.0](https://github.com/dodopayments/dodopayments-java/compare/v1.86.3...v1.87.0)

### Features

* **api:** updated openapi spec to v1.87.0 ([f72c865](https://github.com/dodopayments/dodopayments-java/commit/f72c8658056a68d5e5428e7ec84429b873204946))
...
* **api:** updated to openapi spec v1.86.0 ([ce914f2](https://github.com/dodopayments/dodopayments-java/commit/ce914f2a319f165065204ae20690890a07890a21))
...
* **api:** add webhook signature verification ([9919161](https://github.com/dodopayments/dodopayments-java/commit/99191617d5a354e7792a4dbd2e4b7d5417e6849c))


### Chores

* **internal:** upgrade AssertJ ([90fb5d8](https://github.com/dodopayments/dodopayments-java/commit/90fb5d83fe1d1e2c314dcd5bfe43373d022459ca))

## 1.81.0 (2026-02-06)

Full Changelog: [v1.78.0...v1.81.0](https://github.com/dodopayments/dodopayments-java/compare/v1.78.0...v1.81.0)

### Features

* **api:** updated openapi spec to v1.81.0 ([0879803](https://github.com/dodopayments/dodopayments-java/commit/087980314d6c5c2a1eca04662e643927c2796328))

## 1.78.0 (2026-02-02)

Full Changelog: [v1.75.2...v1.78.0](https://github.com/dodopayments/dodopayments-java/compare/v1.75.2...v1.78.0)

### Features

* **api:** updated openapi spec for v1.78.1 ([5942255](https://github.com/dodopayments/dodopayments-java/commit/5942255ea7e5098f4c7d8191a8e33112428744b3))
