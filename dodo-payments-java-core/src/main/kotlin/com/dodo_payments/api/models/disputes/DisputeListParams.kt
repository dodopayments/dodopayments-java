...
private constructor(
    ...
    class DisputeStage @JsonCreator private constructor(private val value: JsonField<String>) :
        ...
        companion object {
            ...
            @JvmField val PRE_DISPUTE = of("pre_dispute")

            @JvmField val DISPUTE = of("dispute")

            @JvmField val PRE_ARBITRATION = of("pre_arbitration")

            @JvmStatic fun of(value: String) = DisputeStage(JsonField.of(value))
        }
    ...
    class DisputeStatus @JsonCreator private constructor(private val value: JsonField<String>) :
        ...
        companion object {
            ...
            @JvmField val DISPUTE_OPENED = of("dispute_opened")

            @JvmField val DISPUTE_EXPIRED = of("dispute_expired")

            @JvmField val DISPUTE_ACCEPTED = of("dispute_accepted")

            @JvmField val DISPUTE_CANCELLED = of("dispute_cancelled")

            @JvmField val DISPUTE_CHALLENGED = of("dispute_challenged")

            @JvmField val DISPUTE_WON = of("dispute_won")

            @JvmField val DISPUTE_LOST = of("dispute_lost")

            @JvmStatic fun of(value: String) = DisputeStatus(JsonField.of(value))
        }
