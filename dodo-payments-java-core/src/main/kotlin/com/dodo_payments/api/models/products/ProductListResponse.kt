...
private constructor(
    ...
    fun priceDetail(): Optional<PriceDetail> =
    ...
    class Builder internal constructor() {
        ...
        fun priceDetail(priceDetail: Optional<PriceDetail>) = priceDetail(priceDetail.getOrNull())
    ...
    private constructor(
        ...
        fun oneTimePrice(): Optional<OneTimePrice> = Optional.ofNullable(oneTimePrice)

        fun recurringPrice(): Optional<RecurringPrice> = Optional.ofNullable(recurringPrice)
        ...
        private constructor(
             ...
             */
            fun payWhatYouWant(): Optional<Boolean> =
                Optional.ofNullable(payWhatYouWant.getNullable("pay_what_you_want"))

            /**
             * A suggested price for the user to pay. This value is only considered if
             * [`pay_what_you_want`](Self::pay_what_you_want) is `true`. Otherwise, it is ignored.
             */
            fun suggestedPrice(): Optional<Long> =
                Optional.ofNullable(suggestedPrice.getNullable("suggested_price"))
        ...
        private constructor(
            ...
            fun trialPeriodDays(): Optional<Long> =
                Optional.ofNullable(trialPeriodDays.getNullable("trial_period_days"))
