...
private constructor(
    ...
    private constructor(
         ...
         * restrictions, send empty array
         */
        fun restrictedTo(): Optional<List<String>> =
            Optional.ofNullable(restrictedTo.getNullable("restricted_to"))

        fun type(): Optional<DiscountType> = Optional.ofNullable(type.getNullable("type"))

        fun usageLimit(): Optional<Long> =
            Optional.ofNullable(usageLimit.getNullable("usage_limit"))
