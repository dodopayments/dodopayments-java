...
private constructor(
    ...
    private constructor(
        ...
        fun onDemand(): Optional<OnDemand> = Optional.ofNullable(onDemand.getNullable("on_demand"))
    ...
    private constructor(
         ...
         */
        fun productPrice(): Optional<Long> =
            Optional.ofNullable(productPrice.getNullable("product_price"))
