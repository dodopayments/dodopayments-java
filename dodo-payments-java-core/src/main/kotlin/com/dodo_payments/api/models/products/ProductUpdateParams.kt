...
private constructor(
    ...
    private constructor(
        ...
        fun licenseKeyDuration(): Optional<LicenseKeyDuration> =
            Optional.ofNullable(licenseKeyDuration.getNullable("license_key_duration"))
        ...
        fun licenseKeyEnabled(): Optional<Boolean> =
            Optional.ofNullable(licenseKeyEnabled.getNullable("license_key_enabled"))
         ...
         * services.
         */
        fun taxCategory(): Optional<TaxCategory> =
            Optional.ofNullable(taxCategory.getNullable("tax_category"))
