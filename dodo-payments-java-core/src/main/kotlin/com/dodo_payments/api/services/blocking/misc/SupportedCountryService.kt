...
interface SupportedCountryService {
    ...
    fun list(): List<CountryCode> = list(SupportedCountryListParams.none())
    ...
    fun list(
        params: SupportedCountryListParams = SupportedCountryListParams.none()
    ): List<CountryCode> = list(params, RequestOptions.none())
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun list(): HttpResponseFor<List<CountryCode>> = list(SupportedCountryListParams.none())
        ...
        fun list(
            params: SupportedCountryListParams = SupportedCountryListParams.none()
        ): HttpResponseFor<List<CountryCode>> = list(params, RequestOptions.none())
