...
/**
 * A client for interacting with the Dodo Payments REST API synchronously.
...
interface DodoPaymentsClient {
    ...
    interface WithRawResponse {
         ...
         * The original service is not modified.
         */
        fun withOptions(modifier: Consumer<ClientOptions.Builder>): DodoPaymentsClient.WithRawResponse
