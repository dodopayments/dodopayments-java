...
/**
 * A client for interacting with the Dodo Payments REST API asynchronously.
...
interface DodoPaymentsClientAsync {
     ...
     */
    fun withOptions(modifier: Consumer<ClientOptions.Builder>): DodoPaymentsClientAsync
    ...
    /** A view of [DodoPaymentsClientAsync] that provides access to raw HTTP responses for each method. */
    interface WithRawResponse {
         ...
         * The original service is not modified.
         */
        fun withOptions(modifier: Consumer<ClientOptions.Builder>): DodoPaymentsClientAsync.WithRawResponse
