...
class CheckoutSessionPreviewResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("billing_country") @ExcludeMissing billingCountry: JsonField<CountryCode> = JsonMissing.of(),
        @JsonProperty("currency") @ExcludeMissing currency: JsonField<Currency> = JsonMissing.of(),
        @JsonProperty("current_breakup") @ExcludeMissing currentBreakup: JsonField<CurrentBreakup> = JsonMissing.of(),
        @JsonProperty("product_cart") @ExcludeMissing productCart: JsonField<List<ProductCart>> = JsonMissing.of(),
        @JsonProperty("total_price") @ExcludeMissing totalPrice: JsonField<Int> = JsonMissing.of(),
        @JsonProperty("recurring_breakup") @ExcludeMissing recurringBreakup: JsonField<RecurringBreakup> = JsonMissing.of(),
        @JsonProperty("tax_id_err_msg") @ExcludeMissing taxIdErrMsg: JsonField<String> = JsonMissing.of(),
     ...
     */
    fun recurringBreakup(): Optional<RecurringBreakup> = recurringBreakup.getOptional("recurring_breakup")
    ...
    @ExcludeMissing
    fun _totalPrice(): JsonField<Int> = totalPrice

    /**
     * Returns the raw JSON value of [recurringBreakup].
     *
     * Unlike [recurringBreakup], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    @ExcludeMissing
    fun _totalTax(): JsonField<Int> = totalTax
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CheckoutSessionPreviewResponse].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(checkoutSessionPreviewResponse: CheckoutSessionPreviewResponse) =
            apply {
                ...
                additionalProperties = checkoutSessionPreviewResponse.additionalProperties.toMutableMap()
            }

        /** Billing country */
        fun billingCountry(billingCountry: CountryCode) = billingCountry(JsonField.of(billingCountry))

        /**
         * Sets [Builder.billingCountry] to an arbitrary JSON value.
         *
         * You should usually call [Builder.billingCountry] with a well-typed [CountryCode] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun billingCountry(billingCountry: JsonField<CountryCode>) =
            apply {
        ...
        /** Breakup of the current payment */
        fun currentBreakup(currentBreakup: CurrentBreakup) = currentBreakup(JsonField.of(currentBreakup))

        /**
         * Sets [Builder.currentBreakup] to an arbitrary JSON value.
         *
         * You should usually call [Builder.currentBreakup] with a well-typed [CurrentBreakup] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun currentBreakup(currentBreakup: JsonField<CurrentBreakup>) =
            apply {
         ...
         *
         * You should usually call [Builder.productCart] with a well-typed `List<ProductCart>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun productCart(productCart: JsonField<List<ProductCart>>) =
            apply {
         ...
         */
        fun addProductCart(productCart: ProductCart) =
            apply {
         ...
         *
         * You should usually call [Builder.totalPrice] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun totalPrice(totalPrice: JsonField<Int>) =
            apply {
                this.totalPrice = totalPrice
            }

        /** Breakup of recurring payments (None for one-time only) */
        fun recurringBreakup(recurringBreakup: RecurringBreakup?) = recurringBreakup(JsonField.ofNullable(recurringBreakup))

        /** Alias for calling [Builder.recurringBreakup] with `recurringBreakup.orElse(null)`. */
        fun recurringBreakup(recurringBreakup: Optional<RecurringBreakup>) = recurringBreakup(recurringBreakup.getOrNull())

        /**
         * Sets [Builder.recurringBreakup] to an arbitrary JSON value.
         *
         * You should usually call [Builder.recurringBreakup] with a well-typed [RecurringBreakup] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun recurringBreakup(recurringBreakup: JsonField<RecurringBreakup>) =
            apply {
         ...
         *
         * You should usually call [Builder.taxIdErrMsg] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun taxIdErrMsg(taxIdErrMsg: JsonField<String>) =
            apply {
                this.taxIdErrMsg = taxIdErrMsg
            }
         ...
         *
         * You should usually call [Builder.totalTax] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun totalTax(totalTax: JsonField<Int>) =
            apply {
     ...
     *   expected type.
     */
    fun validate(): CheckoutSessionPreviewResponse =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (billingCountry.asKnown().getOrNull()?.validity() ?: 0) + (currency.asKnown().getOrNull()?.validity() ?: 0) + (currentBreakup.asKnown().getOrNull()?.validity() ?: 0) + (productCart.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (if (totalPrice.asKnown().isPresent) 1 else 0) + (recurringBreakup.asKnown().getOrNull()?.validity() ?: 0) + (if (taxIdErrMsg.asKnown().isPresent) 1 else 0) + (if (totalTax.asKnown().isPresent) 1 else 0)

    /** Breakup of the current payment */
    class CurrentBreakup @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        @ExcludeMissing
        fun _discount(): JsonField<Int> = discount
        ...
        @ExcludeMissing
        fun _subtotal(): JsonField<Int> = subtotal
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(currentBreakup: CurrentBreakup) =
                apply {
             ...
             *
             * You should usually call [Builder.discount] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun discount(discount: JsonField<Int>) =
                apply {
             ...
             *
             * You should usually call [Builder.subtotal] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun subtotal(subtotal: JsonField<Int>) =
                apply {
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (discount.asKnown().isPresent) 1 else 0) + (if (subtotal.asKnown().isPresent) 1 else 0) + (if (totalAmount.asKnown().isPresent) 1 else 0) + (if (tax.asKnown().isPresent) 1 else 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is CurrentBreakup && discount == other.discount && subtotal == other.subtotal && totalAmount == other.totalAmount && tax == other.tax && additionalProperties == other.additionalProperties
        }

        private val hashCode: Int by lazy { Objects.hash(discount, subtotal, totalAmount, tax, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() = "CurrentBreakup{discount=$discount, subtotal=$subtotal, totalAmount=$totalAmount, tax=$tax, additionalProperties=$additionalProperties}"
    }

    class ProductCart @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        private constructor(
            ...
            @JsonProperty("currency") @ExcludeMissing currency: JsonField<Currency> = JsonMissing.of(),
            @JsonProperty("discounted_price") @ExcludeMissing discountedPrice: JsonField<Int> = JsonMissing.of(),
            @JsonProperty("is_subscription") @ExcludeMissing isSubscription: JsonField<Boolean> = JsonMissing.of(),
            @JsonProperty("is_usage_based") @ExcludeMissing isUsageBased: JsonField<Boolean> = JsonMissing.of(),
            @JsonProperty("meters") @ExcludeMissing meters: JsonField<List<Meter>> = JsonMissing.of(),
            @JsonProperty("og_currency") @ExcludeMissing ogCurrency: JsonField<Currency> = JsonMissing.of(),
            @JsonProperty("og_price") @ExcludeMissing ogPrice: JsonField<Int> = JsonMissing.of(),
            @JsonProperty("product_id") @ExcludeMissing productId: JsonField<String> = JsonMissing.of(),
            @JsonProperty("quantity") @ExcludeMissing quantity: JsonField<Int> = JsonMissing.of(),
            @JsonProperty("tax_category") @ExcludeMissing taxCategory: JsonField<TaxCategory> = JsonMissing.of(),
            ...
            @JsonProperty("discount_amount") @ExcludeMissing discountAmount: JsonField<Int> = JsonMissing.of(),
            @JsonProperty("discount_cycle") @ExcludeMissing discountCycle: JsonField<Int> = JsonMissing.of(),
         ...
         * @throws DodoPaymentsInvalidDataException if the JSON field has an unexpected type or is unexpectedly missing or null (e.g. if the server responded with an unexpected value).
         */
        fun creditEntitlements(): List<CreditEntitlement> = creditEntitlements.getRequired("credit_entitlements")
         ...
         *
         * Unlike [discountedPrice], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [isSubscription], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [isUsageBased], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        @JsonProperty("meters")
        @ExcludeMissing
        fun _meters(): JsonField<List<Meter>> = meters
        ...
        @ExcludeMissing
        fun _ogPrice(): JsonField<Int> = ogPrice
        ...
        @ExcludeMissing
        fun _taxRate(): JsonField<Int> = taxRate
        ...
        @JsonProperty("addons")
        @ExcludeMissing
        fun _addons(): JsonField<List<Addon>> = addons
         ...
         *
         * Unlike [discountCycle], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(productCart: ProductCart) =
                apply {
            ...
            /** Credit entitlements that will be granted upon purchase */
            fun creditEntitlements(creditEntitlements: List<CreditEntitlement>) = creditEntitlements(JsonField.of(creditEntitlements))
            ...
            /** discounted price */
            fun discountedPrice(discountedPrice: Int) = discountedPrice(JsonField.of(discountedPrice))

            /**
             * Sets [Builder.discountedPrice] to an arbitrary JSON value.
             *
             * You should usually call [Builder.discountedPrice] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun discountedPrice(discountedPrice: JsonField<Int>) =
                apply {
                    this.discountedPrice = discountedPrice
                }

            /** Whether this is a subscription product (affects tax calculation in breakup) */
            fun isSubscription(isSubscription: Boolean) = isSubscription(JsonField.of(isSubscription))

            /**
             * Sets [Builder.isSubscription] to an arbitrary JSON value.
             *
             * You should usually call [Builder.isSubscription] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun isSubscription(isSubscription: JsonField<Boolean>) =
                apply {
             ...
             *
             * You should usually call [Builder.isUsageBased] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun isUsageBased(isUsageBased: JsonField<Boolean>) =
                apply {
             ...
             *
             * You should usually call [Builder.meters] with a well-typed `List<Meter>` value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun meters(meters: JsonField<List<Meter>>) =
                apply {
             ...
             *
             * You should usually call [Builder.ogCurrency] with a well-typed [Currency] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun ogCurrency(ogCurrency: JsonField<Currency>) =
                apply {
             ...
             *
             * You should usually call [Builder.ogPrice] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun ogPrice(ogPrice: JsonField<Int>) =
                apply {
             ...
             *
             * You should usually call [Builder.taxCategory] with a well-typed [TaxCategory] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun taxCategory(taxCategory: JsonField<TaxCategory>) =
                apply {
             ...
             *
             * You should usually call [Builder.taxRate] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun taxRate(taxRate: JsonField<Int>) =
                apply {
             ...
             *
             * You should usually call [Builder.addons] with a well-typed `List<Addon>` value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun addons(addons: JsonField<List<Addon>>) =
                apply {
            ...
            /** discount percentage */
            fun discountAmount(discountAmount: Int?) = discountAmount(JsonField.ofNullable(discountAmount))
            ...
            fun discountAmount(discountAmount: Optional<Int>) = discountAmount(discountAmount.getOrNull())

            /**
             * Sets [Builder.discountAmount] to an arbitrary JSON value.
             *
             * You should usually call [Builder.discountAmount] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun discountAmount(discountAmount: JsonField<Int>) =
                apply {
                    this.discountAmount = discountAmount
                }

            /** number of cycles the discount will apply */
            fun discountCycle(discountCycle: Int?) = discountCycle(JsonField.ofNullable(discountCycle))
            ...
            fun discountCycle(discountCycle: Optional<Int>) = discountCycle(discountCycle.getOrNull())

            /**
             * Sets [Builder.discountCycle] to an arbitrary JSON value.
             *
             * You should usually call [Builder.discountCycle] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun discountCycle(discountCycle: JsonField<Int>) =
                apply {
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (creditEntitlements.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (currency.asKnown().getOrNull()?.validity() ?: 0) + (if (discountedPrice.asKnown().isPresent) 1 else 0) + (if (isSubscription.asKnown().isPresent) 1 else 0) + (if (isUsageBased.asKnown().isPresent) 1 else 0) + (meters.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (ogCurrency.asKnown().getOrNull()?.validity() ?: 0) + (if (ogPrice.asKnown().isPresent) 1 else 0) + (if (productId.asKnown().isPresent) 1 else 0) + (if (quantity.asKnown().isPresent) 1 else 0) + (taxCategory.asKnown().getOrNull()?.validity() ?: 0) + (if (taxInclusive.asKnown().isPresent) 1 else 0) + (if (taxRate.asKnown().isPresent) 1 else 0) + (addons.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (if (description.asKnown().isPresent) 1 else 0) + (if (discountAmount.asKnown().isPresent) 1 else 0) + (if (discountCycle.asKnown().isPresent) 1 else 0) + (if (name.asKnown().isPresent) 1 else 0) + (if (tax.asKnown().isPresent) 1 else 0)
        ...
        class CreditEntitlement @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            ...
            private constructor(
                ...
                @JsonProperty("credit_entitlement_unit") @ExcludeMissing creditEntitlementUnit: JsonField<String> = JsonMissing.of(),
             ...
             * @throws DodoPaymentsInvalidDataException if the JSON field has an unexpected type or is unexpectedly missing or null (e.g. if the server responded with an unexpected value).
             */
            fun creditEntitlementUnit(): String = creditEntitlementUnit.getRequired("credit_entitlement_unit")
             ...
             *
             * Unlike [creditEntitlementUnit], this method doesn't throw if the JSON field has an unexpected type.
             */
            ...
            class Builder internal constructor() {
                ...
                /** Unit label (e.g. "API Calls", "Tokens") */
                fun creditEntitlementUnit(creditEntitlementUnit: String) = creditEntitlementUnit(JsonField.of(creditEntitlementUnit))

                /**
                 * Sets [Builder.creditEntitlementUnit] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.creditEntitlementUnit] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun creditEntitlementUnit(creditEntitlementUnit: JsonField<String>) =
                    apply {
                ...
                fun build(): CreditEntitlement =
                    CreditEntitlement(
                      ...
                      checkRequired(
                        "creditEntitlementUnit", creditEntitlementUnit
                      ),
                      checkRequired(
             ...
             */
            @JvmSynthetic
            internal fun validity(): Int = (if (creditEntitlementId.asKnown().isPresent) 1 else 0) + (if (creditEntitlementName.asKnown().isPresent) 1 else 0) + (if (creditEntitlementUnit.asKnown().isPresent) 1 else 0) + (if (creditsAmount.asKnown().isPresent) 1 else 0)
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is CreditEntitlement && creditEntitlementId == other.creditEntitlementId && creditEntitlementName == other.creditEntitlementName && creditEntitlementUnit == other.creditEntitlementUnit && creditsAmount == other.creditsAmount && additionalProperties == other.additionalProperties
            }

            private val hashCode: Int by lazy { Objects.hash(creditEntitlementId, creditEntitlementName, creditEntitlementUnit, creditsAmount, additionalProperties) }

            override fun hashCode(): Int = hashCode

            override fun toString() = "CreditEntitlement{creditEntitlementId=$creditEntitlementId, creditEntitlementName=$creditEntitlementName, creditEntitlementUnit=$creditEntitlementUnit, creditsAmount=$creditsAmount, additionalProperties=$additionalProperties}"
        }
        ...
        class Meter @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
             ...
             */
            @JvmSynthetic
            internal fun validity(): Int = (if (measurementUnit.asKnown().isPresent) 1 else 0) + (if (name.asKnown().isPresent) 1 else 0) + (if (pricePerUnit.asKnown().isPresent) 1 else 0) + (if (description.asKnown().isPresent) 1 else 0) + (if (freeThreshold.asKnown().isPresent) 1 else 0)
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is Meter && measurementUnit == other.measurementUnit && name == other.name && pricePerUnit == other.pricePerUnit && description == other.description && freeThreshold == other.freeThreshold && additionalProperties == other.additionalProperties
            }

            private val hashCode: Int by lazy { Objects.hash(measurementUnit, name, pricePerUnit, description, freeThreshold, additionalProperties) }

            override fun hashCode(): Int = hashCode

            override fun toString() = "Meter{measurementUnit=$measurementUnit, name=$name, pricePerUnit=$pricePerUnit, description=$description, freeThreshold=$freeThreshold, additionalProperties=$additionalProperties}"
        }

        class Addon @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
             ...
             */
            @JvmSynthetic
            internal fun validity(): Int = (if (addonId.asKnown().isPresent) 1 else 0) + (currency.asKnown().getOrNull()?.validity() ?: 0) + (if (discountedPrice.asKnown().isPresent) 1 else 0) + (if (name.asKnown().isPresent) 1 else 0) + (ogCurrency.asKnown().getOrNull()?.validity() ?: 0) + (if (ogPrice.asKnown().isPresent) 1 else 0) + (if (quantity.asKnown().isPresent) 1 else 0) + (taxCategory.asKnown().getOrNull()?.validity() ?: 0) + (if (taxInclusive.asKnown().isPresent) 1 else 0) + (if (taxRate.asKnown().isPresent) 1 else 0) + (if (description.asKnown().isPresent) 1 else 0) + (if (discountAmount.asKnown().isPresent) 1 else 0) + (if (tax.asKnown().isPresent) 1 else 0)
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is Addon && addonId == other.addonId && currency == other.currency && discountedPrice == other.discountedPrice && name == other.name && ogCurrency == other.ogCurrency && ogPrice == other.ogPrice && quantity == other.quantity && taxCategory == other.taxCategory && taxInclusive == other.taxInclusive && taxRate == other.taxRate && description == other.description && discountAmount == other.discountAmount && tax == other.tax && additionalProperties == other.additionalProperties
            }

            private val hashCode: Int by lazy { Objects.hash(addonId, currency, discountedPrice, name, ogCurrency, ogPrice, quantity, taxCategory, taxInclusive, taxRate, description, discountAmount, tax, additionalProperties) }

            override fun hashCode(): Int = hashCode

            override fun toString() = "Addon{addonId=$addonId, currency=$currency, discountedPrice=$discountedPrice, name=$name, ogCurrency=$ogCurrency, ogPrice=$ogPrice, quantity=$quantity, taxCategory=$taxCategory, taxInclusive=$taxInclusive, taxRate=$taxRate, description=$description, discountAmount=$discountAmount, tax=$tax, additionalProperties=$additionalProperties}"
        }
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is ProductCart && creditEntitlements == other.creditEntitlements && currency == other.currency && discountedPrice == other.discountedPrice && isSubscription == other.isSubscription && isUsageBased == other.isUsageBased && meters == other.meters && ogCurrency == other.ogCurrency && ogPrice == other.ogPrice && productId == other.productId && quantity == other.quantity && taxCategory == other.taxCategory && taxInclusive == other.taxInclusive && taxRate == other.taxRate && addons == other.addons && description == other.description && discountAmount == other.discountAmount && discountCycle == other.discountCycle && name == other.name && tax == other.tax && additionalProperties == other.additionalProperties
        }

        private val hashCode: Int by lazy { Objects.hash(creditEntitlements, currency, discountedPrice, isSubscription, isUsageBased, meters, ogCurrency, ogPrice, productId, quantity, taxCategory, taxInclusive, taxRate, addons, description, discountAmount, discountCycle, name, tax, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() = "ProductCart{creditEntitlements=$creditEntitlements, currency=$currency, discountedPrice=$discountedPrice, isSubscription=$isSubscription, isUsageBased=$isUsageBased, meters=$meters, ogCurrency=$ogCurrency, ogPrice=$ogPrice, productId=$productId, quantity=$quantity, taxCategory=$taxCategory, taxInclusive=$taxInclusive, taxRate=$taxRate, addons=$addons, description=$description, discountAmount=$discountAmount, discountCycle=$discountCycle, name=$name, tax=$tax, additionalProperties=$additionalProperties}"
    }

    /** Breakup of recurring payments (None for one-time only) */
    class RecurringBreakup @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        private val discount: JsonField<Int>,
        private val subtotal: JsonField<Int>,
        private val totalAmount: JsonField<Int>,
        private val tax: JsonField<Int>,
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(recurringBreakup: RecurringBreakup) =
                apply {
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is RecurringBreakup && discount == other.discount && subtotal == other.subtotal && totalAmount == other.totalAmount && tax == other.tax && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "RecurringBreakup{discount=$discount, subtotal=$subtotal, totalAmount=$totalAmount, tax=$tax, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is CheckoutSessionPreviewResponse && billingCountry == other.billingCountry && currency == other.currency && currentBreakup == other.currentBreakup && productCart == other.productCart && totalPrice == other.totalPrice && recurringBreakup == other.recurringBreakup && taxIdErrMsg == other.taxIdErrMsg && totalTax == other.totalTax && additionalProperties == other.additionalProperties
    }

    private val hashCode: Int by lazy { Objects.hash(billingCountry, currency, currentBreakup, productCart, totalPrice, recurringBreakup, taxIdErrMsg, totalTax, additionalProperties) }

    override fun hashCode(): Int = hashCode

    override fun toString() = "CheckoutSessionPreviewResponse{billingCountry=$billingCountry, currency=$currency, currentBreakup=$currentBreakup, productCart=$productCart, totalPrice=$totalPrice, recurringBreakup=$recurringBreakup, taxIdErrMsg=$taxIdErrMsg, totalTax=$totalTax, additionalProperties=$additionalProperties}"
}
