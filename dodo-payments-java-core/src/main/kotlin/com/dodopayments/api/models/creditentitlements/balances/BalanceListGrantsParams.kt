 ...
 */
class BalanceListGrantsParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(balanceListGrantsParams: BalanceListGrantsParams) =
            apply {
    ...
    class Status @JsonCreator private constructor(
        ...
        companion object {
            ...
            @JvmField val DEPLETED = of("depleted")
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is BalanceListGrantsParams && creditEntitlementId == other.creditEntitlementId && customerId == other.customerId && pageNumber == other.pageNumber && pageSize == other.pageSize && status == other.status && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(creditEntitlementId, customerId, pageNumber, pageSize, status, additionalHeaders, additionalQueryParams)

    override fun toString() = "BalanceListGrantsParams{creditEntitlementId=$creditEntitlementId, customerId=$customerId, pageNumber=$pageNumber, pageSize=$pageSize, status=$status, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
