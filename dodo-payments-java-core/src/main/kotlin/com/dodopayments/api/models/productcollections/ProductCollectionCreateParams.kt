...
class ProductCollectionCreateParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ProductCollectionCreateParams].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(productCollectionCreateParams: ProductCollectionCreateParams) =
            apply {
        ...
        /** Groups of products in this collection */
        fun groups(groups: List<ProductCollectionGroupDetails>) =
            apply {
                body.groups(groups)
            }
         ...
         *
         * You should usually call [Builder.groups] with a well-typed `List<ProductCollectionGroupDetails>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun groups(groups: JsonField<List<ProductCollectionGroupDetails>>) =
            apply {
                body.groups(groups)
            }
         ...
         */
        fun addGroup(group: ProductCollectionGroupDetails) =
            apply {
                body.addGroup(group)
            }
    ...
    class Body @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        @JsonCreator
        private constructor(
            @JsonProperty("groups") @ExcludeMissing groups: JsonField<List<ProductCollectionGroupDetails>> = JsonMissing.of(),
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (groups.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (if (name.asKnown().isPresent) 1 else 0) + (if (brandId.asKnown().isPresent) 1 else 0) + (if (description.asKnown().isPresent) 1 else 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Body && groups == other.groups && name == other.name && brandId == other.brandId && description == other.description && additionalProperties == other.additionalProperties
        }

        private val hashCode: Int by lazy { Objects.hash(groups, name, brandId, description, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() = "Body{groups=$groups, name=$name, brandId=$brandId, description=$description, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is ProductCollectionCreateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(body, additionalHeaders, additionalQueryParams)

    override fun toString() = "ProductCollectionCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
