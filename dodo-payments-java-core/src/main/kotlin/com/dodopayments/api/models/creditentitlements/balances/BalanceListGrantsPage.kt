...
class BalanceListGrantsPage private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(balanceListGrantsPage: BalanceListGrantsPage) =
            apply {
        ...
        fun service(service: BalanceService) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is BalanceListGrantsPage && service == other.service && params == other.params && response == other.response
    }

    override fun hashCode(): Int = Objects.hash(service, params, response)

    override fun toString() = "BalanceListGrantsPage{service=$service, params=$params, response=$response}"
}
