...
class LicenseKeyListParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(licenseKeyListParams: LicenseKeyListParams) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is LicenseKeyListParams && createdAtGte == other.createdAtGte && createdAtLte == other.createdAtLte && customerId == other.customerId && pageNumber == other.pageNumber && pageSize == other.pageSize && productId == other.productId && source == other.source && status == other.status && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(createdAtGte, createdAtLte, customerId, pageNumber, pageSize, productId, source, status, additionalHeaders, additionalQueryParams)

    override fun toString() = "LicenseKeyListParams{createdAtGte=$createdAtGte, createdAtLte=$createdAtLte, customerId=$customerId, pageNumber=$pageNumber, pageSize=$pageSize, productId=$productId, source=$source, status=$status, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
