...
class CheckoutSessionBillingAddress @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    @ExcludeMissing
    fun _country(): JsonField<CountryCode> = country
    ...
    @ExcludeMissing
    fun _zipcode(): JsonField<String> = zipcode
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CheckoutSessionBillingAddress].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(checkoutSessionBillingAddress: CheckoutSessionBillingAddress) =
            apply {
         ...
         *
         * You should usually call [Builder.country] with a well-typed [CountryCode] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun country(country: JsonField<CountryCode>) =
            apply {
         ...
         *
         * You should usually call [Builder.street] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun street(street: JsonField<String>) =
            apply {
                this.street = street
            }
         ...
         *
         * You should usually call [Builder.zipcode] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun zipcode(zipcode: JsonField<String>) =
            apply {
     ...
     *   expected type.
     */
    fun validate(): CheckoutSessionBillingAddress =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (country.asKnown().getOrNull()?.validity() ?: 0) + (if (city.asKnown().isPresent) 1 else 0) + (if (state.asKnown().isPresent) 1 else 0) + (if (street.asKnown().isPresent) 1 else 0) + (if (zipcode.asKnown().isPresent) 1 else 0)
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is CheckoutSessionBillingAddress && country == other.country && city == other.city && state == other.state && street == other.street && zipcode == other.zipcode && additionalProperties == other.additionalProperties
    }

    private val hashCode: Int by lazy { Objects.hash(country, city, state, street, zipcode, additionalProperties) }

    override fun hashCode(): Int = hashCode

    override fun toString() = "CheckoutSessionBillingAddress{country=$country, city=$city, state=$state, street=$street, zipcode=$zipcode, additionalProperties=$additionalProperties}"
}
