...
class LicenseDeactivateParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(licenseDeactivateParams: LicenseDeactivateParams) =
            apply {
    ...
    class Body @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        /** @throws DodoPaymentsInvalidDataException if the JSON field has an unexpected type or is unexpectedly missing or null (e.g. if the server responded with an unexpected value). */
        fun licenseKeyInstanceId(): String = licenseKeyInstanceId.getRequired("license_key_instance_id")
        ...
        class Builder internal constructor() {
            ...
            fun licenseKeyInstanceId(licenseKeyInstanceId: String) = licenseKeyInstanceId(JsonField.of(licenseKeyInstanceId))
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is LicenseDeactivateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(body, additionalHeaders, additionalQueryParams)

    override fun toString() = "LicenseDeactivateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
