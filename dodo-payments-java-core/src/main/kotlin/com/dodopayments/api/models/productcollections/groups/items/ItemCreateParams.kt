...
class ItemCreateParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        /** Products to add to the group */
        fun products(products: List<GroupProduct>) =
            apply {
    ...
    class Body @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (products.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Body && products == other.products && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "Body{products=$products, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is ItemCreateParams && id == other.id && groupId == other.groupId && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(id, groupId, body, additionalHeaders, additionalQueryParams)

    override fun toString() = "ItemCreateParams{id=$id, groupId=$groupId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
