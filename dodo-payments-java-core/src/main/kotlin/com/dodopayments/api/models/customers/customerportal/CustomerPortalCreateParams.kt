...
class CustomerPortalCreateParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(customerPortalCreateParams: CustomerPortalCreateParams) =
            apply {
                ...
                additionalBodyProperties = customerPortalCreateParams.additionalBodyProperties.toMutableMap()
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is CustomerPortalCreateParams && customerId == other.customerId && returnUrl == other.returnUrl && sendEmail == other.sendEmail && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams && additionalBodyProperties == other.additionalBodyProperties
    }

    override fun hashCode(): Int = Objects.hash(customerId, returnUrl, sendEmail, additionalHeaders, additionalQueryParams, additionalBodyProperties)

    override fun toString() = "CustomerPortalCreateParams{customerId=$customerId, returnUrl=$returnUrl, sendEmail=$sendEmail, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}
