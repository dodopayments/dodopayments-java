...
class EmailFailureCode @JsonCreator private constructor(private val value: JsonField<String>) :
    ...
    companion object {
        ...
        @JvmField val MAILBOX_NOT_FOUND = of("mailbox_not_found")

        @JvmField val ADDRESS_REJECTED = of("address_rejected")

        @JvmField val ADDRESS_SUPPRESSED = of("address_suppressed")

        @JvmField val MAILBOX_FULL = of("mailbox_full")

        @JvmField val TEMPORARY_FAILURE = of("temporary_failure")

        @JvmField val MESSAGE_TOO_LARGE = of("message_too_large")

        @JvmField val MARKED_AS_SPAM = of("marked_as_spam")

        @JvmField val SEND_FAILED = of("send_failed")

        @JvmField val TEST_MODE_QUOTA_SPENT = of("test_mode_quota_spent")

        @JvmStatic fun of(value: String) = EmailFailureCode(JsonField.of(value))
    }
