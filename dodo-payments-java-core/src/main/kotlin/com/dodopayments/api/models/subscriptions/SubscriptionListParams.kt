...
class SubscriptionListParams private constructor(
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is SubscriptionListParams && brandId == other.brandId && createdAtGte == other.createdAtGte && createdAtLte == other.createdAtLte && customerId == other.customerId && pageNumber == other.pageNumber && pageSize == other.pageSize && productId == other.productId && status == other.status && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(brandId, createdAtGte, createdAtLte, customerId, pageNumber, pageSize, productId, status, additionalHeaders, additionalQueryParams)

    override fun toString() = "SubscriptionListParams{brandId=$brandId, createdAtGte=$createdAtGte, createdAtLte=$createdAtLte, customerId=$customerId, pageNumber=$pageNumber, pageSize=$pageSize, productId=$productId, status=$status, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
