...
class GrantListParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(grantListParams: GrantListParams) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is GrantListParams && id == other.id && customerId == other.customerId && pageNumber == other.pageNumber && pageSize == other.pageSize && status == other.status && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(id, customerId, pageNumber, pageSize, status, additionalHeaders, additionalQueryParams)

    override fun toString() = "GrantListParams{id=$id, customerId=$customerId, pageNumber=$pageNumber, pageSize=$pageSize, status=$status, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
