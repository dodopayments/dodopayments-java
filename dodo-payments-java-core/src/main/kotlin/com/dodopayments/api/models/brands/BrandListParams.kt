...
class BrandListParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(brandListParams: BrandListParams) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is BrandListParams && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(additionalHeaders, additionalQueryParams)

    override fun toString() = "BrandListParams{additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
