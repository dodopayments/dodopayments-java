...
private constructor(
     ...
     */
    fun blockedByEmail(): Optional<String> = blockedByEmail.getOptional("blocked_by_email")
     ...
     *   the server responded with an unexpected value).
     */
    fun cancelledSubscriptionIds(): Optional<List<String>> =
        cancelledSubscriptionIds.getOptional("cancelled_subscription_ids")
     ...
     *   the server responded with an unexpected value).
     */
    fun notes(): Optional<List<BlockedCustomerNote>> = notes.getOptional("notes")
     ...
     *   the server responded with an unexpected value).
     */
    fun remainingSubscriptionIds(): Optional<List<String>> =
        remainingSubscriptionIds.getOptional("remaining_subscription_ids")
     ...
     *   the server responded with an unexpected value).
     */
    fun subscriptionsSwept(): Optional<Boolean> =
        subscriptionsSwept.getOptional("subscriptions_swept")

    /**
     * @throws DodoPaymentsInvalidDataException if the JSON field has an unexpected type (e.g. if
     *   the server responded with an unexpected value).
     */
    fun unblockedAt(): Optional<OffsetDateTime> = unblockedAt.getOptional("unblocked_at")
    ...
    class Builder internal constructor() {
        ...
        /** Alias for calling [Builder.blockedByEmail] with `blockedByEmail.orElse(null)`. */
        fun blockedByEmail(blockedByEmail: Optional<String>) =
            blockedByEmail(blockedByEmail.getOrNull())
        ...
        /**
         * Alias for calling [Builder.cancelledSubscriptionIds] with
         * `cancelledSubscriptionIds.orElse(null)`.
         */
        fun cancelledSubscriptionIds(cancelledSubscriptionIds: Optional<List<String>>) =
            cancelledSubscriptionIds(cancelledSubscriptionIds.getOrNull())
        ...
        fun notes(notes: Optional<List<BlockedCustomerNote>>) = notes(notes.getOrNull())
        ...
        /**
         * Alias for calling [Builder.remainingSubscriptionIds] with
         * `remainingSubscriptionIds.orElse(null)`.
         */
        fun remainingSubscriptionIds(remainingSubscriptionIds: Optional<List<String>>) =
            remainingSubscriptionIds(remainingSubscriptionIds.getOrNull())
        ...
        /**
         * Alias for calling [Builder.subscriptionsSwept] with `subscriptionsSwept.orElse(null)`.
         */
        fun subscriptionsSwept(subscriptionsSwept: Optional<Boolean>) =
            subscriptionsSwept(subscriptionsSwept.getOrNull())
        ...
        /** Alias for calling [Builder.unblockedAt] with `unblockedAt.orElse(null)`. */
        fun unblockedAt(unblockedAt: Optional<OffsetDateTime>) =
            unblockedAt(unblockedAt.getOrNull())
    ...
    fun validate(): BlockedCustomer = apply {
        ...
        blockedByEmail()
        cancelledSubscriptionIds()
        notes().ifPresent { it.forEach { it.validate() } }
        reason()
        remainingSubscriptionIds()
        subscriptionsSwept()
        unblockedAt()
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            (if (blockedByEmail.asKnown().isPresent) 1 else 0) +
            (cancelledSubscriptionIds.asKnown().getOrNull()?.size ?: 0) +
            (notes.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) +
            (if (reason.asKnown().isPresent) 1 else 0) +
            (remainingSubscriptionIds.asKnown().getOrNull()?.size ?: 0) +
            (if (subscriptionsSwept.asKnown().isPresent) 1 else 0) +
            (if (unblockedAt.asKnown().isPresent) 1 else 0)
