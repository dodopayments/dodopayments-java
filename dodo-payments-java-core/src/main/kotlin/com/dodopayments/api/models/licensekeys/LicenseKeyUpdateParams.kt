...
class LicenseKeyUpdateParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(licenseKeyUpdateParams: LicenseKeyUpdateParams) =
            apply {
    ...
    class Body @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (activationsLimit.asKnown().isPresent) 1 else 0) + (if (disabled.asKnown().isPresent) 1 else 0) + (if (expiresAt.asKnown().isPresent) 1 else 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Body && activationsLimit == other.activationsLimit && disabled == other.disabled && expiresAt == other.expiresAt && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "Body{activationsLimit=$activationsLimit, disabled=$disabled, expiresAt=$expiresAt, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is LicenseKeyUpdateParams && id == other.id && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(id, body, additionalHeaders, additionalQueryParams)

    override fun toString() = "LicenseKeyUpdateParams{id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
