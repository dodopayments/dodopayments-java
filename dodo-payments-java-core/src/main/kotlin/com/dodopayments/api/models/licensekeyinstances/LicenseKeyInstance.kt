...
class LicenseKeyInstance @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(licenseKeyInstance: LicenseKeyInstance) =
            apply {
     ...
     *   expected type.
     */
    fun validate(): LicenseKeyInstance =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (id.asKnown().isPresent) 1 else 0) + (if (businessId.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (licenseKeyId.asKnown().isPresent) 1 else 0) + (if (name.asKnown().isPresent) 1 else 0)
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is LicenseKeyInstance && id == other.id && businessId == other.businessId && createdAt == other.createdAt && licenseKeyId == other.licenseKeyId && name == other.name && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "LicenseKeyInstance{id=$id, businessId=$businessId, createdAt=$createdAt, licenseKeyId=$licenseKeyId, name=$name, additionalProperties=$additionalProperties}"
}
