...
class ThemeConfig @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("font_primary_url") @ExcludeMissing fontPrimaryUrl: JsonField<String> = JsonMissing.of(),
        @JsonProperty("font_secondary_url") @ExcludeMissing fontSecondaryUrl: JsonField<String> = JsonMissing.of(),
        @JsonProperty("font_size") @ExcludeMissing fontSize: JsonField<FontSize> = JsonMissing.of(),
        @JsonProperty("font_weight") @ExcludeMissing fontWeight: JsonField<FontWeight> = JsonMissing.of(),
        @JsonProperty("light") @ExcludeMissing light: JsonField<ThemeModeConfig> = JsonMissing.of(),
        @JsonProperty("pay_button_text") @ExcludeMissing payButtonText: JsonField<String> = JsonMissing.of(),
    ...
    @JsonProperty("dark")
    @ExcludeMissing
    fun _dark(): JsonField<ThemeModeConfig> = dark
     ...
     *
     * Unlike [fontSecondaryUrl], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    @JsonProperty("light")
    @ExcludeMissing
    fun _light(): JsonField<ThemeModeConfig> = light
    ...
    @JsonProperty("radius")
    @ExcludeMissing
    fun _radius(): JsonField<String> = radius
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(themeConfig: ThemeConfig) =
            apply {
         ...
         *
         * You should usually call [Builder.dark] with a well-typed [ThemeModeConfig] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun dark(dark: JsonField<ThemeModeConfig>) =
            apply {
                this.dark = dark
            }

        /** URL for the primary font. Must be a valid https:// URL. */
        fun fontPrimaryUrl(fontPrimaryUrl: String?) = fontPrimaryUrl(JsonField.ofNullable(fontPrimaryUrl))

        /** Alias for calling [Builder.fontPrimaryUrl] with `fontPrimaryUrl.orElse(null)`. */
        fun fontPrimaryUrl(fontPrimaryUrl: Optional<String>) = fontPrimaryUrl(fontPrimaryUrl.getOrNull())

        /**
         * Sets [Builder.fontPrimaryUrl] to an arbitrary JSON value.
         *
         * You should usually call [Builder.fontPrimaryUrl] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun fontPrimaryUrl(fontPrimaryUrl: JsonField<String>) =
            apply {
                this.fontPrimaryUrl = fontPrimaryUrl
            }

        /** URL for the secondary font. Must be a valid https:// URL. */
        fun fontSecondaryUrl(fontSecondaryUrl: String?) = fontSecondaryUrl(JsonField.ofNullable(fontSecondaryUrl))

        /** Alias for calling [Builder.fontSecondaryUrl] with `fontSecondaryUrl.orElse(null)`. */
        fun fontSecondaryUrl(fontSecondaryUrl: Optional<String>) = fontSecondaryUrl(fontSecondaryUrl.getOrNull())

        /**
         * Sets [Builder.fontSecondaryUrl] to an arbitrary JSON value.
         *
         * You should usually call [Builder.fontSecondaryUrl] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun fontSecondaryUrl(fontSecondaryUrl: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.fontSize] with a well-typed [FontSize] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun fontSize(fontSize: JsonField<FontSize>) =
            apply {
         ...
         *
         * You should usually call [Builder.fontWeight] with a well-typed [FontWeight] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun fontWeight(fontWeight: JsonField<FontWeight>) =
            apply {
         ...
         *
         * You should usually call [Builder.light] with a well-typed [ThemeModeConfig] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun light(light: JsonField<ThemeModeConfig>) =
            apply {
                this.light = light
            }

        /** Custom text for the pay button (e.g., "Complete Purchase", "Subscribe Now"). Max 100 characters. */
        fun payButtonText(payButtonText: String?) = payButtonText(JsonField.ofNullable(payButtonText))

        /** Alias for calling [Builder.payButtonText] with `payButtonText.orElse(null)`. */
        fun payButtonText(payButtonText: Optional<String>) = payButtonText(payButtonText.getOrNull())

        /**
         * Sets [Builder.payButtonText] to an arbitrary JSON value.
         *
         * You should usually call [Builder.payButtonText] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun payButtonText(payButtonText: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.radius] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun radius(radius: JsonField<String>) =
            apply {
                this.radius = radius
            }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (dark.asKnown().getOrNull()?.validity() ?: 0) + (if (fontPrimaryUrl.asKnown().isPresent) 1 else 0) + (if (fontSecondaryUrl.asKnown().isPresent) 1 else 0) + (fontSize.asKnown().getOrNull()?.validity() ?: 0) + (fontWeight.asKnown().getOrNull()?.validity() ?: 0) + (light.asKnown().getOrNull()?.validity() ?: 0) + (if (payButtonText.asKnown().isPresent) 1 else 0) + (if (radius.asKnown().isPresent) 1 else 0)

    /** Font size for the checkout UI */
    class FontSize @JsonCreator private constructor(
    ...
    /** Font weight for the checkout UI */
    class FontWeight @JsonCreator private constructor(
        private val value: JsonField<String>,
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is ThemeConfig && dark == other.dark && fontPrimaryUrl == other.fontPrimaryUrl && fontSecondaryUrl == other.fontSecondaryUrl && fontSize == other.fontSize && fontWeight == other.fontWeight && light == other.light && payButtonText == other.payButtonText && radius == other.radius && additionalProperties == other.additionalProperties
    }

    private val hashCode: Int by lazy { Objects.hash(dark, fontPrimaryUrl, fontSecondaryUrl, fontSize, fontWeight, light, payButtonText, radius, additionalProperties) }

    override fun hashCode(): Int = hashCode

    override fun toString() = "ThemeConfig{dark=$dark, fontPrimaryUrl=$fontPrimaryUrl, fontSecondaryUrl=$fontSecondaryUrl, fontSize=$fontSize, fontWeight=$fontWeight, light=$light, payButtonText=$payButtonText, radius=$radius, additionalProperties=$additionalProperties}"
}
