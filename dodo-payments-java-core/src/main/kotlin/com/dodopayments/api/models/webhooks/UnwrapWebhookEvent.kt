...
private constructor(
    ...
    fun payoutCreated(): Optional<PayoutCreatedWebhookEvent> = Optional.ofNullable(payoutCreated)

    fun payoutFailed(): Optional<PayoutFailedWebhookEvent> = Optional.ofNullable(payoutFailed)

    fun payoutInProgress(): Optional<PayoutInProgressWebhookEvent> =
        Optional.ofNullable(payoutInProgress)

    fun payoutOnHold(): Optional<PayoutOnHoldWebhookEvent> = Optional.ofNullable(payoutOnHold)

    fun payoutSuccess(): Optional<PayoutSuccessWebhookEvent> = Optional.ofNullable(payoutSuccess)
    ...
    fun subscriptionPastDue(): Optional<SubscriptionPastDueWebhookEvent> =
        Optional.ofNullable(subscriptionPastDue)
