...
class SubscriptionUpdatePaymentMethodParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SubscriptionUpdatePaymentMethodParams].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(subscriptionUpdatePaymentMethodParams: SubscriptionUpdatePaymentMethodParams) =
            apply {
                ...
                additionalQueryParams = subscriptionUpdatePaymentMethodParams.additionalQueryParams.toBuilder()
            }
        ...
        fun paymentMethod(existing: PaymentMethod.Existing) = paymentMethod(PaymentMethod.ofExisting(existing))
        ...
        fun existingPaymentMethod(paymentMethodId: String) =
            paymentMethod(PaymentMethod.Existing.builder()
                .paymentMethodId(paymentMethodId)
                .build())
    ...
    class PaymentMethod private constructor(
        ...
        companion object {
            ...
            @JvmStatic
            fun ofNew(new_: New) = PaymentMethod(new_ = new_)
        ...
        interface Visitor<out T> {
             ...
             *
             * An instance of [PaymentMethod] can contain an unknown variant if it was deserialized from data
        ...
        internal class Deserializer : BaseDeserializer<PaymentMethod>(PaymentMethod::class) {
            ...
            override fun ObjectCodec.deserialize(node: JsonNode): PaymentMethod {
              ...
              when (type) {
                  "new" -> {
                      return tryDeserialize(node, jacksonTypeRef<New>())
                          ?.let {
                              PaymentMethod(new_ = it, _json = json)
                          } ?: PaymentMethod(_json = json)
                  }
                  "existing" -> {
                      return tryDeserialize(node, jacksonTypeRef<Existing>())
                          ?.let {
        ...
        internal class Serializer : BaseSerializer<PaymentMethod>(PaymentMethod::class) {
            ...
            override fun serialize(value: PaymentMethod, generator: JsonGenerator, provider: SerializerProvider) {
              when {
        ...
        class New @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            ...
            internal fun validity(): Int =
                type.let {
                    if (it == JsonValue.from("new")) 1 else 0
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is New && type == other.type && returnUrl == other.returnUrl && additionalProperties == other.additionalProperties
            }

            private val hashCode: Int by lazy { Objects.hash(type, returnUrl, additionalProperties) }

            override fun hashCode(): Int = hashCode

            override fun toString() = "New{type=$type, returnUrl=$returnUrl, additionalProperties=$additionalProperties}"
        }

        class Existing @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            ...
            class Builder internal constructor() {
                ...
                @JvmSynthetic
                internal fun from(existing: Existing) =
                    apply {
            ...
            @JvmSynthetic
            internal fun validity(): Int =
                (if (paymentMethodId.asKnown().isPresent) 1 else 0) + type.let {
                    if (it == JsonValue.from("existing")) 1 else 0
                }
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is Existing && paymentMethodId == other.paymentMethodId && type == other.type && additionalProperties == other.additionalProperties
            }

            private val hashCode: Int by lazy { Objects.hash(paymentMethodId, type, additionalProperties) }

            override fun hashCode(): Int = hashCode

            override fun toString() = "Existing{paymentMethodId=$paymentMethodId, type=$type, additionalProperties=$additionalProperties}"
        }
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is SubscriptionUpdatePaymentMethodParams && subscriptionId == other.subscriptionId && paymentMethod == other.paymentMethod && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(subscriptionId, paymentMethod, additionalHeaders, additionalQueryParams)

    override fun toString() = "SubscriptionUpdatePaymentMethodParams{subscriptionId=$subscriptionId, paymentMethod=$paymentMethod, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
