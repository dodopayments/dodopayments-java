...
class DetailDownloadCsvParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(detailDownloadCsvParams: DetailDownloadCsvParams) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is DetailDownloadCsvParams && payoutId == other.payoutId && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(payoutId, additionalHeaders, additionalQueryParams)

    override fun toString() = "DetailDownloadCsvParams{payoutId=$payoutId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
