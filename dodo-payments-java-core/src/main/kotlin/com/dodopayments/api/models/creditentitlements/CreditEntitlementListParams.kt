 ...
 */
class CreditEntitlementListParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(creditEntitlementListParams: CreditEntitlementListParams) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is CreditEntitlementListParams && deleted == other.deleted && pageNumber == other.pageNumber && pageSize == other.pageSize && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(deleted, pageNumber, pageSize, additionalHeaders, additionalQueryParams)

    override fun toString() = "CreditEntitlementListParams{deleted=$deleted, pageNumber=$pageNumber, pageSize=$pageSize, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
