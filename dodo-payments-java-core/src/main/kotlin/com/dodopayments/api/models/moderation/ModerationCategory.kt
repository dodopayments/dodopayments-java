...
class ModerationCategory @JsonCreator private constructor(private val value: JsonField<String>) :
    ...
    companion object {
        ...
        @JvmField val VIOLENT_CRIMES = of("violent_crimes")

        @JvmField val SEX_RELATED_CRIMES = of("sex_related_crimes")

        @JvmField val CHILD_SEXUAL_EXPLOITATION = of("child_sexual_exploitation")

        @JvmField val SUICIDE_AND_SELF_HARM = of("suicide_and_self_harm")

        @JvmField val INDISCRIMINATE_WEAPONS = of("indiscriminate_weapons")

        @JvmField val INTELLECTUAL_PROPERTY = of("intellectual_property")

        @JvmField val DEFAMATION = of("defamation")

        @JvmField val NON_VIOLENT_CRIMES = of("non_violent_crimes")

        @JvmField val HATE = of("hate")

        @JvmField val PRIVACY = of("privacy")

        @JvmField val SPECIALIZED_ADVICE = of("specialized_advice")

        @JvmField val SEXUAL_CONTENT = of("sexual_content")

        @JvmField val NON_CONSENSUAL_INTIMATE_IMAGERY = of("non_consensual_intimate_imagery")

        @JvmField val MINOR_CODED_LANGUAGE = of("minor_coded_language")

        @JvmField val REAL_PERSON_LIKENESS = of("real_person_likeness")

        @JvmField val LIVING_ARTIST_STYLE = of("living_artist_style")

        @JvmField val PROMPT_INJECTION = of("prompt_injection")

        @JvmStatic fun of(value: String) = ModerationCategory(JsonField.of(value))
    }
