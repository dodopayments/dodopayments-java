...
class PayoutListPageResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("items") @ExcludeMissing items: JsonField<List<PayoutListResponse>> = JsonMissing.of()
    ) : this(
      items, mutableMapOf()
    )
    ...
    @JsonProperty("items")
    @ExcludeMissing
    fun _items(): JsonField<List<PayoutListResponse>> = items
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(payoutListPageResponse: PayoutListPageResponse) =
            apply {
         ...
         *
         * You should usually call [Builder.items] with a well-typed `List<PayoutListResponse>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun items(items: JsonField<List<PayoutListResponse>>) =
            apply {
         ...
         */
        fun addItem(item: PayoutListResponse) =
            apply {
     ...
     *   expected type.
     */
    fun validate(): PayoutListPageResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is PayoutListPageResponse && items == other.items && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "PayoutListPageResponse{items=$items, additionalProperties=$additionalProperties}"
}
