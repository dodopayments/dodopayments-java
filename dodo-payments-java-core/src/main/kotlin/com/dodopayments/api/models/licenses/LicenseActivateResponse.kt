...
class LicenseActivateResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("license_key_id") @ExcludeMissing licenseKeyId: JsonField<String> = JsonMissing.of(),
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(licenseActivateResponse: LicenseActivateResponse) =
            apply {
         ...
         *
         * You should usually call [Builder.licenseKeyId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun licenseKeyId(licenseKeyId: JsonField<String>) =
            apply {
     ...
     *   expected type.
     */
    fun validate(): LicenseActivateResponse =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (id.asKnown().isPresent) 1 else 0) + (if (businessId.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (customer.asKnown().getOrNull()?.validity() ?: 0) + (if (licenseKeyId.asKnown().isPresent) 1 else 0) + (if (name.asKnown().isPresent) 1 else 0) + (product.asKnown().getOrNull()?.validity() ?: 0)
    ...
    class Product @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (productId.asKnown().isPresent) 1 else 0) + (if (name.asKnown().isPresent) 1 else 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Product && productId == other.productId && name == other.name && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "Product{productId=$productId, name=$name, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is LicenseActivateResponse && id == other.id && businessId == other.businessId && createdAt == other.createdAt && customer == other.customer && licenseKeyId == other.licenseKeyId && name == other.name && product == other.product && additionalProperties == other.additionalProperties
    }

    private val hashCode: Int by lazy { Objects.hash(id, businessId, createdAt, customer, licenseKeyId, name, product, additionalProperties) }

    override fun hashCode(): Int = hashCode

    override fun toString() = "LicenseActivateResponse{id=$id, businessId=$businessId, createdAt=$createdAt, customer=$customer, licenseKeyId=$licenseKeyId, name=$name, product=$product, additionalProperties=$additionalProperties}"
}
