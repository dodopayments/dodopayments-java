...
/** POST /entitlements */
class EntitlementCreateParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(entitlementCreateParams: EntitlementCreateParams) =
            apply {
    ...
    class Body @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        class Builder internal constructor() {
            ...
            /** Platform-specific configuration (validated per integration_type) */
            fun integrationConfig(integrationConfig: IntegrationConfig) = integrationConfig(JsonField.of(integrationConfig))
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (integrationConfig.asKnown().getOrNull()?.validity() ?: 0) + (integrationType.asKnown().getOrNull()?.validity() ?: 0) + (if (name.asKnown().isPresent) 1 else 0) + (if (description.asKnown().isPresent) 1 else 0) + (metadata.asKnown().getOrNull()?.validity() ?: 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Body && integrationConfig == other.integrationConfig && integrationType == other.integrationType && name == other.name && description == other.description && metadata == other.metadata && additionalProperties == other.additionalProperties
        }

        private val hashCode: Int by lazy { Objects.hash(integrationConfig, integrationType, name, description, metadata, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() = "Body{integrationConfig=$integrationConfig, integrationType=$integrationType, name=$name, description=$description, metadata=$metadata, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is EntitlementCreateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(body, additionalHeaders, additionalQueryParams)

    override fun toString() = "EntitlementCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
