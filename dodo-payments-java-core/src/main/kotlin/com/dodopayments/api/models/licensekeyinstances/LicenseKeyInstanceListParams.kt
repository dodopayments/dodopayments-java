...
class LicenseKeyInstanceListParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(licenseKeyInstanceListParams: LicenseKeyInstanceListParams) =
            apply {
        ...
        /** Filter by license key ID */
        fun licenseKeyId(licenseKeyId: String?) =
            apply {
                this.licenseKeyId = licenseKeyId
            }

        /** Alias for calling [Builder.licenseKeyId] with `licenseKeyId.orElse(null)`. */
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is LicenseKeyInstanceListParams && grantId == other.grantId && licenseKeyId == other.licenseKeyId && pageNumber == other.pageNumber && pageSize == other.pageSize && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(grantId, licenseKeyId, pageNumber, pageSize, additionalHeaders, additionalQueryParams)

    override fun toString() = "LicenseKeyInstanceListParams{grantId=$grantId, licenseKeyId=$licenseKeyId, pageNumber=$pageNumber, pageSize=$pageSize, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
