...
private constructor(
    ...
    fun blocklistCustomersBlockByCustomerId(): Optional<BlocklistCustomersBlockByCustomerId> =
        Optional.ofNullable(blocklistCustomersBlockByCustomerId)

    fun blocklistCustomersBlockByEmail(): Optional<BlocklistCustomersBlockByEmail> =
        Optional.ofNullable(blocklistCustomersBlockByEmail)
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = createBlockedCustomerRequest.accept(new CreateBlockedCustomerRequest.Visitor<Optional<String>>() {
     *     @Override
     *     public Optional<String> visitBlocklistCustomersBlockByCustomerId(BlocklistCustomersBlockByCustomerId blocklistCustomersBlockByCustomerId) {
     *         return Optional.of(blocklistCustomersBlockByCustomerId.toString());
     *     }
     *
     *     // ...
     *
    ...
    private constructor(
         ...
         *   if the server responded with an unexpected value).
         */
        fun source(): Optional<BlockedCustomerSource> = source.getOptional("source")
        ...
        class Builder internal constructor() {
            ...
            fun source(source: Optional<BlockedCustomerSource>) = source(source.getOrNull())
