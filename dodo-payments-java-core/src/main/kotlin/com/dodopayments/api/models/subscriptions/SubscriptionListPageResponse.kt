...
class SubscriptionListPageResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("items") @ExcludeMissing items: JsonField<List<SubscriptionListResponse>> = JsonMissing.of()
    ) : this(
      items, mutableMapOf()
    )
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(subscriptionListPageResponse: SubscriptionListPageResponse) =
            apply {
         ...
         *
         * You should usually call [Builder.items] with a well-typed `List<SubscriptionListResponse>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun items(items: JsonField<List<SubscriptionListResponse>>) =
            apply {
         ...
         */
        fun addItem(item: SubscriptionListResponse) =
            apply {
     ...
     *   expected type.
     */
    fun validate(): SubscriptionListPageResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is SubscriptionListPageResponse && items == other.items && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "SubscriptionListPageResponse{items=$items, additionalProperties=$additionalProperties}"
}
