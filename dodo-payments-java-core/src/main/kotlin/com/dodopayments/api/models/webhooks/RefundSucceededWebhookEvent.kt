...
class RefundSucceededWebhookEvent @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<Refund> = data
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(refundSucceededWebhookEvent: RefundSucceededWebhookEvent) =
            apply {
         ...
         *
         * You should usually call [Builder.data] with a well-typed [Refund] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<Refund>) =
            apply {
                this.data = data
            }
     ...
     *   expected type.
     */
    fun validate(): RefundSucceededWebhookEvent =
        apply {
            if (validated) {
              return@apply
            }
    ...
    internal fun validity(): Int =
        (if (businessId.asKnown().isPresent) 1 else 0) + (data.asKnown().getOrNull()?.validity() ?: 0) + (if (timestamp.asKnown().isPresent) 1 else 0) + type.let {
            if (it == JsonValue.from("refund.succeeded")) 1 else 0
        }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is RefundSucceededWebhookEvent && businessId == other.businessId && data == other.data && timestamp == other.timestamp && type == other.type && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "RefundSucceededWebhookEvent{businessId=$businessId, data=$data, timestamp=$timestamp, type=$type, additionalProperties=$additionalProperties}"
}
