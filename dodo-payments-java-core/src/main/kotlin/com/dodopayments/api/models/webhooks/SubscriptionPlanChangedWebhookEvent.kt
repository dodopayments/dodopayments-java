...
class SubscriptionPlanChangedWebhookEvent @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SubscriptionPlanChangedWebhookEvent].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(subscriptionPlanChangedWebhookEvent: SubscriptionPlanChangedWebhookEvent) =
            apply {
                ...
                additionalProperties = subscriptionPlanChangedWebhookEvent.additionalProperties.toMutableMap()
            }
     ...
     *   expected type.
     */
    fun validate(): SubscriptionPlanChangedWebhookEvent =
        apply {
            if (validated) {
              return@apply
            }
    ...
    internal fun validity(): Int =
        (if (businessId.asKnown().isPresent) 1 else 0) + (data.asKnown().getOrNull()?.validity() ?: 0) + (if (timestamp.asKnown().isPresent) 1 else 0) + type.let {
            if (it == JsonValue.from("subscription.plan_changed")) 1 else 0
        }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is SubscriptionPlanChangedWebhookEvent && businessId == other.businessId && data == other.data && timestamp == other.timestamp && type == other.type && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "SubscriptionPlanChangedWebhookEvent{businessId=$businessId, data=$data, timestamp=$timestamp, type=$type, additionalProperties=$additionalProperties}"
}
