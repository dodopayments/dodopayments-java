...
import com.dodopayments.api.models.creditentitlements.balances.BalanceListGrantsResponse
...
class BalanceListGrantsResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("initial_amount") @ExcludeMissing initialAmount: JsonField<String> = JsonMissing.of(),
        @JsonProperty("is_expired") @ExcludeMissing isExpired: JsonField<Boolean> = JsonMissing.of(),
        @JsonProperty("is_rolled_over") @ExcludeMissing isRolledOver: JsonField<Boolean> = JsonMissing.of(),
        @JsonProperty("remaining_amount") @ExcludeMissing remainingAmount: JsonField<String> = JsonMissing.of(),
        @JsonProperty("rollover_count") @ExcludeMissing rolloverCount: JsonField<Int> = JsonMissing.of(),
        @JsonProperty("source_type") @ExcludeMissing sourceType: JsonField<SourceType> = JsonMissing.of(),
        ...
        @JsonProperty("parent_grant_id") @ExcludeMissing parentGrantId: JsonField<String> = JsonMissing.of(),
    ...
    @ExcludeMissing
    fun _isExpired(): JsonField<Boolean> = isExpired
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(balanceListGrantsResponse: BalanceListGrantsResponse) =
            apply {
         ...
         *
         * You should usually call [Builder.initialAmount] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun initialAmount(initialAmount: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.isExpired] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun isExpired(isExpired: JsonField<Boolean>) =
            apply {
         ...
         *
         * You should usually call [Builder.isRolledOver] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun isRolledOver(isRolledOver: JsonField<Boolean>) =
            apply {
                this.isRolledOver = isRolledOver
            }

        fun remainingAmount(remainingAmount: String) = remainingAmount(JsonField.of(remainingAmount))

        /**
         * Sets [Builder.remainingAmount] to an arbitrary JSON value.
         *
         * You should usually call [Builder.remainingAmount] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun remainingAmount(remainingAmount: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.rolloverCount] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun rolloverCount(rolloverCount: JsonField<Int>) =
            apply {
         ...
         *
         * You should usually call [Builder.sourceType] with a well-typed [SourceType] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun sourceType(sourceType: JsonField<SourceType>) =
            apply {
        ...
        fun parentGrantId(parentGrantId: String?) = parentGrantId(JsonField.ofNullable(parentGrantId))

        /** Alias for calling [Builder.parentGrantId] with `parentGrantId.orElse(null)`. */
        fun parentGrantId(parentGrantId: Optional<String>) = parentGrantId(parentGrantId.getOrNull())

        /**
         * Sets [Builder.parentGrantId] to an arbitrary JSON value.
         *
         * You should usually call [Builder.parentGrantId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun parentGrantId(parentGrantId: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.sourceId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
     ...
     *   expected type.
     */
    fun validate(): BalanceListGrantsResponse =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (id.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (creditEntitlementId.asKnown().isPresent) 1 else 0) + (if (customerId.asKnown().isPresent) 1 else 0) + (if (initialAmount.asKnown().isPresent) 1 else 0) + (if (isExpired.asKnown().isPresent) 1 else 0) + (if (isRolledOver.asKnown().isPresent) 1 else 0) + (if (remainingAmount.asKnown().isPresent) 1 else 0) + (if (rolloverCount.asKnown().isPresent) 1 else 0) + (sourceType.asKnown().getOrNull()?.validity() ?: 0) + (if (updatedAt.asKnown().isPresent) 1 else 0) + (if (expiresAt.asKnown().isPresent) 1 else 0) + (metadata.asKnown().getOrNull()?.validity() ?: 0) + (if (parentGrantId.asKnown().isPresent) 1 else 0) + (if (sourceId.asKnown().isPresent) 1 else 0)

    class SourceType @JsonCreator private constructor(
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is BalanceListGrantsResponse && id == other.id && createdAt == other.createdAt && creditEntitlementId == other.creditEntitlementId && customerId == other.customerId && initialAmount == other.initialAmount && isExpired == other.isExpired && isRolledOver == other.isRolledOver && remainingAmount == other.remainingAmount && rolloverCount == other.rolloverCount && sourceType == other.sourceType && updatedAt == other.updatedAt && expiresAt == other.expiresAt && metadata == other.metadata && parentGrantId == other.parentGrantId && sourceId == other.sourceId && additionalProperties == other.additionalProperties
    }

    private val hashCode: Int by lazy { Objects.hash(id, createdAt, creditEntitlementId, customerId, initialAmount, isExpired, isRolledOver, remainingAmount, rolloverCount, sourceType, updatedAt, expiresAt, metadata, parentGrantId, sourceId, additionalProperties) }

    override fun hashCode(): Int = hashCode

    override fun toString() = "BalanceListGrantsResponse{id=$id, createdAt=$createdAt, creditEntitlementId=$creditEntitlementId, customerId=$customerId, initialAmount=$initialAmount, isExpired=$isExpired, isRolledOver=$isRolledOver, remainingAmount=$remainingAmount, rolloverCount=$rolloverCount, sourceType=$sourceType, updatedAt=$updatedAt, expiresAt=$expiresAt, metadata=$metadata, parentGrantId=$parentGrantId, sourceId=$sourceId, additionalProperties=$additionalProperties}"
}
