...
class LedgerEntryListPageAsync private constructor(
     ...
     */
    override fun items(): List<CustomerWalletTransaction> = response._items().getOptional("items").getOrNull() ?: emptyList()
    ...
    class Builder internal constructor() {
        ...
        /** The response that this page was parsed from. */
        fun response(response: LedgerEntryListPageResponse) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is LedgerEntryListPageAsync && service == other.service && streamHandlerExecutor == other.streamHandlerExecutor && params == other.params && response == other.response
    }

    override fun hashCode(): Int = Objects.hash(service, streamHandlerExecutor, params, response)

    override fun toString() = "LedgerEntryListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, response=$response}"
}
