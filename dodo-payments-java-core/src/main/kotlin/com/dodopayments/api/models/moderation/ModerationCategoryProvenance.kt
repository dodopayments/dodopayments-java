...
private constructor(
    ...
    internal fun validity(): Int =
        (childSexualExploitation.asKnown().getOrNull()?.validity() ?: 0) +
            (defamation.asKnown().getOrNull()?.validity() ?: 0) +
            (hate.asKnown().getOrNull()?.validity() ?: 0) +
            (indiscriminateWeapons.asKnown().getOrNull()?.validity() ?: 0) +
            (intellectualProperty.asKnown().getOrNull()?.validity() ?: 0) +
            (livingArtistStyle.asKnown().getOrNull()?.validity() ?: 0) +
            (minorCodedLanguage.asKnown().getOrNull()?.validity() ?: 0) +
            (nonConsensualIntimateImagery.asKnown().getOrNull()?.validity() ?: 0) +
            (nonViolentCrimes.asKnown().getOrNull()?.validity() ?: 0) +
            (privacy.asKnown().getOrNull()?.validity() ?: 0) +
            (promptInjection.asKnown().getOrNull()?.validity() ?: 0) +
            (realPersonLikeness.asKnown().getOrNull()?.validity() ?: 0) +
            (sexRelatedCrimes.asKnown().getOrNull()?.validity() ?: 0) +
            (sexualContent.asKnown().getOrNull()?.validity() ?: 0) +
            (specializedAdvice.asKnown().getOrNull()?.validity() ?: 0) +
            (suicideAndSelfHarm.asKnown().getOrNull()?.validity() ?: 0) +
            (violentCrimes.asKnown().getOrNull()?.validity() ?: 0)
