...
class CancellationFeedback @JsonCreator private constructor(
    ...
    enum class Value {
        ...
        TOO_COMPLEX,
        OTHER,
        /** An enum member indicating that [CancellationFeedback] was instantiated with an unknown value. */
        _UNKNOWN,
    }
     ...
     *   expected type.
     */
    fun validate(): CancellationFeedback =
        apply {
            if (validated) {
              return@apply
            }
