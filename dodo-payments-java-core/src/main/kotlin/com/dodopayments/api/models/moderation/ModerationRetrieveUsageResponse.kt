...
private constructor(
    ...
    internal fun validity(): Int =
        (daily.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) +
            (if (screensToNextBlock.asKnown().isPresent) 1 else 0) +
            (if (unbilledScreens.asKnown().isPresent) 1 else 0)
    ...
    private constructor(
        ...
        @JvmSynthetic
        internal fun validity(): Int =
            (if (date.asKnown().isPresent) 1 else 0) + (if (screens.asKnown().isPresent) 1 else 0)
