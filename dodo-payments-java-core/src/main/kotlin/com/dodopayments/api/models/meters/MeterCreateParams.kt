...
class MeterCreateParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(meterCreateParams: MeterCreateParams) =
            apply {
        ...
        /** Aggregation configuration for the meter */
        fun aggregation(aggregation: MeterAggregation) =
            apply {
    ...
    class Body @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (aggregation.asKnown().getOrNull()?.validity() ?: 0) + (if (eventName.asKnown().isPresent) 1 else 0) + (if (measurementUnit.asKnown().isPresent) 1 else 0) + (if (name.asKnown().isPresent) 1 else 0) + (if (description.asKnown().isPresent) 1 else 0) + (filter.asKnown().getOrNull()?.validity() ?: 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Body && aggregation == other.aggregation && eventName == other.eventName && measurementUnit == other.measurementUnit && name == other.name && description == other.description && filter == other.filter && additionalProperties == other.additionalProperties
        }

        private val hashCode: Int by lazy { Objects.hash(aggregation, eventName, measurementUnit, name, description, filter, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() = "Body{aggregation=$aggregation, eventName=$eventName, measurementUnit=$measurementUnit, name=$name, description=$description, filter=$filter, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is MeterCreateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(body, additionalHeaders, additionalQueryParams)

    override fun toString() = "MeterCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
