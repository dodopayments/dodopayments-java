...
class RefundRetrieveParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(refundRetrieveParams: RefundRetrieveParams) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is RefundRetrieveParams && refundId == other.refundId && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(refundId, additionalHeaders, additionalQueryParams)

    override fun toString() = "RefundRetrieveParams{refundId=$refundId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
