...
private constructor(
    ...
    fun emailLogId(): Optional<String> = Optional.ofNullable(emailLogId)
    ...
    class Builder internal constructor() {
        ...
        /** Alias for calling [Builder.emailLogId] with `emailLogId.orElse(null)`. */
        fun emailLogId(emailLogId: Optional<String>) = emailLogId(emailLogId.getOrNull())
