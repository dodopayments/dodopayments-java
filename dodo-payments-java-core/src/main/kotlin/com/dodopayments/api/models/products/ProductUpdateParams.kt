...
class ProductUpdateParams private constructor(
     ...
     * @throws DodoPaymentsInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun creditEntitlements(): Optional<List<AttachCreditEntitlement>> = body.creditEntitlements()
     ...
     * @throws DodoPaymentsInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun entitlements(): Optional<List<AttachProductEntitlement>> = body.entitlements()
     ...
     */
    fun _digitalProductDelivery(): JsonField<DigitalProductDelivery> = body._digitalProductDelivery()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(productUpdateParams: ProductUpdateParams) =
            apply {
        ...
        fun creditEntitlements(creditEntitlements: Optional<List<AttachCreditEntitlement>>) = creditEntitlements(creditEntitlements.getOrNull())

        /**
         * Sets [Builder.creditEntitlements] to an arbitrary JSON value.
         *
         * You should usually call [Builder.creditEntitlements] with a well-typed `List<AttachCreditEntitlement>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addCreditEntitlement(creditEntitlement: AttachCreditEntitlement) =
            apply {
        ...
        fun entitlements(entitlements: Optional<List<AttachProductEntitlement>>) = entitlements(entitlements.getOrNull())

        /**
         * Sets [Builder.entitlements] to an arbitrary JSON value.
         *
         * You should usually call [Builder.entitlements] with a well-typed `List<AttachProductEntitlement>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun entitlements(entitlements: JsonField<List<AttachProductEntitlement>>) =
            apply {
                body.entitlements(entitlements)
            }
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addEntitlement(entitlement: AttachProductEntitlement) =
            apply {
         ...
         */
        @Deprecated("Use the dedicated entitlements API to configure license-key delivery.")
        fun licenseKeyEnabled(licenseKeyEnabled: Boolean) = licenseKeyEnabled(licenseKeyEnabled as Boolean?)

        /** Alias for calling [Builder.licenseKeyEnabled] with `licenseKeyEnabled.orElse(null)`. */
        @Deprecated("Use the dedicated entitlements API to configure license-key delivery.")
        fun licenseKeyEnabled(licenseKeyEnabled: Optional<Boolean>) = licenseKeyEnabled(licenseKeyEnabled.getOrNull())
        ...
        fun price(oneTime: Price.OneTimePrice) =
            apply {
                body.price(oneTime)
            }

        /** Alias for calling [price] with `Price.ofRecurring(recurring)`. */
        fun price(recurring: Price.RecurringPrice) =
            apply {
                body.price(recurring)
            }

        /** Alias for calling [price] with `Price.ofUsageBased(usageBased)`. */
        fun price(usageBased: Price.UsageBasedPrice) =
            apply {
                body.price(usageBased)
            }
    ...
    class Body @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        private constructor(
            ...
            @JsonProperty("credit_entitlements") @ExcludeMissing creditEntitlements: JsonField<List<AttachCreditEntitlement>> = JsonMissing.of(),
            ...
            @JsonProperty("entitlements") @ExcludeMissing entitlements: JsonField<List<AttachProductEntitlement>> = JsonMissing.of(),
         ...
         * @throws DodoPaymentsInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun creditEntitlements(): Optional<List<AttachCreditEntitlement>> = creditEntitlements.getOptional("credit_entitlements")
         ...
         * @throws DodoPaymentsInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun entitlements(): Optional<List<AttachProductEntitlement>> = entitlements.getOptional("entitlements")
         ...
         */
        @Deprecated("Use the dedicated entitlements API to configure license-key delivery.")
        fun licenseKeyEnabled(): Optional<Boolean> = licenseKeyEnabled.getOptional("license_key_enabled")
        ...
        class Builder internal constructor() {
             ...
             * Send empty array to remove all, omit field to leave unchanged
             */
            fun creditEntitlements(creditEntitlements: List<AttachCreditEntitlement>?) = creditEntitlements(JsonField.ofNullable(creditEntitlements))
             ...
             * Send empty array to remove all, omit field to leave unchanged
             */
            fun entitlements(entitlements: List<AttachProductEntitlement>?) = entitlements(JsonField.ofNullable(entitlements))
             ...
             */
            @Deprecated("Use the dedicated entitlements API to configure license-key delivery.")
            fun licenseKeyEnabled(licenseKeyEnabled: Boolean?) = licenseKeyEnabled(JsonField.ofNullable(licenseKeyEnabled))
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (addons.asKnown().getOrNull()?.size ?: 0) + (if (brandId.asKnown().isPresent) 1 else 0) + (creditEntitlements.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (if (description.asKnown().isPresent) 1 else 0) + (digitalProductDelivery.asKnown().getOrNull()?.validity() ?: 0) + (entitlements.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (if (imageId.asKnown().isPresent) 1 else 0) + (if (licenseKeyActivationMessage.asKnown().isPresent) 1 else 0) + (if (licenseKeyActivationsLimit.asKnown().isPresent) 1 else 0) + (licenseKeyDuration.asKnown().getOrNull()?.validity() ?: 0) + (if (licenseKeyEnabled.asKnown().isPresent) 1 else 0) + (metadata.asKnown().getOrNull()?.validity() ?: 0) + (if (name.asKnown().isPresent) 1 else 0) + (price.asKnown().getOrNull()?.validity() ?: 0) + (taxCategory.asKnown().getOrNull()?.validity() ?: 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Body && addons == other.addons && brandId == other.brandId && creditEntitlements == other.creditEntitlements && description == other.description && digitalProductDelivery == other.digitalProductDelivery && entitlements == other.entitlements && imageId == other.imageId && licenseKeyActivationMessage == other.licenseKeyActivationMessage && licenseKeyActivationsLimit == other.licenseKeyActivationsLimit && licenseKeyDuration == other.licenseKeyDuration && licenseKeyEnabled == other.licenseKeyEnabled && metadata == other.metadata && name == other.name && price == other.price && taxCategory == other.taxCategory && additionalProperties == other.additionalProperties
        }

        private val hashCode: Int by lazy { Objects.hash(addons, brandId, creditEntitlements, description, digitalProductDelivery, entitlements, imageId, licenseKeyActivationMessage, licenseKeyActivationsLimit, licenseKeyDuration, licenseKeyEnabled, metadata, name, price, taxCategory, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() = "Body{addons=$addons, brandId=$brandId, creditEntitlements=$creditEntitlements, description=$description, digitalProductDelivery=$digitalProductDelivery, entitlements=$entitlements, imageId=$imageId, licenseKeyActivationMessage=$licenseKeyActivationMessage, licenseKeyActivationsLimit=$licenseKeyActivationsLimit, licenseKeyDuration=$licenseKeyDuration, licenseKeyEnabled=$licenseKeyEnabled, metadata=$metadata, name=$name, price=$price, taxCategory=$taxCategory, additionalProperties=$additionalProperties}"
    }
    ...
    class DigitalProductDelivery @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        private constructor(
            ...
            @JsonProperty("files") @ExcludeMissing files: JsonField<List<String>> = JsonMissing.of(),
        ...
        @JsonProperty("files")
        @ExcludeMissing
        fun _files(): JsonField<List<String>> = files
        ...
        class Builder internal constructor() {
            ...
            fun files(files: Optional<List<String>>) = files(files.getOrNull())

            /**
             * Sets [Builder.files] to an arbitrary JSON value.
             *
             * You should usually call [Builder.files] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun files(files: JsonField<List<String>>) =
                apply {
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (externalUrl.asKnown().isPresent) 1 else 0) + (files.asKnown().getOrNull()?.size ?: 0) + (if (instructions.asKnown().isPresent) 1 else 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is DigitalProductDelivery && externalUrl == other.externalUrl && files == other.files && instructions == other.instructions && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "DigitalProductDelivery{externalUrl=$externalUrl, files=$files, instructions=$instructions, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is ProductUpdateParams && id == other.id && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(id, body, additionalHeaders, additionalQueryParams)

    override fun toString() = "ProductUpdateParams{id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
