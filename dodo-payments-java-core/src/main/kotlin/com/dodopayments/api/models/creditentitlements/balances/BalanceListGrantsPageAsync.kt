...
class BalanceListGrantsPageAsync private constructor(
     ...
     */
    override fun items(): List<BalanceListGrantsResponse> = response._items().getOptional("items").getOrNull() ?: emptyList()
    ...
    override fun nextPage(): CompletableFuture<BalanceListGrantsPageAsync> = service.listGrants(nextPageParams())
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(balanceListGrantsPageAsync: BalanceListGrantsPageAsync) =
            apply {
        ...
        /** The parameters that were used to request this page. */
        fun params(params: BalanceListGrantsParams) =
            apply {
                this.params = params
            }

        /** The response that this page was parsed from. */
        fun response(response: BalanceListGrantsPageResponse) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is BalanceListGrantsPageAsync && service == other.service && streamHandlerExecutor == other.streamHandlerExecutor && params == other.params && response == other.response
    }

    override fun hashCode(): Int = Objects.hash(service, streamHandlerExecutor, params, response)

    override fun toString() = "BalanceListGrantsPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, response=$response}"
}
