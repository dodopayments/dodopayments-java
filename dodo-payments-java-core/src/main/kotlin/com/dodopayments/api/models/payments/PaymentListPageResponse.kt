...
class PaymentListPageResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("items") @ExcludeMissing items: JsonField<List<PaymentListResponse>> = JsonMissing.of()
    ) : this(
      items, mutableMapOf()
    )
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(paymentListPageResponse: PaymentListPageResponse) =
            apply {
         ...
         *
         * You should usually call [Builder.items] with a well-typed `List<PaymentListResponse>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun items(items: JsonField<List<PaymentListResponse>>) =
            apply {
         ...
         */
        fun addItem(item: PaymentListResponse) =
            apply {
     ...
     *   expected type.
     */
    fun validate(): PaymentListPageResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is PaymentListPageResponse && items == other.items && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "PaymentListPageResponse{items=$items, additionalProperties=$additionalProperties}"
}
