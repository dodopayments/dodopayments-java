...
private constructor(
     ...
     */
    fun movedToBrandId(): Optional<String> = movedToBrandId.getOptional("moved_to_brand_id")
    ...
    class Builder internal constructor() {
        ...
        /** Alias for calling [Builder.movedToBrandId] with `movedToBrandId.orElse(null)`. */
        fun movedToBrandId(movedToBrandId: Optional<String>) =
            movedToBrandId(movedToBrandId.getOrNull())
    ...
    internal fun validity(): Int =
        (if (archivedAt.asKnown().isPresent) 1 else 0) +
            ...
            (if (collectionsMoved.asKnown().isPresent) 1 else 0) +
            (if (productsMoved.asKnown().isPresent) 1 else 0) +
            (if (subscriptionsMoved.asKnown().isPresent) 1 else 0) +
            (if (movedToBrandId.asKnown().isPresent) 1 else 0)
