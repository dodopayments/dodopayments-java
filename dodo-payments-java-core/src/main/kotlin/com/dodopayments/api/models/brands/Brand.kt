...
class Brand @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("verification_enabled") @ExcludeMissing verificationEnabled: JsonField<Boolean> = JsonMissing.of(),
        ...
        @JsonProperty("reason_for_hold") @ExcludeMissing reasonForHold: JsonField<String> = JsonMissing.of(),
        @JsonProperty("support_email") @ExcludeMissing supportEmail: JsonField<String> = JsonMissing.of(),
     ...
     * @throws DodoPaymentsInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun reasonForHold(): Optional<String> = reasonForHold.getOptional("reason_for_hold")
     ...
     *
     * Unlike [verificationEnabled], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    class Builder internal constructor() {
         ...
         *
         * You should usually call [Builder.enabled] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        ...
        fun verificationEnabled(verificationEnabled: Boolean) = verificationEnabled(JsonField.of(verificationEnabled))

        /**
         * Sets [Builder.verificationEnabled] to an arbitrary JSON value.
         *
         * You should usually call [Builder.verificationEnabled] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun verificationEnabled(verificationEnabled: JsonField<Boolean>) =
            apply {
        ...
        /** Incase the brand verification fails or is put on hold */
        fun reasonForHold(reasonForHold: String?) = reasonForHold(JsonField.ofNullable(reasonForHold))

        /** Alias for calling [Builder.reasonForHold] with `reasonForHold.orElse(null)`. */
        fun reasonForHold(reasonForHold: Optional<String>) = reasonForHold(reasonForHold.getOrNull())

        /**
         * Sets [Builder.reasonForHold] to an arbitrary JSON value.
         *
         * You should usually call [Builder.reasonForHold] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun reasonForHold(reasonForHold: JsonField<String>) =
            apply {
        ...
        /** Alias for calling [Builder.supportEmail] with `supportEmail.orElse(null)`. */
        fun supportEmail(supportEmail: Optional<String>) = supportEmail(supportEmail.getOrNull())

        /**
         * Sets [Builder.supportEmail] to an arbitrary JSON value.
         *
         * You should usually call [Builder.supportEmail] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun supportEmail(supportEmail: JsonField<String>) =
            apply {
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (brandId.asKnown().isPresent) 1 else 0) + (if (businessId.asKnown().isPresent) 1 else 0) + (if (enabled.asKnown().isPresent) 1 else 0) + (if (statementDescriptor.asKnown().isPresent) 1 else 0) + (if (verificationEnabled.asKnown().isPresent) 1 else 0) + (verificationStatus.asKnown().getOrNull()?.validity() ?: 0) + (if (description.asKnown().isPresent) 1 else 0) + (if (image.asKnown().isPresent) 1 else 0) + (if (name.asKnown().isPresent) 1 else 0) + (if (reasonForHold.asKnown().isPresent) 1 else 0) + (if (supportEmail.asKnown().isPresent) 1 else 0) + (if (url.asKnown().isPresent) 1 else 0)
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is Brand && brandId == other.brandId && businessId == other.businessId && enabled == other.enabled && statementDescriptor == other.statementDescriptor && verificationEnabled == other.verificationEnabled && verificationStatus == other.verificationStatus && description == other.description && image == other.image && name == other.name && reasonForHold == other.reasonForHold && supportEmail == other.supportEmail && url == other.url && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "Brand{brandId=$brandId, businessId=$businessId, enabled=$enabled, statementDescriptor=$statementDescriptor, verificationEnabled=$verificationEnabled, verificationStatus=$verificationStatus, description=$description, image=$image, name=$name, reasonForHold=$reasonForHold, supportEmail=$supportEmail, url=$url, additionalProperties=$additionalProperties}"
}
