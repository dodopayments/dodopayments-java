...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun reasonForHold(reasonForHold: Optional<String>) =
            reasonForHold(reasonForHold.getOrNull())
