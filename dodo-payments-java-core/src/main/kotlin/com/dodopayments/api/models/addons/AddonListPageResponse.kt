...
class AddonListPageResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("items") @ExcludeMissing items: JsonField<List<AddonResponse>> = JsonMissing.of()
    ) : this(
      items, mutableMapOf()
    )
    ...
    @JsonProperty("items")
    @ExcludeMissing
    fun _items(): JsonField<List<AddonResponse>> = items
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(addonListPageResponse: AddonListPageResponse) =
            apply {
         ...
         *
         * You should usually call [Builder.items] with a well-typed `List<AddonResponse>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun items(items: JsonField<List<AddonResponse>>) =
            apply {
         ...
         */
        fun addItem(item: AddonResponse) =
            apply {
     ...
     *   expected type.
     */
    fun validate(): AddonListPageResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is AddonListPageResponse && items == other.items && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "AddonListPageResponse{items=$items, additionalProperties=$additionalProperties}"
}
