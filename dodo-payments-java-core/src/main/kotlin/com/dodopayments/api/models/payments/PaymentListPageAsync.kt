...
class PaymentListPageAsync private constructor(
     ...
     */
    override fun items(): List<PaymentListResponse> = response._items().getOptional("items").getOrNull() ?: emptyList()
    ...
    override fun nextPage(): CompletableFuture<PaymentListPageAsync> = service.list(nextPageParams())
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(paymentListPageAsync: PaymentListPageAsync) =
            apply {
        ...
        fun service(service: PaymentServiceAsync) =
            apply {
        ...
        /** The parameters that were used to request this page. */
        fun params(params: PaymentListParams) =
            apply {
                this.params = params
            }

        /** The response that this page was parsed from. */
        fun response(response: PaymentListPageResponse) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is PaymentListPageAsync && service == other.service && streamHandlerExecutor == other.streamHandlerExecutor && params == other.params && response == other.response
    }

    override fun hashCode(): Int = Objects.hash(service, streamHandlerExecutor, params, response)

    override fun toString() = "PaymentListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, response=$response}"
}
