 ...
 */
class CreditEntitlementRetrieveParams private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [CreditEntitlementRetrieveParams]. */
        @JvmStatic
        fun builder() = Builder()
    }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(creditEntitlementRetrieveParams: CreditEntitlementRetrieveParams) =
            apply {
                ...
                additionalQueryParams = creditEntitlementRetrieveParams.additionalQueryParams.toBuilder()
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is CreditEntitlementRetrieveParams && id == other.id && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(id, additionalHeaders, additionalQueryParams)

    override fun toString() = "CreditEntitlementRetrieveParams{id=$id, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
