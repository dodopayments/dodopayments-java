...
private constructor(
    ...
    fun latestAttemptedAt(): Optional<OffsetDateTime> =
        Optional.ofNullable(latestAttemptedAt.getNullable("latest_attempted_at"))

    fun request(): Optional<String> = Optional.ofNullable(request.getNullable("request"))

    fun response(): Optional<String> = Optional.ofNullable(response.getNullable("response"))
