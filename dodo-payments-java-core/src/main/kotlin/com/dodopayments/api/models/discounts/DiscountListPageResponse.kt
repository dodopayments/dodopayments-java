...
class DiscountListPageResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    @JsonProperty("items")
    @ExcludeMissing
    fun _items(): JsonField<List<Discount>> = items
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(discountListPageResponse: DiscountListPageResponse) =
            apply {
         ...
         *
         * You should usually call [Builder.items] with a well-typed `List<Discount>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun items(items: JsonField<List<Discount>>) =
            apply {
     ...
     *   expected type.
     */
    fun validate(): DiscountListPageResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is DiscountListPageResponse && items == other.items && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "DiscountListPageResponse{items=$items, additionalProperties=$additionalProperties}"
}
