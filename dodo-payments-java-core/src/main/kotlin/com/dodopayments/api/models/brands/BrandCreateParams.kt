...
class BrandCreateParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(brandCreateParams: BrandCreateParams) =
            apply {
    ...
    class Body @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (description.asKnown().isPresent) 1 else 0) + (if (name.asKnown().isPresent) 1 else 0) + (if (statementDescriptor.asKnown().isPresent) 1 else 0) + (if (supportEmail.asKnown().isPresent) 1 else 0) + (if (url.asKnown().isPresent) 1 else 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Body && description == other.description && name == other.name && statementDescriptor == other.statementDescriptor && supportEmail == other.supportEmail && url == other.url && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "Body{description=$description, name=$name, statementDescriptor=$statementDescriptor, supportEmail=$supportEmail, url=$url, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is BrandCreateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(body, additionalHeaders, additionalQueryParams)

    override fun toString() = "BrandCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
