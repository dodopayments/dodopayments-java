...
class ItemDeleteParams private constructor(
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is ItemDeleteParams && id == other.id && groupId == other.groupId && itemId == other.itemId && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams && additionalBodyProperties == other.additionalBodyProperties
    }

    override fun hashCode(): Int = Objects.hash(id, groupId, itemId, additionalHeaders, additionalQueryParams, additionalBodyProperties)

    override fun toString() = "ItemDeleteParams{id=$id, groupId=$groupId, itemId=$itemId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}
