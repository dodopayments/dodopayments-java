...
class WebhookEventType @JsonCreator private constructor(private val value: JsonField<String>) :
    ...
    companion object {
        ...
        @JvmField val SUBSCRIPTION_PAST_DUE = of("subscription.past_due")

        @JvmField val SUBSCRIPTION_PAUSED = of("subscription.paused")

        @JvmField val SUBSCRIPTION_UNPAUSED = of("subscription.unpaused")
        ...
        @JvmField val SUBSCRIPTION_UPDATE_PAYMENT_METHOD = of("subscription.update_payment_method")

        @JvmField val LICENSE_KEY_CREATED = of("license_key.created")

        @JvmField val PAYOUT_CREATED = of("payout.created")
        ...
        @JvmField val CREDIT_OVERAGE_RESET = of("credit.overage_reset")

        @JvmField val CREDIT_MANUAL_ADJUSTMENT = of("credit.manual_adjustment")

        @JvmField val CREDIT_BALANCE_LOW = of("credit.balance_low")

        @JvmField val ABANDONED_CHECKOUT_DETECTED = of("abandoned_checkout.detected")

        @JvmField val ABANDONED_CHECKOUT_RECOVERED = of("abandoned_checkout.recovered")

        @JvmField val DUNNING_STARTED = of("dunning.started")
        ...
        @JvmField val ENTITLEMENT_GRANT_FAILED = of("entitlement_grant.failed")

        @JvmField val ENTITLEMENT_GRANT_REVOKED = of("entitlement_grant.revoked")
