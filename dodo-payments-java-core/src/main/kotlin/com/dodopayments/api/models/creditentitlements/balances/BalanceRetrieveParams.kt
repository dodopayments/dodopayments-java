 ...
 */
class BalanceRetrieveParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(balanceRetrieveParams: BalanceRetrieveParams) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is BalanceRetrieveParams && creditEntitlementId == other.creditEntitlementId && customerId == other.customerId && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(creditEntitlementId, customerId, additionalHeaders, additionalQueryParams)

    override fun toString() = "BalanceRetrieveParams{creditEntitlementId=$creditEntitlementId, customerId=$customerId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
