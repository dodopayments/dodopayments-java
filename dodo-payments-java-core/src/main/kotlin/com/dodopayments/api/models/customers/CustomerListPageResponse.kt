...
class CustomerListPageResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    @JsonProperty("items")
    @ExcludeMissing
    fun _items(): JsonField<List<Customer>> = items
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(customerListPageResponse: CustomerListPageResponse) =
            apply {
         ...
         *
         * You should usually call [Builder.items] with a well-typed `List<Customer>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun items(items: JsonField<List<Customer>>) =
            apply {
     ...
     *   expected type.
     */
    fun validate(): CustomerListPageResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is CustomerListPageResponse && items == other.items && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "CustomerListPageResponse{items=$items, additionalProperties=$additionalProperties}"
}
