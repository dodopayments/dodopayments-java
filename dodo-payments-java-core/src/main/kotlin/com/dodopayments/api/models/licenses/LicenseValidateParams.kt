...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        /**
         * Alias for calling [Builder.licenseKeyInstanceId] with
         * `licenseKeyInstanceId.orElse(null)`.
         */
        fun licenseKeyInstanceId(licenseKeyInstanceId: Optional<String>) =
            licenseKeyInstanceId(licenseKeyInstanceId.getOrNull())
    ...
    private constructor(
         ...
         */
        fun licenseKeyInstanceId(): Optional<String> =
            licenseKeyInstanceId.getOptional("license_key_instance_id")
        ...
        internal fun validity(): Int =
            (if (licenseKey.asKnown().isPresent) 1 else 0) +
                (if (licenseKeyInstanceId.asKnown().isPresent) 1 else 0)
