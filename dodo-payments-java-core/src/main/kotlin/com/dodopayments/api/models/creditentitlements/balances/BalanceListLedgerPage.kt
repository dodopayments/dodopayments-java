...
class BalanceListLedgerPage private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(balanceListLedgerPage: BalanceListLedgerPage) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is BalanceListLedgerPage && service == other.service && params == other.params && response == other.response
    }

    override fun hashCode(): Int = Objects.hash(service, params, response)

    override fun toString() = "BalanceListLedgerPage{service=$service, params=$params, response=$response}"
}
