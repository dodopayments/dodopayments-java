...
class LicenseKeyInstanceListPageResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("items") @ExcludeMissing items: JsonField<List<LicenseKeyInstance>> = JsonMissing.of()
    ) : this(
      items, mutableMapOf()
    )
    ...
    @JsonProperty("items")
    @ExcludeMissing
    fun _items(): JsonField<List<LicenseKeyInstance>> = items
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LicenseKeyInstanceListPageResponse].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(licenseKeyInstanceListPageResponse: LicenseKeyInstanceListPageResponse) =
            apply {
                ...
                additionalProperties = licenseKeyInstanceListPageResponse.additionalProperties.toMutableMap()
            }
         ...
         *
         * You should usually call [Builder.items] with a well-typed `List<LicenseKeyInstance>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun items(items: JsonField<List<LicenseKeyInstance>>) =
            apply {
         ...
         */
        fun addItem(item: LicenseKeyInstance) =
            apply {
     ...
     *   expected type.
     */
    fun validate(): LicenseKeyInstanceListPageResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is LicenseKeyInstanceListPageResponse && items == other.items && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "LicenseKeyInstanceListPageResponse{items=$items, additionalProperties=$additionalProperties}"
}
