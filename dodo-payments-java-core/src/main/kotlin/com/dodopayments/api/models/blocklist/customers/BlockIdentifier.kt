...
private constructor(
    ...
    fun byCustomerId(): Optional<BlockByCustomerId> = Optional.ofNullable(byCustomerId)

    fun byEmail(): Optional<BlockByEmail> = Optional.ofNullable(byEmail)
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = blockIdentifier.accept(new BlockIdentifier.Visitor<Optional<String>>() {
     *     @Override
     *     public Optional<String> visitByCustomerId(BlockByCustomerId byCustomerId) {
     *         return Optional.of(byCustomerId.toString());
     *     }
     *
     *     // ...
     *
    ...
    companion object {
        ...
        @JvmStatic fun ofByEmail(byEmail: BlockByEmail) = BlockIdentifier(byEmail = byEmail)
    }
