...
class ProductCollection @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("groups") @ExcludeMissing groups: JsonField<List<ProductCollectionGroupResponse>> = JsonMissing.of(),
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(productCollection: ProductCollection) =
            apply {
         ...
         *
         * You should usually call [Builder.groups] with a well-typed `List<ProductCollectionGroupResponse>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun groups(groups: JsonField<List<ProductCollectionGroupResponse>>) =
            apply {
         ...
         */
        fun addGroup(group: ProductCollectionGroupResponse) =
            apply {
     ...
     *   expected type.
     */
    fun validate(): ProductCollection =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (id.asKnown().isPresent) 1 else 0) + (if (brandId.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (groups.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (if (name.asKnown().isPresent) 1 else 0) + (if (updatedAt.asKnown().isPresent) 1 else 0) + (if (description.asKnown().isPresent) 1 else 0) + (if (image.asKnown().isPresent) 1 else 0)
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is ProductCollection && id == other.id && brandId == other.brandId && createdAt == other.createdAt && groups == other.groups && name == other.name && updatedAt == other.updatedAt && description == other.description && image == other.image && additionalProperties == other.additionalProperties
    }

    private val hashCode: Int by lazy { Objects.hash(id, brandId, createdAt, groups, name, updatedAt, description, image, additionalProperties) }

    override fun hashCode(): Int = hashCode

    override fun toString() = "ProductCollection{id=$id, brandId=$brandId, createdAt=$createdAt, groups=$groups, name=$name, updatedAt=$updatedAt, description=$description, image=$image, additionalProperties=$additionalProperties}"
}
