 ...
 */
class BalanceCreateLedgerEntryParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BalanceCreateLedgerEntryParams].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(balanceCreateLedgerEntryParams: BalanceCreateLedgerEntryParams) =
            apply {
        ...
        /** Entry type: credit or debit */
        fun entryType(entryType: LedgerEntryType) =
            apply {
    ...
    class Body @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (amount.asKnown().isPresent) 1 else 0) + (entryType.asKnown().getOrNull()?.validity() ?: 0) + (if (expiresAt.asKnown().isPresent) 1 else 0) + (if (idempotencyKey.asKnown().isPresent) 1 else 0) + (metadata.asKnown().getOrNull()?.validity() ?: 0) + (if (reason.asKnown().isPresent) 1 else 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Body && amount == other.amount && entryType == other.entryType && expiresAt == other.expiresAt && idempotencyKey == other.idempotencyKey && metadata == other.metadata && reason == other.reason && additionalProperties == other.additionalProperties
        }

        private val hashCode: Int by lazy { Objects.hash(amount, entryType, expiresAt, idempotencyKey, metadata, reason, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() = "Body{amount=$amount, entryType=$entryType, expiresAt=$expiresAt, idempotencyKey=$idempotencyKey, metadata=$metadata, reason=$reason, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is BalanceCreateLedgerEntryParams && creditEntitlementId == other.creditEntitlementId && customerId == other.customerId && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(creditEntitlementId, customerId, body, additionalHeaders, additionalQueryParams)

    override fun toString() = "BalanceCreateLedgerEntryParams{creditEntitlementId=$creditEntitlementId, customerId=$customerId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
