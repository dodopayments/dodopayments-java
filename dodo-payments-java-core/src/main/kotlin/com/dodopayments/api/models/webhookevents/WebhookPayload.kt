...
private constructor(
    ...
    private constructor(
        ...
        private constructor(
             ...
             *   (e.g. if the server responded with an unexpected value).
             */
            fun feature(): Optional<EntitlementGrant.Feature> = feature.getOptional("feature")
            ...
            class Builder internal constructor() {
                ...
                fun feature(feature: Optional<EntitlementGrant.Feature>) =
                    feature(feature.getOrNull())
