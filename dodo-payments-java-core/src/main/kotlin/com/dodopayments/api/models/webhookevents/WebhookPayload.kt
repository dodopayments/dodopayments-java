...
private constructor(
    ...
    private constructor(
        ...
        fun payout(): Optional<Payout> = Optional.ofNullable(payout)
        ...
        companion object {
            ...
            @JvmStatic fun ofPayout(payout: Payout) = Data(payout = payout)
        ...
        private constructor(
             ...
             *   (e.g. if the server responded with an unexpected value).
             */
            fun pastDueEndsAt(): Optional<OffsetDateTime> =
                pastDueEndsAt.getOptional("past_due_ends_at")
            ...
            class Builder internal constructor() {
                ...
                /** Alias for calling [Builder.pastDueEndsAt] with `pastDueEndsAt.orElse(null)`. */
                fun pastDueEndsAt(pastDueEndsAt: Optional<OffsetDateTime>) =
                    pastDueEndsAt(pastDueEndsAt.getOrNull())
            ...
            internal fun validity(): Int =
                (addons.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) +
                    ...
                    (if (pastDueEndsAt.asKnown().isPresent) 1 else 0)
        ...
        private constructor(
            ...
            fun payoutDocumentUrl(): Optional<String> =
                payoutDocumentUrl.getOptional("payout_document_url")
            ...
            class Builder internal constructor() {
                ...
                /**
                 * Alias for calling [Builder.payoutDocumentUrl] with
                 * `payoutDocumentUrl.orElse(null)`.
                 */
