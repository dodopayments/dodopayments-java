    ...
    class Data private constructor(
        ...
        class Payment @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            ...
            private constructor(
                ...
                @JsonProperty("disputes") @ExcludeMissing disputes: JsonField<List<Dispute>> = JsonMissing.of(),
                @JsonProperty("metadata") @ExcludeMissing metadata: JsonField<Payment.Metadata> = JsonMissing.of(),
                ...
                @JsonProperty("product_cart") @ExcludeMissing productCart: JsonField<List<Payment.ProductCart>> = JsonMissing.of(),
             ...
             * @throws DodoPaymentsInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
             */
            fun productCart(): Optional<List<Payment.ProductCart>> = productCart.getOptional("product_cart")
            ...
            class Builder internal constructor() {
                 ...
                 *
                 * You should usually call [Builder.disputes] with a well-typed `List<Dispute>` value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun disputes(disputes: JsonField<List<Dispute>>) =
                    apply {
                 ...
                 *
                 * You should usually call [Builder.metadata] with a well-typed [Payment.Metadata] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun metadata(metadata: JsonField<Payment.Metadata>) =
                    apply {
                ...
                /** List of products purchased in a one-time payment */
                fun productCart(productCart: List<Payment.ProductCart>?) = productCart(JsonField.ofNullable(productCart))

                /** Alias for calling [Builder.productCart] with `productCart.orElse(null)`. */
                fun productCart(productCart: Optional<List<Payment.ProductCart>>) = productCart(productCart.getOrNull())

                /**
                 * Sets [Builder.productCart] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.productCart] with a well-typed `List<Payment.ProductCart>` value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun productCart(productCart: JsonField<List<Payment.ProductCart>>) =
                    apply {
                 ...
                 * @throws IllegalStateException if the field was previously set to a non-list.
                 */
                fun addProductCart(productCart: Payment.ProductCart) =
                    apply {
        ...
        class Subscription @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            ...
            private constructor(
                ...
                @JsonProperty("currency") @ExcludeMissing currency: JsonField<Currency> = JsonMissing.of(),
                @JsonProperty("customer") @ExcludeMissing customer: JsonField<CustomerLimitedDetails> = JsonMissing.of(),
                @JsonProperty("metadata") @ExcludeMissing metadata: JsonField<Subscription.Metadata> = JsonMissing.of(),
            ...
            class Builder internal constructor() {
                 ...
                 * Sets [Builder.metadata] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.metadata] with a well-typed [Subscription.Metadata] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun metadata(metadata: JsonField<Subscription.Metadata>) =
                    apply {
                        this.metadata = metadata
                    }
        ...
        class Refund @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            ...
            private constructor(
                ...
                @JsonProperty("metadata") @ExcludeMissing metadata: JsonField<Refund.Metadata> = JsonMissing.of(),
                @JsonProperty("payment_id") @ExcludeMissing paymentId: JsonField<String> = JsonMissing.of(),
            ...
            class Builder internal constructor() {
                 ...
                 * Sets [Builder.metadata] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.metadata] with a well-typed [Refund.Metadata] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun metadata(metadata: JsonField<Refund.Metadata>) =
                    apply {
                        this.metadata = metadata
                    }
        ...
        class LicenseKey @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            ...
            private constructor(
                ...
                @JsonProperty("product_id") @ExcludeMissing productId: JsonField<String> = JsonMissing.of(),
                @JsonProperty("source") @ExcludeMissing source: JsonField<LicenseKey.Source> = JsonMissing.of(),
            ...
            class Builder internal constructor() {
                 ...
                 *
                 * You should usually call [Builder.source] with a well-typed [LicenseKey.Source] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun source(source: JsonField<LicenseKey.Source>) =
                    apply {
                        this.source = source
                    }
        ...
        class CreditLedgerEntry @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            ...
            private constructor(
                ...
                @JsonProperty("transaction_type") @ExcludeMissing transactionType: JsonField<CreditLedgerEntry.TransactionType> = JsonMissing.of(),
            ...
            /** @throws DodoPaymentsInvalidDataException if the JSON field has an unexpected type or is unexpectedly missing or null (e.g. if the server responded with an unexpected value). */
            fun transactionType(): CreditLedgerEntry.TransactionType = transactionType.getRequired("transaction_type")
            ...
            class Builder internal constructor() {
                ...
                fun transactionType(transactionType: CreditLedgerEntry.TransactionType) = transactionType(JsonField.of(transactionType))

                /**
                 * Sets [Builder.transactionType] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.transactionType] with a well-typed [CreditLedgerEntry.TransactionType] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
        ...
        class EntitlementGrant @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            ...
            private constructor(
                ...
                @JsonProperty("metadata") @ExcludeMissing metadata: JsonField<EntitlementGrant.Metadata> = JsonMissing.of(),
                @JsonProperty("status") @ExcludeMissing status: JsonField<EntitlementGrant.Status> = JsonMissing.of(),
                @JsonProperty("updated_at") @ExcludeMissing updatedAt: JsonField<OffsetDateTime> = JsonMissing.of(),
            ...
            class Builder internal constructor() {
                 ...
                 * Sets [Builder.metadata] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.metadata] with a well-typed [EntitlementGrant.Metadata] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun metadata(metadata: JsonField<EntitlementGrant.Metadata>) =
                    apply {
                        this.metadata = metadata
                    }
                 ...
                 * Sets [Builder.status] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.status] with a well-typed [EntitlementGrant.Status] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun status(status: JsonField<EntitlementGrant.Status>) =
                    apply {
                        this.status = status
                    }
