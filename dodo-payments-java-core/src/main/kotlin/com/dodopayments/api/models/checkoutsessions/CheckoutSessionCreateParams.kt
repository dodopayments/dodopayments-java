...
class CheckoutSessionCreateParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(checkoutSessionCreateParams: CheckoutSessionCreateParams) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is CheckoutSessionCreateParams && checkoutSessionRequest == other.checkoutSessionRequest && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(checkoutSessionRequest, additionalHeaders, additionalQueryParams)

    override fun toString() = "CheckoutSessionCreateParams{checkoutSessionRequest=$checkoutSessionRequest, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
