...
class LicenseKeyCreatedWebhookEvent @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<LicenseKey> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LicenseKeyCreatedWebhookEvent].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(licenseKeyCreatedWebhookEvent: LicenseKeyCreatedWebhookEvent) =
            apply {
         ...
         *
         * You should usually call [Builder.data] with a well-typed [LicenseKey] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<LicenseKey>) =
            apply {
                this.data = data
            }
     ...
     *   expected type.
     */
    fun validate(): LicenseKeyCreatedWebhookEvent =
        apply {
            if (validated) {
              return@apply
            }
    ...
    internal fun validity(): Int =
        (if (businessId.asKnown().isPresent) 1 else 0) + (data.asKnown().getOrNull()?.validity() ?: 0) + (if (timestamp.asKnown().isPresent) 1 else 0) + type.let {
            if (it == JsonValue.from("license_key.created")) 1 else 0
        }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is LicenseKeyCreatedWebhookEvent && businessId == other.businessId && data == other.data && timestamp == other.timestamp && type == other.type && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "LicenseKeyCreatedWebhookEvent{businessId=$businessId, data=$data, timestamp=$timestamp, type=$type, additionalProperties=$additionalProperties}"
}
