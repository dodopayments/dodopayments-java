 ...
 */
class CreditEntitlementUpdateParams private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [CreditEntitlementUpdateParams]. */
        @JvmStatic
        fun builder() = Builder()
    }
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(creditEntitlementUpdateParams: CreditEntitlementUpdateParams) =
            apply {
    ...
    class Body @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (currency.asKnown().getOrNull()?.validity() ?: 0) + (if (description.asKnown().isPresent) 1 else 0) + (if (expiresAfterDays.asKnown().isPresent) 1 else 0) + (if (maxRolloverCount.asKnown().isPresent) 1 else 0) + (if (name.asKnown().isPresent) 1 else 0) + (overageBehavior.asKnown().getOrNull()?.validity() ?: 0) + (if (overageEnabled.asKnown().isPresent) 1 else 0) + (if (overageLimit.asKnown().isPresent) 1 else 0) + (if (pricePerUnit.asKnown().isPresent) 1 else 0) + (if (rolloverEnabled.asKnown().isPresent) 1 else 0) + (if (rolloverPercentage.asKnown().isPresent) 1 else 0) + (if (rolloverTimeframeCount.asKnown().isPresent) 1 else 0) + (rolloverTimeframeInterval.asKnown().getOrNull()?.validity() ?: 0) + (if (unit.asKnown().isPresent) 1 else 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Body && currency == other.currency && description == other.description && expiresAfterDays == other.expiresAfterDays && maxRolloverCount == other.maxRolloverCount && name == other.name && overageBehavior == other.overageBehavior && overageEnabled == other.overageEnabled && overageLimit == other.overageLimit && pricePerUnit == other.pricePerUnit && rolloverEnabled == other.rolloverEnabled && rolloverPercentage == other.rolloverPercentage && rolloverTimeframeCount == other.rolloverTimeframeCount && rolloverTimeframeInterval == other.rolloverTimeframeInterval && unit == other.unit && additionalProperties == other.additionalProperties
        }

        private val hashCode: Int by lazy { Objects.hash(currency, description, expiresAfterDays, maxRolloverCount, name, overageBehavior, overageEnabled, overageLimit, pricePerUnit, rolloverEnabled, rolloverPercentage, rolloverTimeframeCount, rolloverTimeframeInterval, unit, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() = "Body{currency=$currency, description=$description, expiresAfterDays=$expiresAfterDays, maxRolloverCount=$maxRolloverCount, name=$name, overageBehavior=$overageBehavior, overageEnabled=$overageEnabled, overageLimit=$overageLimit, pricePerUnit=$pricePerUnit, rolloverEnabled=$rolloverEnabled, rolloverPercentage=$rolloverPercentage, rolloverTimeframeCount=$rolloverTimeframeCount, rolloverTimeframeInterval=$rolloverTimeframeInterval, unit=$unit, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is CreditEntitlementUpdateParams && id == other.id && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(id, body, additionalHeaders, additionalQueryParams)

    override fun toString() = "CreditEntitlementUpdateParams{id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
