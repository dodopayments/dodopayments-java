...
class BrandListResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    @JsonProperty("items")
    @ExcludeMissing
    fun _items(): JsonField<List<Brand>> = items
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(brandListResponse: BrandListResponse) =
            apply {
         ...
         *
         * You should usually call [Builder.items] with a well-typed `List<Brand>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun items(items: JsonField<List<Brand>>) =
            apply {
     ...
     *   expected type.
     */
    fun validate(): BrandListResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is BrandListResponse && items == other.items && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "BrandListResponse{items=$items, additionalProperties=$additionalProperties}"
}
