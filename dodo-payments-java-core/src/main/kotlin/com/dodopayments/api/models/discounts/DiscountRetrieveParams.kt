...
class DiscountRetrieveParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(discountRetrieveParams: DiscountRetrieveParams) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is DiscountRetrieveParams && discountId == other.discountId && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(discountId, additionalHeaders, additionalQueryParams)

    override fun toString() = "DiscountRetrieveParams{discountId=$discountId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
