...
class SubscriptionExpiredWebhookEvent @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SubscriptionExpiredWebhookEvent].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(subscriptionExpiredWebhookEvent: SubscriptionExpiredWebhookEvent) =
            apply {
                ...
                additionalProperties = subscriptionExpiredWebhookEvent.additionalProperties.toMutableMap()
            }
     ...
     *   expected type.
     */
    fun validate(): SubscriptionExpiredWebhookEvent =
        apply {
            if (validated) {
              return@apply
            }
    ...
    internal fun validity(): Int =
        (if (businessId.asKnown().isPresent) 1 else 0) + (data.asKnown().getOrNull()?.validity() ?: 0) + (if (timestamp.asKnown().isPresent) 1 else 0) + type.let {
            if (it == JsonValue.from("subscription.expired")) 1 else 0
        }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is SubscriptionExpiredWebhookEvent && businessId == other.businessId && data == other.data && timestamp == other.timestamp && type == other.type && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "SubscriptionExpiredWebhookEvent{businessId=$businessId, data=$data, timestamp=$timestamp, type=$type, additionalProperties=$additionalProperties}"
}
