...
class PayoutListResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("chargebacks") @ExcludeMissing chargebacks: JsonField<Long> = JsonMissing.of(),
        ...
        @JsonProperty("payout_document_url") @ExcludeMissing payoutDocumentUrl: JsonField<String> = JsonMissing.of(),
    ...
    @ExcludeMissing
    fun _payoutId(): JsonField<String> = payoutId
     ...
     *
     * Unlike [payoutDocumentUrl], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(payoutListResponse: PayoutListResponse) =
            apply {
         ...
         *
         * You should usually call [Builder.chargebacks] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        @Deprecated("Use the v3 payout breakup endpoints instead. Will be removed in a future release.")
        fun chargebacks(chargebacks: JsonField<Long>) =
            apply {
         ...
         *
         * You should usually call [Builder.fee] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun fee(fee: JsonField<Long>) =
            apply {
                this.fee = fee
            }
         ...
         *
         * You should usually call [Builder.payoutId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun payoutId(payoutId: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.refunds] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        @Deprecated("Use the v3 payout breakup endpoints instead. Will be removed in a future release.")
        fun refunds(refunds: JsonField<Long>) =
            apply {
         ...
         *
         * You should usually call [Builder.tax] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        @Deprecated("Use the v3 payout breakup endpoints instead. Will be removed in a future release.")
        fun tax(tax: JsonField<Long>) =
            apply {
                this.tax = tax
            }
        ...
        /** The URL of the document associated with the payout. */
        fun payoutDocumentUrl(payoutDocumentUrl: String?) = payoutDocumentUrl(JsonField.ofNullable(payoutDocumentUrl))

        /** Alias for calling [Builder.payoutDocumentUrl] with `payoutDocumentUrl.orElse(null)`. */
        fun payoutDocumentUrl(payoutDocumentUrl: Optional<String>) = payoutDocumentUrl(payoutDocumentUrl.getOrNull())

        /**
         * Sets [Builder.payoutDocumentUrl] to an arbitrary JSON value.
         *
         * You should usually call [Builder.payoutDocumentUrl] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun payoutDocumentUrl(payoutDocumentUrl: JsonField<String>) =
            apply {
     ...
     *   expected type.
     */
    fun validate(): PayoutListResponse =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (amount.asKnown().isPresent) 1 else 0) + (if (businessId.asKnown().isPresent) 1 else 0) + (if (chargebacks.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (currency.asKnown().getOrNull()?.validity() ?: 0) + (if (fee.asKnown().isPresent) 1 else 0) + (if (paymentMethod.asKnown().isPresent) 1 else 0) + (if (payoutId.asKnown().isPresent) 1 else 0) + (if (refunds.asKnown().isPresent) 1 else 0) + (status.asKnown().getOrNull()?.validity() ?: 0) + (if (tax.asKnown().isPresent) 1 else 0) + (if (updatedAt.asKnown().isPresent) 1 else 0) + (if (name.asKnown().isPresent) 1 else 0) + (if (payoutDocumentUrl.asKnown().isPresent) 1 else 0) + (if (remarks.asKnown().isPresent) 1 else 0)
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is PayoutListResponse && amount == other.amount && businessId == other.businessId && chargebacks == other.chargebacks && createdAt == other.createdAt && currency == other.currency && fee == other.fee && paymentMethod == other.paymentMethod && payoutId == other.payoutId && refunds == other.refunds && status == other.status && tax == other.tax && updatedAt == other.updatedAt && name == other.name && payoutDocumentUrl == other.payoutDocumentUrl && remarks == other.remarks && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "PayoutListResponse{amount=$amount, businessId=$businessId, chargebacks=$chargebacks, createdAt=$createdAt, currency=$currency, fee=$fee, paymentMethod=$paymentMethod, payoutId=$payoutId, refunds=$refunds, status=$status, tax=$tax, updatedAt=$updatedAt, name=$name, payoutDocumentUrl=$payoutDocumentUrl, remarks=$remarks, additionalProperties=$additionalProperties}"
}
