...
class UnwrapWebhookParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(unwrapWebhookParams: UnwrapWebhookParams) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is UnwrapWebhookParams && body == other.body && headers == other.headers && secret == other.secret
    }
