...
class FileServiceAsyncImpl internal constructor(
    ...
    override fun delete(params: FileDeleteParams, requestOptions: RequestOptions): CompletableFuture<Void?> =
        // delete /entitlements/{id}/files/{file_id}
        withRawResponse().delete(params, requestOptions).thenAccept {}

    override fun upload(params: FileUploadParams, requestOptions: RequestOptions): CompletableFuture<FileUploadResponse> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun delete(params: FileDeleteParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
        ...
        override fun upload(params: FileUploadParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<FileUploadResponse>> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
