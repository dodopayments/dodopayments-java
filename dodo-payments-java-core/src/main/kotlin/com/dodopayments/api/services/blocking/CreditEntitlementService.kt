...
interface CreditEntitlementService {
    ...
    /** @see create */
    fun create(params: CreditEntitlementCreateParams, requestOptions: RequestOptions = RequestOptions.none()): CreditEntitlement
    ...
    /** @see retrieve */
    fun retrieve(id: String, params: CreditEntitlementRetrieveParams = CreditEntitlementRetrieveParams.none(), requestOptions: RequestOptions = RequestOptions.none()): CreditEntitlement =
        retrieve(
          params.toBuilder()
              .id(id)
    ...
    /** @see retrieve */
    fun retrieve(id: String, params: CreditEntitlementRetrieveParams = CreditEntitlementRetrieveParams.none()): CreditEntitlement =
        retrieve(
          id,
          params,
          RequestOptions.none(),
    ...
    /** @see retrieve */
    fun retrieve(params: CreditEntitlementRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): CreditEntitlement
    ...
    /** @see update */
    fun update(id: String, params: CreditEntitlementUpdateParams = CreditEntitlementUpdateParams.none(), requestOptions: RequestOptions = RequestOptions.none()) =
        update(
          params.toBuilder()
              .id(id)
              .build(), requestOptions
    ...
    /** @see update */
    fun update(id: String, params: CreditEntitlementUpdateParams = CreditEntitlementUpdateParams.none()) =
        update(
          id,
          params,
          RequestOptions.none(),
    ...
    /** @see update */
    fun update(params: CreditEntitlementUpdateParams, requestOptions: RequestOptions = RequestOptions.none())

    /** @see update */
    fun update(params: CreditEntitlementUpdateParams) =
        update(
          params, RequestOptions.none()
        )
    ...
    /** @see list */
    fun list(params: CreditEntitlementListParams = CreditEntitlementListParams.none(), requestOptions: RequestOptions = RequestOptions.none()): CreditEntitlementListPage

    /** @see list */
    fun list(params: CreditEntitlementListParams = CreditEntitlementListParams.none()): CreditEntitlementListPage =
        list(
          params, RequestOptions.none()
        )
    ...
    /** @see delete */
    fun delete(id: String, params: CreditEntitlementDeleteParams = CreditEntitlementDeleteParams.none(), requestOptions: RequestOptions = RequestOptions.none()) =
        delete(
          params.toBuilder()
              .id(id)
              .build(), requestOptions
    ...
    /** @see delete */
    fun delete(id: String, params: CreditEntitlementDeleteParams = CreditEntitlementDeleteParams.none()) =
        delete(
          id,
          params,
          RequestOptions.none(),
    ...
    /** @see delete */
    fun delete(params: CreditEntitlementDeleteParams, requestOptions: RequestOptions = RequestOptions.none())

    /** @see delete */
    fun delete(params: CreditEntitlementDeleteParams) =
        delete(
          params, RequestOptions.none()
        )
     ...
     */
    fun undelete(id: String) =
        undelete(
          id, CreditEntitlementUndeleteParams.none()
        )

    /** @see undelete */
    fun undelete(id: String, params: CreditEntitlementUndeleteParams = CreditEntitlementUndeleteParams.none(), requestOptions: RequestOptions = RequestOptions.none()) =
        undelete(
          params.toBuilder()
              .id(id)
              .build(), requestOptions
    ...
    /** @see undelete */
    fun undelete(id: String, params: CreditEntitlementUndeleteParams = CreditEntitlementUndeleteParams.none()) =
        undelete(
          id,
          params,
          RequestOptions.none(),
    ...
    /** @see undelete */
    fun undelete(params: CreditEntitlementUndeleteParams, requestOptions: RequestOptions = RequestOptions.none())

    /** @see undelete */
    fun undelete(params: CreditEntitlementUndeleteParams) =
        undelete(
          params, RequestOptions.none()
        )
    ...
    /** A view of [CreditEntitlementService] that provides access to raw HTTP responses for each method. */
    interface WithRawResponse {
         ...
         * The original service is not modified.
         */
        fun withOptions(modifier: Consumer<ClientOptions.Builder>): CreditEntitlementService.WithRawResponse

        fun balances(): BalanceService.WithRawResponse

        /** Returns a raw HTTP response for `post /credit-entitlements`, but is otherwise the             same as [CreditEntitlementService.create]. */
        @MustBeClosed
        ...
        /** @see create */
        @MustBeClosed
        fun create(params: CreditEntitlementCreateParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<CreditEntitlement>

        /** Returns a raw HTTP response for `get /credit-entitlements/{id}`, but is otherwise the             same as [CreditEntitlementService.retrieve]. */
        @MustBeClosed
        ...
        /** @see retrieve */
        @MustBeClosed
        fun retrieve(id: String, params: CreditEntitlementRetrieveParams = CreditEntitlementRetrieveParams.none(), requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<CreditEntitlement> =
            retrieve(
              params.toBuilder()
                  .id(id)
                  .build(), requestOptions
        ...
        /** @see retrieve */
        @MustBeClosed
        fun retrieve(id: String, params: CreditEntitlementRetrieveParams = CreditEntitlementRetrieveParams.none()): HttpResponseFor<CreditEntitlement> =
            retrieve(
              id,
              params,
              RequestOptions.none(),
        ...
        /** @see retrieve */
        @MustBeClosed
        fun retrieve(params: CreditEntitlementRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<CreditEntitlement>
        ...
        /** @see retrieve */
        @MustBeClosed
        fun retrieve(id: String, requestOptions: RequestOptions): HttpResponseFor<CreditEntitlement> =
            retrieve(
              id,
              CreditEntitlementRetrieveParams.none(),
              requestOptions,
        ...
        /** Returns a raw HTTP response for `patch /credit-entitlements/{id}`, but is otherwise the             same as [CreditEntitlementService.update]. */
        @MustBeClosed
        ...
        /** @see update */
        @MustBeClosed
        fun update(id: String, params: CreditEntitlementUpdateParams = CreditEntitlementUpdateParams.none(), requestOptions: RequestOptions = RequestOptions.none()): HttpResponse =
            update(
              params.toBuilder()
                  .id(id)
                  .build(), requestOptions
        ...
        /** @see update */
        @MustBeClosed
        fun update(id: String, params: CreditEntitlementUpdateParams = CreditEntitlementUpdateParams.none()): HttpResponse =
            update(
              id,
              params,
              RequestOptions.none(),
        ...
        /** @see update */
        @MustBeClosed
        fun update(params: CreditEntitlementUpdateParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponse
        ...
        /** Returns a raw HTTP response for `get /credit-entitlements`, but is otherwise the             same as [CreditEntitlementService.list]. */
        @MustBeClosed
        fun list(): HttpResponseFor<CreditEntitlementListPage> = list(CreditEntitlementListParams.none())

        /** @see list */
        @MustBeClosed
        fun list(params: CreditEntitlementListParams = CreditEntitlementListParams.none(), requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<CreditEntitlementListPage>

        /** @see list */
        @MustBeClosed
        fun list(params: CreditEntitlementListParams = CreditEntitlementListParams.none()): HttpResponseFor<CreditEntitlementListPage> =
            list(
              params, RequestOptions.none()
            )
        ...
        /** Returns a raw HTTP response for `delete /credit-entitlements/{id}`, but is otherwise the             same as [CreditEntitlementService.delete]. */
        @MustBeClosed
        ...
        /** @see delete */
        @MustBeClosed
        fun delete(id: String, params: CreditEntitlementDeleteParams = CreditEntitlementDeleteParams.none(), requestOptions: RequestOptions = RequestOptions.none()): HttpResponse =
            delete(
              params.toBuilder()
                  .id(id)
                  .build(), requestOptions
        ...
        /** @see delete */
        @MustBeClosed
        fun delete(id: String, params: CreditEntitlementDeleteParams = CreditEntitlementDeleteParams.none()): HttpResponse =
            delete(
              id,
              params,
              RequestOptions.none(),
        ...
        /** @see delete */
        @MustBeClosed
        fun delete(params: CreditEntitlementDeleteParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponse
        ...
        /** Returns a raw HTTP response for `post /credit-entitlements/{id}/undelete`, but is otherwise the             same as [CreditEntitlementService.undelete]. */
        @MustBeClosed
        ...
        /** @see undelete */
        @MustBeClosed
        fun undelete(id: String, params: CreditEntitlementUndeleteParams = CreditEntitlementUndeleteParams.none(), requestOptions: RequestOptions = RequestOptions.none()): HttpResponse =
            undelete(
              params.toBuilder()
                  .id(id)
                  .build(), requestOptions
        ...
        /** @see undelete */
        @MustBeClosed
        fun undelete(id: String, params: CreditEntitlementUndeleteParams = CreditEntitlementUndeleteParams.none()): HttpResponse =
            undelete(
              id,
              params,
              RequestOptions.none(),
        ...
        /** @see undelete */
        @MustBeClosed
        fun undelete(params: CreditEntitlementUndeleteParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponse
