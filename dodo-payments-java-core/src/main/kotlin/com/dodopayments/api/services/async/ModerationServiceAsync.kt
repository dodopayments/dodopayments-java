...
interface ModerationServiceAsync {
     ...
     */
    fun retrieveUsage(): CompletableFuture<ModerationRetrieveUsageResponse> =
        retrieveUsage(ModerationRetrieveUsageParams.none())
     ...
     * (503).
     */
    fun screen(): CompletableFuture<ModerationScreenResponse> =
        screen(ModerationScreenParams.none())
    ...
    fun screen(
        params: ModerationScreenParams = ModerationScreenParams.none()
    ): CompletableFuture<ModerationScreenResponse> = screen(params, RequestOptions.none())

    /** @see screen */
    fun screen(requestOptions: RequestOptions): CompletableFuture<ModerationScreenResponse> =
    ...
    interface WithRawResponse {
         ...
         */
        fun retrieveUsage(): CompletableFuture<HttpResponseFor<ModerationRetrieveUsageResponse>> =
            retrieveUsage(ModerationRetrieveUsageParams.none())
         ...
         */
        fun screen(): CompletableFuture<HttpResponseFor<ModerationScreenResponse>> =
            screen(ModerationScreenParams.none())
        ...
        fun screen(
            ...
            screen(params, RequestOptions.none())
