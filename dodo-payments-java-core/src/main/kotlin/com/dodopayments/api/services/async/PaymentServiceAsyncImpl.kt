...
class PaymentServiceAsyncImpl internal constructor(
    ...
    override fun create(params: PaymentCreateParams, requestOptions: RequestOptions): CompletableFuture<PaymentCreateResponse> =
        // post /payments
        withRawResponse().create(params, requestOptions).thenApply { it.parse() }

    override fun retrieve(params: PaymentRetrieveParams, requestOptions: RequestOptions): CompletableFuture<Payment> =
        // get /payments/{payment_id}
        withRawResponse().retrieve(params, requestOptions).thenApply { it.parse() }

    override fun list(params: PaymentListParams, requestOptions: RequestOptions): CompletableFuture<PaymentListPageAsync> =
        // get /payments
        withRawResponse().list(params, requestOptions).thenApply { it.parse() }

    override fun retrieveLineItems(params: PaymentRetrieveLineItemsParams, requestOptions: RequestOptions): CompletableFuture<PaymentRetrieveLineItemsResponse> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        private val createHandler: Handler<PaymentCreateResponse> = jsonHandler<PaymentCreateResponse>(clientOptions.jsonMapper)

        @Deprecated("deprecated")
        override fun create(params: PaymentCreateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<PaymentCreateResponse>> {
        ...
        private val retrieveHandler: Handler<Payment> = jsonHandler<Payment>(clientOptions.jsonMapper)

        override fun retrieve(params: PaymentRetrieveParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<Payment>> {
        ...
        private val listHandler: Handler<PaymentListPageResponse> = jsonHandler<PaymentListPageResponse>(clientOptions.jsonMapper)

        override fun list(params: PaymentListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<PaymentListPageAsync>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
            .addPathSegments("payments")
        ...
        private val retrieveLineItemsHandler: Handler<PaymentRetrieveLineItemsResponse> = jsonHandler<PaymentRetrieveLineItemsResponse>(clientOptions.jsonMapper)

        override fun retrieveLineItems(params: PaymentRetrieveLineItemsParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<PaymentRetrieveLineItemsResponse>> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("paymentId", params.paymentId().getOrNull())
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
          ...
          return request.thenComposeAsync { clientOptions.httpClient.executeAsync(
            it, requestOptions
              ...
              response.use {
                  retrieveLineItemsHandler.handle(it)
              }
              .also {
                  if (requestOptions.responseValidation!!) {
                    it.validate()
