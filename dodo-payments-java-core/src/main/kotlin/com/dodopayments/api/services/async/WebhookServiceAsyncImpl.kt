...
class WebhookServiceAsyncImpl internal constructor(
    ...
    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): WebhookServiceAsync = WebhookServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())

    override fun headers(): HeaderServiceAsync = headers

    override fun create(params: WebhookCreateParams, requestOptions: RequestOptions): CompletableFuture<WebhookDetails> =
        // post /webhooks
        withRawResponse().create(params, requestOptions).thenApply { it.parse() }

    override fun retrieve(params: WebhookRetrieveParams, requestOptions: RequestOptions): CompletableFuture<WebhookDetails> =
        // get /webhooks/{webhook_id}
        withRawResponse().retrieve(params, requestOptions).thenApply { it.parse() }

    override fun update(params: WebhookUpdateParams, requestOptions: RequestOptions): CompletableFuture<WebhookDetails> =
        // patch /webhooks/{webhook_id}
        withRawResponse().update(params, requestOptions).thenApply { it.parse() }

    override fun list(params: WebhookListParams, requestOptions: RequestOptions): CompletableFuture<WebhookListPageAsync> =
        // get /webhooks
        withRawResponse().list(params, requestOptions).thenApply { it.parse() }

    override fun delete(params: WebhookDeleteParams, requestOptions: RequestOptions): CompletableFuture<Void?> =
        // delete /webhooks/{webhook_id}
        withRawResponse().delete(params, requestOptions).thenAccept {}

    override fun retrieveSecret(params: WebhookRetrieveSecretParams, requestOptions: RequestOptions): CompletableFuture<WebhookRetrieveSecretResponse> =
        // get /webhooks/{webhook_id}/secret
        withRawResponse().retrieveSecret(params, requestOptions).thenApply { it.parse() }

    override fun unsafeUnwrap(body: String): UnsafeUnwrapWebhookEvent = WebhookServiceImpl(clientOptions).unsafeUnwrap(body)

    override fun unwrap(body: String): UnwrapWebhookEvent = WebhookServiceImpl(clientOptions).unwrap(body)

    override fun unwrap(unwrapParams: UnwrapWebhookParams): UnwrapWebhookEvent = WebhookServiceImpl(clientOptions).unwrap(unwrapParams)
    ...
    class WithRawResponseImpl internal constructor(
        ...
        private val headers: HeaderServiceAsync.WithRawResponse by lazy { HeaderServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): WebhookServiceAsync.WithRawResponse = WebhookServiceAsyncImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())
        ...
        override fun create(params: WebhookCreateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<WebhookDetails>> {
        ...
        override fun retrieve(params: WebhookRetrieveParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<WebhookDetails>> {
        ...
        override fun update(params: WebhookUpdateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<WebhookDetails>> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("webhookId", params.webhookId().getOrNull())
          val request = HttpRequest.builder()
        ...
        override fun list(params: WebhookListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<WebhookListPageAsync>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
            .addPathSegments("webhooks")
        ...
        override fun delete(params: WebhookDeleteParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("webhookId", params.webhookId().getOrNull())
          val request = HttpRequest.builder()
        ...
        override fun retrieveSecret(params: WebhookRetrieveSecretParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<WebhookRetrieveSecretResponse>> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("webhookId", params.webhookId().getOrNull())
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
