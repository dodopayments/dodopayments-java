...
interface ShortLinkService {
    ...
    /** @see create */
    fun create(id: String, params: ShortLinkCreateParams, requestOptions: RequestOptions = RequestOptions.none()): ShortLinkCreateResponse =
        create(
          params.toBuilder()
              .id(id)
    ...
    /** @see create */
    fun create(params: ShortLinkCreateParams, requestOptions: RequestOptions = RequestOptions.none()): ShortLinkCreateResponse

    /** Lists all short links created by the business. */
    fun list(): ShortLinkListPage = list(ShortLinkListParams.none())

    /** @see list */
    fun list(params: ShortLinkListParams = ShortLinkListParams.none(), requestOptions: RequestOptions = RequestOptions.none()): ShortLinkListPage
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `post /products/{id}/short_links`, but is otherwise the             same as [ShortLinkService.create]. */
        @MustBeClosed
        fun create(id: String, params: ShortLinkCreateParams): HttpResponseFor<ShortLinkCreateResponse> =
            create(
              id,
              params,
              RequestOptions.none(),
        ...
        /** @see create */
        @MustBeClosed
        fun create(id: String, params: ShortLinkCreateParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<ShortLinkCreateResponse> =
            create(
              params.toBuilder()
                  .id(id)
                  .build(), requestOptions
        ...
        /** @see create */
        @MustBeClosed
        fun create(params: ShortLinkCreateParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<ShortLinkCreateResponse>

        /** Returns a raw HTTP response for `get /products/short_links`, but is otherwise the             same as [ShortLinkService.list]. */
        @MustBeClosed
        fun list(): HttpResponseFor<ShortLinkListPage> = list(ShortLinkListParams.none())

        /** @see list */
        @MustBeClosed
        fun list(params: ShortLinkListParams = ShortLinkListParams.none(), requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<ShortLinkListPage>

        /** @see list */
        @MustBeClosed
        fun list(params: ShortLinkListParams = ShortLinkListParams.none()): HttpResponseFor<ShortLinkListPage> =
            list(
              params, RequestOptions.none()
            )
