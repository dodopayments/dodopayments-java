...
interface ProductCollectionService {
    ...
    fun create(params: ProductCollectionCreateParams): ProductCollectionCreateResponse =
    ...
    fun retrieve(id: String): ProductCollectionRetrieveResponse =
    ...
    fun retrieve(
        id: String,
        params: ProductCollectionRetrieveParams = ProductCollectionRetrieveParams.none(),
    ): ProductCollectionRetrieveResponse = retrieve(id, params, RequestOptions.none())
    ...
    /** @see retrieve */
    fun retrieve(params: ProductCollectionRetrieveParams): ProductCollectionRetrieveResponse =
    ...
    interface WithRawResponse {
        ...
        fun create(
            params: ProductCollectionCreateParams
        ): HttpResponseFor<ProductCollectionCreateResponse> = create(params, RequestOptions.none())
         ...
         */
        @MustBeClosed
        fun retrieve(id: String): HttpResponseFor<ProductCollectionRetrieveResponse> =
            retrieve(id, ProductCollectionRetrieveParams.none())
