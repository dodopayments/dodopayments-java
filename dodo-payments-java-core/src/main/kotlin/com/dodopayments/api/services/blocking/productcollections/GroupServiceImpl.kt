...
class GroupServiceImpl internal constructor(
    ...
    override fun create(params: GroupCreateParams, requestOptions: RequestOptions): ProductCollectionGroupResponse =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun create(params: GroupCreateParams, requestOptions: RequestOptions): HttpResponseFor<ProductCollectionGroupResponse> {
        ...
        override fun update(params: GroupUpdateParams, requestOptions: RequestOptions): HttpResponse {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
        ...
        override fun delete(params: GroupDeleteParams, requestOptions: RequestOptions): HttpResponse {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("groupId", params.groupId().getOrNull())
          val request = HttpRequest.builder()
