...
interface YourWebhookUrlService {
     ...
     */
    fun withOptions(modifier: Consumer<ClientOptions.Builder>): YourWebhookUrlService

    fun create(params: YourWebhookUrlCreateParams) = create(params, RequestOptions.none())
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun create(params: YourWebhookUrlCreateParams): HttpResponse =
