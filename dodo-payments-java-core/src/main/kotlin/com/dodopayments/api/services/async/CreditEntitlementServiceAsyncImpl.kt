...
class CreditEntitlementServiceAsyncImpl internal constructor(
    private val clientOptions: ClientOptions,

) : CreditEntitlementServiceAsync {

    private val withRawResponse: CreditEntitlementServiceAsync.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }
    ...
    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): CreditEntitlementServiceAsync = CreditEntitlementServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())

    override fun balances(): BalanceServiceAsync = balances

    override fun create(params: CreditEntitlementCreateParams, requestOptions: RequestOptions): CompletableFuture<CreditEntitlement> =
        // post /credit-entitlements
        withRawResponse().create(params, requestOptions).thenApply { it.parse() }

    override fun retrieve(params: CreditEntitlementRetrieveParams, requestOptions: RequestOptions): CompletableFuture<CreditEntitlement> =
        // get /credit-entitlements/{id}
        withRawResponse().retrieve(params, requestOptions).thenApply { it.parse() }

    override fun update(params: CreditEntitlementUpdateParams, requestOptions: RequestOptions): CompletableFuture<Void?> =
        // patch /credit-entitlements/{id}
        withRawResponse().update(params, requestOptions).thenAccept {}

    override fun list(params: CreditEntitlementListParams, requestOptions: RequestOptions): CompletableFuture<CreditEntitlementListPageAsync> =
        // get /credit-entitlements
        withRawResponse().list(params, requestOptions).thenApply { it.parse() }

    override fun delete(params: CreditEntitlementDeleteParams, requestOptions: RequestOptions): CompletableFuture<Void?> =
        // delete /credit-entitlements/{id}
        withRawResponse().delete(params, requestOptions).thenAccept {}

    override fun undelete(params: CreditEntitlementUndeleteParams, requestOptions: RequestOptions): CompletableFuture<Void?> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): CreditEntitlementServiceAsync.WithRawResponse = CreditEntitlementServiceAsyncImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())
        ...
        override fun create(params: CreditEntitlementCreateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<CreditEntitlement>> {
        ...
        override fun retrieve(params: CreditEntitlementRetrieveParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<CreditEntitlement>> {
        ...
        override fun update(params: CreditEntitlementUpdateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("id", params.id().getOrNull())
          val request = HttpRequest.builder()
        ...
        override fun list(params: CreditEntitlementListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<CreditEntitlementListPageAsync>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
            .addPathSegments("credit-entitlements")
        ...
        override fun delete(params: CreditEntitlementDeleteParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("id", params.id().getOrNull())
          val request = HttpRequest.builder()
        ...
        override fun undelete(params: CreditEntitlementUndeleteParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("id", params.id().getOrNull())
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
