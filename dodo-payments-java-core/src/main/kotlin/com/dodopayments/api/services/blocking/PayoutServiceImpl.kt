...
class PayoutServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : PayoutService {

    private val withRawResponse: PayoutService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }
    ...
    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): PayoutService = PayoutServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    class WithRawResponseImpl internal constructor(
        ...
        private val breakup: BreakupService.WithRawResponse by lazy { BreakupServiceImpl.WithRawResponseImpl(clientOptions) }

        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): PayoutService.WithRawResponse = PayoutServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())
        ...
        override fun list(params: PayoutListParams, requestOptions: RequestOptions): HttpResponseFor<PayoutListPage> {
