...
interface UsageEventServiceAsync {
    ...
    fun retrieve(eventId: String): CompletableFuture<Event> =
        retrieve(
          eventId, UsageEventRetrieveParams.none()
        )

    /** @see retrieve */
    fun retrieve(eventId: String, params: UsageEventRetrieveParams = UsageEventRetrieveParams.none(), requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<Event> =
        retrieve(
          params.toBuilder()
              .eventId(eventId)
    ...
    /** @see retrieve */
    fun retrieve(eventId: String, params: UsageEventRetrieveParams = UsageEventRetrieveParams.none()): CompletableFuture<Event> =
        retrieve(
          eventId,
          params,
          RequestOptions.none(),
    ...
    /** @see retrieve */
    fun retrieve(params: UsageEventRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<Event>
    ...
    /** @see list */
    fun list(params: UsageEventListParams = UsageEventListParams.none(), requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<UsageEventListPageAsync>

    /** @see list */
    fun list(params: UsageEventListParams = UsageEventListParams.none()): CompletableFuture<UsageEventListPageAsync> =
        list(
          params, RequestOptions.none()
        )
    ...
    fun list(requestOptions: RequestOptions): CompletableFuture<UsageEventListPageAsync> =
        list(
          UsageEventListParams.none(), requestOptions
        )
    ...
    /** @see ingest */
    fun ingest(params: UsageEventIngestParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<UsageEventIngestResponse>

    /** A view of [UsageEventServiceAsync] that provides access to raw HTTP responses for each method. */
    interface WithRawResponse {
         ...
         * The original service is not modified.
         */
        fun withOptions(modifier: Consumer<ClientOptions.Builder>): UsageEventServiceAsync.WithRawResponse

        /** Returns a raw HTTP response for `get /events/{event_id}`, but is otherwise the             same as [UsageEventServiceAsync.retrieve]. */
        ...
        /** @see retrieve */
        fun retrieve(eventId: String, params: UsageEventRetrieveParams = UsageEventRetrieveParams.none(), requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<Event>> =
            retrieve(
              params.toBuilder()
                  .eventId(eventId)
                  .build(), requestOptions
        ...
        /** @see retrieve */
        fun retrieve(eventId: String, params: UsageEventRetrieveParams = UsageEventRetrieveParams.none()): CompletableFuture<HttpResponseFor<Event>> =
            retrieve(
              eventId,
              params,
              RequestOptions.none(),
        ...
        /** @see retrieve */
        fun retrieve(params: UsageEventRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<Event>>
        ...
        /** @see retrieve */
        fun retrieve(eventId: String, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<Event>> =
            retrieve(
              eventId,
              UsageEventRetrieveParams.none(),
              requestOptions,
        ...
        /** Returns a raw HTTP response for `get /events`, but is otherwise the             same as [UsageEventServiceAsync.list]. */
        fun list(): CompletableFuture<HttpResponseFor<UsageEventListPageAsync>> = list(UsageEventListParams.none())

        /** @see list */
        fun list(params: UsageEventListParams = UsageEventListParams.none(), requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<UsageEventListPageAsync>>

        /** @see list */
        fun list(params: UsageEventListParams = UsageEventListParams.none()): CompletableFuture<HttpResponseFor<UsageEventListPageAsync>> =
            list(
              params, RequestOptions.none()
            )

        /** @see list */
        fun list(requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<UsageEventListPageAsync>> =
            list(
              UsageEventListParams.none(), requestOptions
            )

        /** Returns a raw HTTP response for `post /events/ingest`, but is otherwise the             same as [UsageEventServiceAsync.ingest]. */
        fun ingest(params: UsageEventIngestParams): CompletableFuture<HttpResponseFor<UsageEventIngestResponse>> =
            ingest(
              params, RequestOptions.none()
            )

        /** @see ingest */
        fun ingest(params: UsageEventIngestParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<UsageEventIngestResponse>>
    }
}
