...
class LicenseServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : LicenseService {

    private val withRawResponse: LicenseService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): LicenseService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): LicenseService = LicenseServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())

    override fun activate(params: LicenseActivateParams, requestOptions: RequestOptions): LicenseActivateResponse =
    ...
    override fun validate(params: LicenseValidateParams, requestOptions: RequestOptions): LicenseValidateResponse =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): LicenseService.WithRawResponse = LicenseServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        private val activateHandler: Handler<LicenseActivateResponse> = jsonHandler<LicenseActivateResponse>(clientOptions.jsonMapper)

        override fun activate(params: LicenseActivateParams, requestOptions: RequestOptions): HttpResponseFor<LicenseActivateResponse> {
        ...
        override fun deactivate(params: LicenseDeactivateParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun validate(params: LicenseValidateParams, requestOptions: RequestOptions): HttpResponseFor<LicenseValidateResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
