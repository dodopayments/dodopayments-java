...
interface BrandService {
     ...
     */
    fun archive(id: String): BrandArchiveResponse = archive(id, BrandArchiveParams.none())
    ...
    fun archive(
        id: String,
        params: BrandArchiveParams = BrandArchiveParams.none(),
    ): BrandArchiveResponse = archive(id, params, RequestOptions.none())
    ...
    /** @see archive */
    fun archive(params: BrandArchiveParams): BrandArchiveResponse =
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun archive(id: String): HttpResponseFor<BrandArchiveResponse> =
        ...
        fun archive(
            id: String,
            params: BrandArchiveParams = BrandArchiveParams.none(),
        ): HttpResponseFor<BrandArchiveResponse> = archive(id, params, RequestOptions.none())
        ...
        /** @see archive */
        @MustBeClosed
        fun archive(params: BrandArchiveParams): HttpResponseFor<BrandArchiveResponse> =
            archive(params, RequestOptions.none())
