...
class LedgerEntryServiceAsyncImpl internal constructor(
    ...
    override fun create(params: LedgerEntryCreateParams, requestOptions: RequestOptions): CompletableFuture<CustomerWallet> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        private val createHandler: Handler<CustomerWallet> = jsonHandler<CustomerWallet>(clientOptions.jsonMapper)

        override fun create(params: LedgerEntryCreateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<CustomerWallet>> {
        ...
        private val listHandler: Handler<LedgerEntryListPageResponse> = jsonHandler<LedgerEntryListPageResponse>(clientOptions.jsonMapper)
