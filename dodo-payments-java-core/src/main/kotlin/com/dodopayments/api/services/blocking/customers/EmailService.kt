...
interface EmailService {
     ...
     */
    fun list(customerId: String): EmailListPage = list(customerId, EmailListParams.none())
    ...
    /** @see list */
    fun list(customerId: String, params: EmailListParams = EmailListParams.none()): EmailListPage =
    ...
    /** @see list */
    fun list(params: EmailListParams): EmailListPage = list(params, RequestOptions.none())
     ...
     */
    fun retrieveBody(emailLogId: String, params: EmailRetrieveBodyParams): EmailBody =
    ...
    /** @see retrieveBody */
    fun retrieveBody(params: EmailRetrieveBodyParams): EmailBody =
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun list(customerId: String): HttpResponseFor<EmailListPage> =
        ...
        fun list(
            customerId: String,
            params: EmailListParams = EmailListParams.none(),
        ): HttpResponseFor<EmailListPage> = list(customerId, params, RequestOptions.none())
        ...
        /** @see list */
        @MustBeClosed
        fun list(params: EmailListParams): HttpResponseFor<EmailListPage> =
        ...
        fun retrieveBody(
            emailLogId: String,
            params: EmailRetrieveBodyParams,
        ): HttpResponseFor<EmailBody> = retrieveBody(emailLogId, params, RequestOptions.none())
        ...
        /** @see retrieveBody */
        @MustBeClosed
        fun retrieveBody(params: EmailRetrieveBodyParams): HttpResponseFor<EmailBody> =
            retrieveBody(params, RequestOptions.none())
