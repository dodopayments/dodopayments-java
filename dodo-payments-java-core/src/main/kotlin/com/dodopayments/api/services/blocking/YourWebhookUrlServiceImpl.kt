...
class YourWebhookUrlServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): YourWebhookUrlService =
        YourWebhookUrlServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
