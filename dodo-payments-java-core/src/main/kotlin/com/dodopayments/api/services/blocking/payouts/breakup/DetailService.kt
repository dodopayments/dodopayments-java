...
interface DetailService {
     ...
     */
    fun list(payoutId: String): DetailListPage = list(payoutId, DetailListParams.none())
    ...
    /** @see list */
    fun list(params: DetailListParams): DetailListPage = list(params, RequestOptions.none())
     ...
     */
    fun downloadCsv(payoutId: String) = downloadCsv(payoutId, DetailDownloadCsvParams.none())
    ...
    fun downloadCsv(
        payoutId: String,
        params: DetailDownloadCsvParams = DetailDownloadCsvParams.none(),
    ) = downloadCsv(payoutId, params, RequestOptions.none())
    ...
    /** @see downloadCsv */
    fun downloadCsv(params: DetailDownloadCsvParams) = downloadCsv(params, RequestOptions.none())
    ...
    interface WithRawResponse {
        ...
        fun list(
            payoutId: String,
            params: DetailListParams = DetailListParams.none(),
        ): HttpResponseFor<DetailListPage> = list(payoutId, params, RequestOptions.none())
        ...
        fun downloadCsv(
            payoutId: String,
            params: DetailDownloadCsvParams = DetailDownloadCsvParams.none(),
        ): HttpResponse = downloadCsv(payoutId, params, RequestOptions.none())
