...
class WalletServiceAsyncImpl internal constructor(
    private val clientOptions: ClientOptions,

) : WalletServiceAsync {

    private val withRawResponse: WalletServiceAsync.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    private val ledgerEntries: LedgerEntryServiceAsync by lazy { LedgerEntryServiceAsyncImpl(clientOptions) }

    override fun withRawResponse(): WalletServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): WalletServiceAsync = WalletServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())

    override fun ledgerEntries(): LedgerEntryServiceAsync = ledgerEntries

    override fun list(params: WalletListParams, requestOptions: RequestOptions): CompletableFuture<WalletListResponse> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): WalletServiceAsync.WithRawResponse = WalletServiceAsyncImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())
        ...
        override fun list(params: WalletListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<WalletListResponse>> {
