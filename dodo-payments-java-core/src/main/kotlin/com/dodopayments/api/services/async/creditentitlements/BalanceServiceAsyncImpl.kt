...
class BalanceServiceAsyncImpl internal constructor(
    private val clientOptions: ClientOptions,

) : BalanceServiceAsync {

    private val withRawResponse: BalanceServiceAsync.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): BalanceServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): BalanceServiceAsync = BalanceServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())

    override fun retrieve(params: BalanceRetrieveParams, requestOptions: RequestOptions): CompletableFuture<CustomerCreditBalance> =
        // get /credit-entitlements/{credit_entitlement_id}/balances/{customer_id}
        withRawResponse().retrieve(params, requestOptions).thenApply { it.parse() }

    override fun list(params: BalanceListParams, requestOptions: RequestOptions): CompletableFuture<BalanceListPageAsync> =
        // get /credit-entitlements/{credit_entitlement_id}/balances
        withRawResponse().list(params, requestOptions).thenApply { it.parse() }

    override fun createLedgerEntry(params: BalanceCreateLedgerEntryParams, requestOptions: RequestOptions): CompletableFuture<BalanceCreateLedgerEntryResponse> =
    ...
    override fun listGrants(params: BalanceListGrantsParams, requestOptions: RequestOptions): CompletableFuture<BalanceListGrantsPageAsync> =
    ...
    override fun listLedger(params: BalanceListLedgerParams, requestOptions: RequestOptions): CompletableFuture<BalanceListLedgerPageAsync> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): BalanceServiceAsync.WithRawResponse = BalanceServiceAsyncImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        private val retrieveHandler: Handler<CustomerCreditBalance> = jsonHandler<CustomerCreditBalance>(clientOptions.jsonMapper)

        override fun retrieve(params: BalanceRetrieveParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<CustomerCreditBalance>> {
        ...
        override fun list(params: BalanceListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<BalanceListPageAsync>> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
        ...
        override fun createLedgerEntry(params: BalanceCreateLedgerEntryParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<BalanceCreateLedgerEntryResponse>> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("customerId", params.customerId().getOrNull())
          val request = HttpRequest.builder()
        ...
        override fun listGrants(params: BalanceListGrantsParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<BalanceListGrantsPageAsync>> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("customerId", params.customerId().getOrNull())
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
        ...
        override fun listLedger(params: BalanceListLedgerParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<BalanceListLedgerPageAsync>> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("customerId", params.customerId().getOrNull())
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
