...
class ShortLinkServiceAsyncImpl internal constructor(
    private val clientOptions: ClientOptions,

) : ShortLinkServiceAsync {

    private val withRawResponse: ShortLinkServiceAsync.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): ShortLinkServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): ShortLinkServiceAsync = ShortLinkServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())

    override fun create(params: ShortLinkCreateParams, requestOptions: RequestOptions): CompletableFuture<ShortLinkCreateResponse> =
        // post /products/{id}/short_links
        withRawResponse().create(params, requestOptions).thenApply { it.parse() }

    override fun list(params: ShortLinkListParams, requestOptions: RequestOptions): CompletableFuture<ShortLinkListPageAsync> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): ShortLinkServiceAsync.WithRawResponse = ShortLinkServiceAsyncImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        private val createHandler: Handler<ShortLinkCreateResponse> = jsonHandler<ShortLinkCreateResponse>(clientOptions.jsonMapper)

        override fun create(params: ShortLinkCreateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<ShortLinkCreateResponse>> {
        ...
        override fun list(params: ShortLinkListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<ShortLinkListPageAsync>> {
          val request = HttpRequest.builder()
