...
class NoteServiceImpl internal constructor(private val clientOptions: ClientOptions) : NoteService {
    ...
    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): NoteService =
        NoteServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            NoteServiceImpl.WithRawResponseImpl(
