...
class GroupServiceAsyncImpl internal constructor(
    ...
    override fun create(params: GroupCreateParams, requestOptions: RequestOptions): CompletableFuture<ProductCollectionGroupResponse> =
        // post /product-collections/{id}/groups
        withRawResponse().create(params, requestOptions).thenApply { it.parse() }

    override fun update(params: GroupUpdateParams, requestOptions: RequestOptions): CompletableFuture<Void?> =
        // patch /product-collections/{id}/groups/{group_id}
        withRawResponse().update(params, requestOptions).thenAccept {}

    override fun delete(params: GroupDeleteParams, requestOptions: RequestOptions): CompletableFuture<Void?> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        private val createHandler: Handler<ProductCollectionGroupResponse> = jsonHandler<ProductCollectionGroupResponse>(clientOptions.jsonMapper)

        override fun create(params: GroupCreateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<ProductCollectionGroupResponse>> {
        ...
        override fun update(params: GroupUpdateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("groupId", params.groupId().getOrNull())
          val request = HttpRequest.builder()
            .method(HttpMethod.PATCH)
            .baseUrl(clientOptions.baseUrl())
            .addPathSegments("product-collections", params._pathParam(0), "groups", params._pathParam(1))
            .body(json(clientOptions.jsonMapper, params._body()))
            .build()
            .prepareAsync(
              clientOptions, params
        ...
        override fun delete(params: GroupDeleteParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("groupId", params.groupId().getOrNull())
          val request = HttpRequest.builder()
