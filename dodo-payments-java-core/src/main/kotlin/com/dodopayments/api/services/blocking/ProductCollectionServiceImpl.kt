...
class ProductCollectionServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : ProductCollectionService {

    private val withRawResponse: ProductCollectionService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }
    ...
    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): ProductCollectionService = ProductCollectionServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())

    override fun groups(): GroupService = groups

    override fun create(params: ProductCollectionCreateParams, requestOptions: RequestOptions): ProductCollection =
        // post /product-collections
        withRawResponse().create(params, requestOptions).parse()

    override fun retrieve(params: ProductCollectionRetrieveParams, requestOptions: RequestOptions): ProductCollection =
    ...
    override fun list(params: ProductCollectionListParams, requestOptions: RequestOptions): ProductCollectionListPage =
    ...
    override fun unarchive(params: ProductCollectionUnarchiveParams, requestOptions: RequestOptions): ProductCollectionUnarchiveResponse =
        // post /product-collections/{id}/unarchive
        withRawResponse().unarchive(params, requestOptions).parse()

    override fun updateImages(params: ProductCollectionUpdateImagesParams, requestOptions: RequestOptions): ProductCollectionUpdateImagesResponse =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): ProductCollectionService.WithRawResponse = ProductCollectionServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())
        ...
        override fun create(params: ProductCollectionCreateParams, requestOptions: RequestOptions): HttpResponseFor<ProductCollection> {
        ...
        override fun retrieve(params: ProductCollectionRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<ProductCollection> {
        ...
        override fun update(params: ProductCollectionUpdateParams, requestOptions: RequestOptions): HttpResponse {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("id", params.id().getOrNull())
          val request = HttpRequest.builder()
        ...
        override fun list(params: ProductCollectionListParams, requestOptions: RequestOptions): HttpResponseFor<ProductCollectionListPage> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
            .addPathSegments("product-collections")
        ...
        override fun delete(params: ProductCollectionDeleteParams, requestOptions: RequestOptions): HttpResponse {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("id", params.id().getOrNull())
          val request = HttpRequest.builder()
        ...
        override fun unarchive(params: ProductCollectionUnarchiveParams, requestOptions: RequestOptions): HttpResponseFor<ProductCollectionUnarchiveResponse> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("id", params.id().getOrNull())
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
        ...
        override fun updateImages(params: ProductCollectionUpdateImagesParams, requestOptions: RequestOptions): HttpResponseFor<ProductCollectionUpdateImagesResponse> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("id", params.id().getOrNull())
          val request = HttpRequest.builder()
