...
class ProductServiceAsyncImpl internal constructor(
    ...
    private val shortLinks: ShortLinkServiceAsync by lazy { ShortLinkServiceAsyncImpl(clientOptions) }

    override fun withRawResponse(): ProductServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): ProductServiceAsync = ProductServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())

    override fun images(): ImageServiceAsync = images

    override fun shortLinks(): ShortLinkServiceAsync = shortLinks

    override fun create(params: ProductCreateParams, requestOptions: RequestOptions): CompletableFuture<Product> =
        // post /products
        withRawResponse().create(params, requestOptions).thenApply { it.parse() }

    override fun retrieve(params: ProductRetrieveParams, requestOptions: RequestOptions): CompletableFuture<Product> =
        // get /products/{id}
        withRawResponse().retrieve(params, requestOptions).thenApply { it.parse() }

    override fun update(params: ProductUpdateParams, requestOptions: RequestOptions): CompletableFuture<Void?> =
        // patch /products/{id}
        withRawResponse().update(params, requestOptions).thenAccept {}

    override fun list(params: ProductListParams, requestOptions: RequestOptions): CompletableFuture<ProductListPageAsync> =
        // get /products
        withRawResponse().list(params, requestOptions).thenApply { it.parse() }

    override fun archive(params: ProductArchiveParams, requestOptions: RequestOptions): CompletableFuture<Void?> =
        // delete /products/{id}
        withRawResponse().archive(params, requestOptions).thenAccept {}

    override fun unarchive(params: ProductUnarchiveParams, requestOptions: RequestOptions): CompletableFuture<Void?> =
        // post /products/{id}/unarchive
        withRawResponse().unarchive(params, requestOptions).thenAccept {}

    override fun updateFiles(params: ProductUpdateFilesParams, requestOptions: RequestOptions): CompletableFuture<ProductUpdateFilesResponse> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        private val images: ImageServiceAsync.WithRawResponse by lazy { ImageServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val shortLinks: ShortLinkServiceAsync.WithRawResponse by lazy { ShortLinkServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): ProductServiceAsync.WithRawResponse = ProductServiceAsyncImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())
        ...
        override fun create(params: ProductCreateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<Product>> {
        ...
        override fun retrieve(params: ProductRetrieveParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<Product>> {
        ...
        override fun update(params: ProductUpdateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("id", params.id().getOrNull())
          val request = HttpRequest.builder()
        ...
        override fun list(params: ProductListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<ProductListPageAsync>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
            .addPathSegments("products")
        ...
        override fun archive(params: ProductArchiveParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("id", params.id().getOrNull())
          val request = HttpRequest.builder()
        ...
        override fun unarchive(params: ProductUnarchiveParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("id", params.id().getOrNull())
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
        ...
        override fun updateFiles(params: ProductUpdateFilesParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<ProductUpdateFilesResponse>> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("id", params.id().getOrNull())
          val request = HttpRequest.builder()
