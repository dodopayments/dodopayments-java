...
interface ModerationService {
     ...
     */
    fun retrieveUsage(): ModerationRetrieveUsageResponse =
    ...
    fun retrieveUsage(
        params: ModerationRetrieveUsageParams = ModerationRetrieveUsageParams.none()
    ): ModerationRetrieveUsageResponse = retrieveUsage(params, RequestOptions.none())
     ...
     * (503).
     */
    fun screen(): ModerationScreenResponse = screen(ModerationScreenParams.none())
    ...
    fun screen(
        params: ModerationScreenParams = ModerationScreenParams.none()
    ): ModerationScreenResponse = screen(params, RequestOptions.none())
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun retrieveUsage(): HttpResponseFor<ModerationRetrieveUsageResponse> =
            retrieveUsage(ModerationRetrieveUsageParams.none())
         ...
         */
        @MustBeClosed
        fun screen(): HttpResponseFor<ModerationScreenResponse> =
        ...
        fun screen(
            params: ModerationScreenParams = ModerationScreenParams.none()
        ): HttpResponseFor<ModerationScreenResponse> = screen(params, RequestOptions.none())
