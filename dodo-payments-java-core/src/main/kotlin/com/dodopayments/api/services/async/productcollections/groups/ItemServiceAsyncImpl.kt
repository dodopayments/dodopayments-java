...
class ItemServiceAsyncImpl internal constructor(
    ...
    override fun create(params: ItemCreateParams, requestOptions: RequestOptions): CompletableFuture<List<ProductCollectionProduct>> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun create(params: ItemCreateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<List<ProductCollectionProduct>>> {
