...
class PaymentServiceImpl internal constructor(
    ...
    override fun create(params: PaymentCreateParams, requestOptions: RequestOptions): PaymentCreateResponse =
        // post /payments
    ...
    override fun retrieveLineItems(params: PaymentRetrieveLineItemsParams, requestOptions: RequestOptions): PaymentRetrieveLineItemsResponse =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        @Deprecated("deprecated")
        override fun create(params: PaymentCreateParams, requestOptions: RequestOptions): HttpResponseFor<PaymentCreateResponse> {
        ...
        override fun retrieve(params: PaymentRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<Payment> {
        ...
        override fun list(params: PaymentListParams, requestOptions: RequestOptions): HttpResponseFor<PaymentListPage> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
            .addPathSegments("payments")
        ...
        override fun retrieveLineItems(params: PaymentRetrieveLineItemsParams, requestOptions: RequestOptions): HttpResponseFor<PaymentRetrieveLineItemsResponse> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("paymentId", params.paymentId().getOrNull())
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
