...
interface UsageEventService {
     ...
     * ```
     */
    fun retrieve(eventId: String): Event =
        retrieve(
          eventId, UsageEventRetrieveParams.none()
        )

    /** @see retrieve */
    fun retrieve(eventId: String, params: UsageEventRetrieveParams = UsageEventRetrieveParams.none(), requestOptions: RequestOptions = RequestOptions.none()): Event =
        retrieve(
          params.toBuilder()
              .eventId(eventId)
    ...
    /** @see retrieve */
    fun retrieve(eventId: String, params: UsageEventRetrieveParams = UsageEventRetrieveParams.none()): Event =
        retrieve(
          eventId,
          params,
          RequestOptions.none(),
    ...
    /** @see retrieve */
    fun retrieve(params: UsageEventRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): Event

    /** @see retrieve */
    fun retrieve(params: UsageEventRetrieveParams): Event =
        retrieve(
    ...
    /** @see list */
    fun list(params: UsageEventListParams = UsageEventListParams.none(), requestOptions: RequestOptions = RequestOptions.none()): UsageEventListPage
    ...
    /** @see ingest */
    fun ingest(params: UsageEventIngestParams, requestOptions: RequestOptions = RequestOptions.none()): UsageEventIngestResponse
    ...
    interface WithRawResponse {
         ...
         * The original service is not modified.
         */
        fun withOptions(modifier: Consumer<ClientOptions.Builder>): UsageEventService.WithRawResponse

        /** Returns a raw HTTP response for `get /events/{event_id}`, but is otherwise the             same as [UsageEventService.retrieve]. */
        @MustBeClosed
        ...
        /** @see retrieve */
        @MustBeClosed
        fun retrieve(eventId: String, params: UsageEventRetrieveParams = UsageEventRetrieveParams.none(), requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<Event> =
            retrieve(
              params.toBuilder()
                  .eventId(eventId)
                  .build(), requestOptions
        ...
        /** @see retrieve */
        @MustBeClosed
        fun retrieve(eventId: String, params: UsageEventRetrieveParams = UsageEventRetrieveParams.none()): HttpResponseFor<Event> =
            retrieve(
              eventId,
              params,
              RequestOptions.none(),
        ...
        /** @see retrieve */
        @MustBeClosed
        fun retrieve(params: UsageEventRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<Event>
        ...
        /** Returns a raw HTTP response for `get /events`, but is otherwise the             same as [UsageEventService.list]. */
        @MustBeClosed
        fun list(): HttpResponseFor<UsageEventListPage> = list(UsageEventListParams.none())

        /** @see list */
        @MustBeClosed
        fun list(params: UsageEventListParams = UsageEventListParams.none(), requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<UsageEventListPage>

        /** @see list */
        @MustBeClosed
        fun list(params: UsageEventListParams = UsageEventListParams.none()): HttpResponseFor<UsageEventListPage> =
            list(
              params, RequestOptions.none()
            )
        ...
        /** Returns a raw HTTP response for `post /events/ingest`, but is otherwise the             same as [UsageEventService.ingest]. */
        @MustBeClosed
        ...
        /** @see ingest */
        @MustBeClosed
        fun ingest(params: UsageEventIngestParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<UsageEventIngestResponse>
    }
}
