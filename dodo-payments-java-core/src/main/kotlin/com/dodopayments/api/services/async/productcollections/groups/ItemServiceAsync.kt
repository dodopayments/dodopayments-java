...
interface ItemServiceAsync {
    ...
    ): CompletableFuture<List<ItemCreateResponse>> = create(groupId, params, RequestOptions.none())
    ...
    ): CompletableFuture<List<ItemCreateResponse>> =
        create(params.toBuilder().groupId(groupId).build(), requestOptions)

    /** @see create */
    fun create(params: ItemCreateParams): CompletableFuture<List<ItemCreateResponse>> =
    ...
    fun update(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<Void?> = update(params.toBuilder().itemId(itemId).build(), requestOptions)
    ...
    fun delete(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<Void?> = delete(params.toBuilder().itemId(itemId).build(), requestOptions)
    ...
    interface WithRawResponse {
        ...
        fun create(
            groupId: String,
            params: ItemCreateParams,
        ): CompletableFuture<HttpResponseFor<List<ItemCreateResponse>>> =
