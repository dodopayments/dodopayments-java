...
interface ProductCollectionServiceAsync {
    ...
    ): CompletableFuture<ProductCollectionCreateResponse> = create(params, RequestOptions.none())

    /** @see create */
    fun create(
        params: ProductCollectionCreateParams,
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<ProductCollectionCreateResponse>

    fun retrieve(id: String): CompletableFuture<ProductCollectionRetrieveResponse> =
    ...
    fun retrieve(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<ProductCollectionRetrieveResponse> =
    ...
    interface WithRawResponse {
        ...
        fun create(
            params: ProductCollectionCreateParams
        ): CompletableFuture<HttpResponseFor<ProductCollectionCreateResponse>> =
        ...
        fun retrieve(
            id: String
        ): CompletableFuture<HttpResponseFor<ProductCollectionRetrieveResponse>> =
            retrieve(id, ProductCollectionRetrieveParams.none())
