...
interface BlocklistService {
     ...
     */
    fun withOptions(modifier: Consumer<ClientOptions.Builder>): BlocklistService
    ...
    interface WithRawResponse {
         ...
         * The original service is not modified.
         */
        fun withOptions(modifier: Consumer<ClientOptions.Builder>): BlocklistService.WithRawResponse
