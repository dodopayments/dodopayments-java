...
internal class MeterCartResponseItemTest {
    ...
    @Test
    fun create() {
      val meterCartResponseItem = MeterCartResponseItem.builder()
    ...
    fun roundtrip() {
      ...
      val roundtrippedMeterCartResponseItem = jsonMapper.readValue(jsonMapper.writeValueAsString(meterCartResponseItem), jacksonTypeRef<MeterCartResponseItem>())
