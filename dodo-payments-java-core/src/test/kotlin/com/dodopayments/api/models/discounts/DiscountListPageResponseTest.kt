...
internal class DiscountListPageResponseTest {
    ...
    @Test
    fun create() {
      val discountListPageResponse = DiscountListPageResponse.builder()
          .addItem(Discount.builder()
              .amount(0)
      ...
      assertThat(discountListPageResponse.items()).containsExactly(Discount.builder()
          .amount(0)
          .businessId("business_id")
          .code("code")
          .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    ...
    fun roundtrip() {
      ...
      val roundtrippedDiscountListPageResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(discountListPageResponse), jacksonTypeRef<DiscountListPageResponse>())
