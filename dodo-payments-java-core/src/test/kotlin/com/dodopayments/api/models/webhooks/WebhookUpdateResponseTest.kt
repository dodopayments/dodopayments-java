...
internal class WebhookUpdateResponseTest {
    ...
    fun create() {
        ...
        assertThat(webhookUpdateResponse.disabled()).contains(true)
        assertThat(webhookUpdateResponse.filterTypes().getOrNull()).containsExactly("string")
        assertThat(webhookUpdateResponse.rateLimit()).contains(0)
    }
