...
internal class EntitlementGrantDeliveredWebhookEventTest {
    ...
    @Test
    fun create() {
      val entitlementGrantDeliveredWebhookEvent = EntitlementGrantDeliveredWebhookEvent.builder()
      ...
      assertThat(entitlementGrantDeliveredWebhookEvent.data()).isEqualTo(EntitlementGrant.builder()
          .id("id")
          .businessId("business_id")
          .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .customerId("customer_id")
          ...
          .subscriptionId("subscription_id")
          .build())
      assertThat(entitlementGrantDeliveredWebhookEvent.timestamp()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedEntitlementGrantDeliveredWebhookEvent = jsonMapper.readValue(jsonMapper.writeValueAsString(entitlementGrantDeliveredWebhookEvent), jacksonTypeRef<EntitlementGrantDeliveredWebhookEvent>())

      assertThat(roundtrippedEntitlementGrantDeliveredWebhookEvent).isEqualTo(entitlementGrantDeliveredWebhookEvent)
    }
}
