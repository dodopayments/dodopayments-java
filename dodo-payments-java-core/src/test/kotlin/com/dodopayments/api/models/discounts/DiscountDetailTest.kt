...
internal class DiscountDetailTest {
    ...
    @Test
    fun create() {
      val discountDetail = DiscountDetail.builder()
          .amount(0)
      ...
      assertThat(discountDetail.createdAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(discountDetail.discountId()).isEqualTo("discount_id")
      assertThat(discountDetail.metadata()).isEqualTo(DiscountDetail.Metadata.builder()
          .putAdditionalProperty("foo", JsonValue.from("string"))
          .build())
      ...
      assertThat(discountDetail.expiresAt()).contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    ...
    fun roundtrip() {
      ...
      val roundtrippedDiscountDetail = jsonMapper.readValue(jsonMapper.writeValueAsString(discountDetail), jacksonTypeRef<DiscountDetail>())
