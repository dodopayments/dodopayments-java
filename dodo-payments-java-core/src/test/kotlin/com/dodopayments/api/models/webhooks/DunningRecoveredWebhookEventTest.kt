...
internal class DunningRecoveredWebhookEventTest {
    ...
    @Test
    fun create() {
      val dunningRecoveredWebhookEvent = DunningRecoveredWebhookEvent.builder()
      ...
      assertThat(dunningRecoveredWebhookEvent.data()).isEqualTo(DunningRecoveredWebhookEvent.Data.builder()
          .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .customerId("customer_id")
          .status(DunningRecoveredWebhookEvent.Data.Status.RECOVERING)
          .subscriptionId("subscription_id")
          ...
          .paymentId("payment_id")
          .build())
      assertThat(dunningRecoveredWebhookEvent.timestamp()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedDunningRecoveredWebhookEvent = jsonMapper.readValue(jsonMapper.writeValueAsString(dunningRecoveredWebhookEvent), jacksonTypeRef<DunningRecoveredWebhookEvent>())
