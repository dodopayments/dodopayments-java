...
internal class SubscriptionListPageResponseTest {
    ...
    @Test
    fun create() {
      val subscriptionListPageResponse = SubscriptionListPageResponse.builder()
          .addItem(SubscriptionListResponse.builder()
      ...
      assertThat(subscriptionListPageResponse.items()).containsExactly(SubscriptionListResponse.builder()
          .billing(BillingAddress.builder()
              .country(CountryCode.AF)
              .city("city")
              .state("state")
    ...
    fun roundtrip() {
      ...
      val roundtrippedSubscriptionListPageResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(subscriptionListPageResponse), jacksonTypeRef<SubscriptionListPageResponse>())
