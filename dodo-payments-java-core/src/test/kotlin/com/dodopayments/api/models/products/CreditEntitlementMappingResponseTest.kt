...
internal class CreditEntitlementMappingResponseTest {
    ...
    @Test
    fun create() {
      val creditEntitlementMappingResponse = CreditEntitlementMappingResponse.builder()
      ...
      assertThat(creditEntitlementMappingResponse.id()).isEqualTo("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
      assertThat(creditEntitlementMappingResponse.creditEntitlementId()).isEqualTo("credit_entitlement_id")
      assertThat(creditEntitlementMappingResponse.creditEntitlementName()).isEqualTo("credit_entitlement_name")
      assertThat(creditEntitlementMappingResponse.creditEntitlementUnit()).isEqualTo("credit_entitlement_unit")
      assertThat(creditEntitlementMappingResponse.creditsAmount()).isEqualTo("credits_amount")
      assertThat(creditEntitlementMappingResponse.overageBehavior()).isEqualTo(CbbOverageBehavior.FORGIVE_AT_RESET)
      assertThat(creditEntitlementMappingResponse.overageEnabled()).isEqualTo(true)
      assertThat(creditEntitlementMappingResponse.prorationBehavior()).isEqualTo(CbbProrationBehavior.PRORATE)
      ...
      assertThat(creditEntitlementMappingResponse.rolloverTimeframeInterval()).contains(TimeInterval.DAY)
    ...
    fun roundtrip() {
      ...
      val roundtrippedCreditEntitlementMappingResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(creditEntitlementMappingResponse), jacksonTypeRef<CreditEntitlementMappingResponse>())

      assertThat(roundtrippedCreditEntitlementMappingResponse).isEqualTo(creditEntitlementMappingResponse)
    }
}
