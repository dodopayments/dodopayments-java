...
internal class LicenseActivateResponseTest {
    ...
    @Test
    fun create() {
      val licenseActivateResponse = LicenseActivateResponse.builder()
          .id("lki_123")
          ...
          .product(LicenseActivateResponse.Product.builder()
      ...
      assertThat(licenseActivateResponse.createdAt()).isEqualTo(OffsetDateTime.parse("2024-01-01T00:00:00Z"))
      assertThat(licenseActivateResponse.customer()).isEqualTo(CustomerLimitedDetails.builder()
          .customerId("customer_id")
          .email("email")
          .name("name")
          .metadata(CustomerLimitedDetails.Metadata.builder()
      ...
      assertThat(licenseActivateResponse.product()).isEqualTo(LicenseActivateResponse.Product.builder()
          .productId("product_id")
          .name("name")
          .build())
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedLicenseActivateResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(licenseActivateResponse), jacksonTypeRef<LicenseActivateResponse>())
