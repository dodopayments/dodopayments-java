...
internal class DisputeCancelledWebhookEventTest {
    ...
    @Test
    fun create() {
      val disputeCancelledWebhookEvent = DisputeCancelledWebhookEvent.builder()
      ...
      assertThat(disputeCancelledWebhookEvent.data()).isEqualTo(Dispute.builder()
          .amount("amount")
          .businessId("business_id")
          .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .currency("currency")
          ...
          .remarks("remarks")
          .build())
      assertThat(disputeCancelledWebhookEvent.timestamp()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedDisputeCancelledWebhookEvent = jsonMapper.readValue(jsonMapper.writeValueAsString(disputeCancelledWebhookEvent), jacksonTypeRef<DisputeCancelledWebhookEvent>())
