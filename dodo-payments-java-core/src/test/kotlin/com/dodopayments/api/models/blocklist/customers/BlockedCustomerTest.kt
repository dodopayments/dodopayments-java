...
internal class BlockedCustomerTest {
    ...
    fun create() {
        ...
        assertThat(blockedCustomer.blockedByEmail()).contains("blocked_by_email")
        assertThat(blockedCustomer.cancelledSubscriptionIds().getOrNull()).containsExactly("string")
        assertThat(blockedCustomer.notes().getOrNull())
            .containsExactly(
                BlockedCustomerNote.builder()
                    .id("id")
                    .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        ...
        assertThat(blockedCustomer.reason()).contains("reason")
        assertThat(blockedCustomer.remainingSubscriptionIds().getOrNull()).containsExactly("string")
        assertThat(blockedCustomer.subscriptionsSwept()).contains(true)
