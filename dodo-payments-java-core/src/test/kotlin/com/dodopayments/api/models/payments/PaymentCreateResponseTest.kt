...
internal class PaymentCreateResponseTest {
    ...
    @Test
    fun create() {
      val paymentCreateResponse = PaymentCreateResponse.builder()
          ...
          .customer(CustomerLimitedDetails.builder()
              ...
              .build())
          .metadata(PaymentCreateResponse.Metadata.builder()
              .putAdditionalProperty("foo", JsonValue.from("string"))
              .build())
      ...
      assertThat(paymentCreateResponse.customer()).isEqualTo(CustomerLimitedDetails.builder()
          .customerId("customer_id")
          .email("email")
          .name("name")
          .metadata(CustomerLimitedDetails.Metadata.builder()
          ...
          .phoneNumber("phone_number")
          .build())
      assertThat(paymentCreateResponse.metadata()).isEqualTo(PaymentCreateResponse.Metadata.builder()
          .putAdditionalProperty("foo", JsonValue.from("string"))
          .build())
      ...
      assertThat(paymentCreateResponse.expiresOn()).contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(paymentCreateResponse.paymentLink()).contains("payment_link")
      assertThat(paymentCreateResponse.productCart().getOrNull()).containsExactly(OneTimeProductCartItem.builder()
          .productId("product_id")
          .quantity(0)
          .amount(0)
          .build())
    ...
    fun roundtrip() {
      ...
      val roundtrippedPaymentCreateResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(paymentCreateResponse), jacksonTypeRef<PaymentCreateResponse>())
