...
internal class PaymentListPageResponseTest {
    ...
    @Test
    fun create() {
      val paymentListPageResponse = PaymentListPageResponse.builder()
          .addItem(PaymentListResponse.builder()
              .brandId("brand_id")
      ...
      assertThat(paymentListPageResponse.items()).containsExactly(PaymentListResponse.builder()
          .brandId("brand_id")
          .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .currency(Currency.AED)
          .customer(CustomerLimitedDetails.builder()
    ...
    fun roundtrip() {
      ...
      val roundtrippedPaymentListPageResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(paymentListPageResponse), jacksonTypeRef<PaymentListPageResponse>())
