...
internal class EntitlementTest {
    ...
    @Test
    fun create() {
      val entitlement = Entitlement.builder()
          .id("id")
      ...
      assertThat(entitlement.createdAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(entitlement.integrationConfig()).isEqualTo(IntegrationConfigResponse.ofGitHubConfig(IntegrationConfigResponse.GitHubConfig.builder()
          .permission(GitHubPermission.PULL)
          .targetId("target_id")
          .build()))
      ...
      assertThat(entitlement.metadata()).isEqualTo(Entitlement.Metadata.builder()
          .putAdditionalProperty("foo", JsonValue.from("string"))
          .build())
      assertThat(entitlement.name()).isEqualTo("name")
      assertThat(entitlement.updatedAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    ...
    fun roundtrip() {
      ...
      val roundtrippedEntitlement = jsonMapper.readValue(jsonMapper.writeValueAsString(entitlement), jacksonTypeRef<Entitlement>())
