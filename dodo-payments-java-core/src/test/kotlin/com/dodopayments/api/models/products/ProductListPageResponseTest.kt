...
internal class ProductListPageResponseTest {
    ...
    @Test
    fun create() {
      val productListPageResponse = ProductListPageResponse.builder()
          .addItem(ProductListResponse.builder()
      ...
      assertThat(productListPageResponse.items()).containsExactly(ProductListResponse.builder()
          .businessId("business_id")
          .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .addEntitlement(ProductEntitlementSummary.builder()
              .id("id")
    ...
    fun roundtrip() {
      ...
      val roundtrippedProductListPageResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(productListPageResponse), jacksonTypeRef<ProductListPageResponse>())
