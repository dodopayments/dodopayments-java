...
internal class SubscriptionChargeParamsTest {
    ...
    @Test
    fun pathParams() {
      val params = SubscriptionChargeParams.builder()
          .subscriptionId("subscription_id")
          .productPrice(0)
          .build()
    ...
    fun body() {
      ...
      assertThat(body.customerBalanceConfig()).contains(SubscriptionChargeParams.CustomerBalanceConfig.builder()
          .allowCustomerCreditsPurchase(true)
          .allowCustomerCreditsUsage(true)
          .build())
      assertThat(body.metadata()).contains(SubscriptionChargeParams.Metadata.builder()
          .putAdditionalProperty("foo", JsonValue.from("string"))
          .build())
