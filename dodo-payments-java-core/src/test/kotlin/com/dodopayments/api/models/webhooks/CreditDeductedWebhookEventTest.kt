...
internal class CreditDeductedWebhookEventTest {
    ...
    @Test
    fun create() {
      val creditDeductedWebhookEvent = CreditDeductedWebhookEvent.builder()
      ...
      assertThat(creditDeductedWebhookEvent.data()).isEqualTo(CreditLedgerEntry.builder()
          .id("id")
          .amount("amount")
          .balanceAfter("balance_after")
          .balanceBefore("balance_before")
          ...
          .referenceType("reference_type")
          .build())
      assertThat(creditDeductedWebhookEvent.timestamp()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedCreditDeductedWebhookEvent = jsonMapper.readValue(jsonMapper.writeValueAsString(creditDeductedWebhookEvent), jacksonTypeRef<CreditDeductedWebhookEvent>())
