...
internal class SubscriptionPlanChangedWebhookEventTest {
    ...
    @Test
    fun create() {
      val subscriptionPlanChangedWebhookEvent = SubscriptionPlanChangedWebhookEvent.builder()
      ...
      assertThat(subscriptionPlanChangedWebhookEvent.data()).isEqualTo(Subscription.builder()
          .addAddon(AddonCartResponseItem.builder()
              .addonId("addon_id")
              .quantity(0)
              .build())
          ...
          .taxId("tax_id")
          .build())
      assertThat(subscriptionPlanChangedWebhookEvent.timestamp()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedSubscriptionPlanChangedWebhookEvent = jsonMapper.readValue(jsonMapper.writeValueAsString(subscriptionPlanChangedWebhookEvent), jacksonTypeRef<SubscriptionPlanChangedWebhookEvent>())

      assertThat(roundtrippedSubscriptionPlanChangedWebhookEvent).isEqualTo(subscriptionPlanChangedWebhookEvent)
    }
}
