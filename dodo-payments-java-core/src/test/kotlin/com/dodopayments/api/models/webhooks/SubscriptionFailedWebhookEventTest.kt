...
internal class SubscriptionFailedWebhookEventTest {
    ...
    @Test
    fun create() {
      val subscriptionFailedWebhookEvent = SubscriptionFailedWebhookEvent.builder()
      ...
      assertThat(subscriptionFailedWebhookEvent.data()).isEqualTo(Subscription.builder()
          .addAddon(AddonCartResponseItem.builder()
              .addonId("addon_id")
              .quantity(0)
              .build())
          ...
          .taxId("tax_id")
          .build())
      assertThat(subscriptionFailedWebhookEvent.timestamp()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedSubscriptionFailedWebhookEvent = jsonMapper.readValue(jsonMapper.writeValueAsString(subscriptionFailedWebhookEvent), jacksonTypeRef<SubscriptionFailedWebhookEvent>())

      assertThat(roundtrippedSubscriptionFailedWebhookEvent).isEqualTo(subscriptionFailedWebhookEvent)
    }
}
