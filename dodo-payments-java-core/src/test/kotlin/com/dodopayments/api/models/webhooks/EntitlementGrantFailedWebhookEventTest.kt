...
internal class EntitlementGrantFailedWebhookEventTest {
    ...
    @Test
    fun create() {
      val entitlementGrantFailedWebhookEvent = EntitlementGrantFailedWebhookEvent.builder()
      ...
      assertThat(entitlementGrantFailedWebhookEvent.data()).isEqualTo(EntitlementGrant.builder()
          .id("id")
          .businessId("business_id")
          .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .customerId("customer_id")
          ...
          .subscriptionId("subscription_id")
          .build())
      assertThat(entitlementGrantFailedWebhookEvent.timestamp()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedEntitlementGrantFailedWebhookEvent = jsonMapper.readValue(jsonMapper.writeValueAsString(entitlementGrantFailedWebhookEvent), jacksonTypeRef<EntitlementGrantFailedWebhookEvent>())

      assertThat(roundtrippedEntitlementGrantFailedWebhookEvent).isEqualTo(entitlementGrantFailedWebhookEvent)
    }
}
