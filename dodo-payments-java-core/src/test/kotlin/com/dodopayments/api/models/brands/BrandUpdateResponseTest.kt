...
internal class BrandUpdateResponseTest {
    ...
    fun create() {
        ...
        assertThat(brandUpdateResponse.description()).contains("description")
        assertThat(brandUpdateResponse.image()).contains("image")
        assertThat(brandUpdateResponse.name()).contains("name")
        assertThat(brandUpdateResponse.reasonForHold()).contains("reason_for_hold")
        assertThat(brandUpdateResponse.supportEmail()).contains("support_email")
        assertThat(brandUpdateResponse.url()).contains("url")
    }
