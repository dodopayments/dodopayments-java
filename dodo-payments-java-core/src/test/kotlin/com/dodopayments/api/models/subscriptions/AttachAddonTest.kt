...
internal class AttachAddonTest {
    ...
    @Test
    fun create() {
      val attachAddon = AttachAddon.builder()
          .addonId("addon_id")
          .quantity(0)
          .build()
    ...
    fun roundtrip() {
      ...
      val roundtrippedAttachAddon = jsonMapper.readValue(jsonMapper.writeValueAsString(attachAddon), jacksonTypeRef<AttachAddon>())
