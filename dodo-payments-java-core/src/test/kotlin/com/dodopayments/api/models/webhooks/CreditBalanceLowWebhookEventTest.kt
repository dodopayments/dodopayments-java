...
internal class CreditBalanceLowWebhookEventTest {
    ...
    @Test
    fun create() {
      val creditBalanceLowWebhookEvent = CreditBalanceLowWebhookEvent.builder()
      ...
      assertThat(creditBalanceLowWebhookEvent.data()).isEqualTo(CreditBalanceLowWebhookEvent.Data.builder()
          .availableBalance("available_balance")
          .creditEntitlementId("credit_entitlement_id")
          .creditEntitlementName("credit_entitlement_name")
          .customerId("customer_id")
          ...
          .thresholdPercent(0)
          .build())
      assertThat(creditBalanceLowWebhookEvent.timestamp()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedCreditBalanceLowWebhookEvent = jsonMapper.readValue(jsonMapper.writeValueAsString(creditBalanceLowWebhookEvent), jacksonTypeRef<CreditBalanceLowWebhookEvent>())
