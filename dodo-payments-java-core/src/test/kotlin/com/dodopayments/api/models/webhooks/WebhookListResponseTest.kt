...
internal class WebhookListResponseTest {
    ...
    fun create() {
        ...
        assertThat(webhookListResponse.disabled()).contains(true)
        assertThat(webhookListResponse.filterTypes().getOrNull()).containsExactly("string")
        assertThat(webhookListResponse.rateLimit()).contains(0)
    }
