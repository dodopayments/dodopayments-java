...
internal class CreditRolledOverWebhookEventTest {
    ...
    @Test
    fun create() {
      val creditRolledOverWebhookEvent = CreditRolledOverWebhookEvent.builder()
      ...
      assertThat(creditRolledOverWebhookEvent.data()).isEqualTo(CreditLedgerEntry.builder()
          .id("id")
          .amount("amount")
          .balanceAfter("balance_after")
          .balanceBefore("balance_before")
          ...
          .referenceType("reference_type")
          .build())
      assertThat(creditRolledOverWebhookEvent.timestamp()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedCreditRolledOverWebhookEvent = jsonMapper.readValue(jsonMapper.writeValueAsString(creditRolledOverWebhookEvent), jacksonTypeRef<CreditRolledOverWebhookEvent>())
