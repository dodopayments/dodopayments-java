...
internal class UnwrapWebhookEventTest {
    ...
    fun ofAbandonedCheckoutDetected() {
      ...
      val unwrapWebhookEvent = UnwrapWebhookEvent.ofAbandonedCheckoutDetected(abandonedCheckoutDetected)

      assertThat(unwrapWebhookEvent.abandonedCheckoutDetected()).contains(abandonedCheckoutDetected)
    ...
    fun ofAbandonedCheckoutDetectedRoundtrip() {
      ...
      val unwrapWebhookEvent = UnwrapWebhookEvent.ofAbandonedCheckoutDetected(AbandonedCheckoutDetectedWebhookEvent.builder()
          .businessId("business_id")
          .data(AbandonedCheckoutDetectedWebhookEvent.Data.builder()
              .abandonedAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
              .abandonmentReason(AbandonedCheckoutDetectedWebhookEvent.Data.AbandonmentReason.PAYMENT_FAILED)
    ...
    fun ofAbandonedCheckoutRecovered() {
      ...
      val unwrapWebhookEvent = UnwrapWebhookEvent.ofAbandonedCheckoutRecovered(abandonedCheckoutRecovered)

      assertThat(unwrapWebhookEvent.abandonedCheckoutDetected()).isEmpty
      assertThat(unwrapWebhookEvent.abandonedCheckoutRecovered()).contains(abandonedCheckoutRecovered)
      assertThat(unwrapWebhookEvent.creditAdded()).isEmpty
      assertThat(unwrapWebhookEvent.creditBalanceLow()).isEmpty
      assertThat(unwrapWebhookEvent.creditDeducted()).isEmpty
      assertThat(unwrapWebhookEvent.creditExpired()).isEmpty
    ...
    fun ofAbandonedCheckoutRecoveredRoundtrip() {
      val jsonMapper = jsonMapper()
      val unwrapWebhookEvent = UnwrapWebhookEvent.ofAbandonedCheckoutRecovered(AbandonedCheckoutRecoveredWebhookEvent.builder()
          .businessId("business_id")
          .data(AbandonedCheckoutRecoveredWebhookEvent.Data.builder()
              .abandonedAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
              .abandonmentReason(AbandonedCheckoutRecoveredWebhookEvent.Data.AbandonmentReason.PAYMENT_FAILED)
    ...
    fun ofCreditAddedRoundtrip() {
      val jsonMapper = jsonMapper()
      val unwrapWebhookEvent = UnwrapWebhookEvent.ofCreditAdded(CreditAddedWebhookEvent.builder()
          .businessId("business_id")
          .data(CreditLedgerEntry.builder()
              .id("id")
              .amount("amount")
    ...
    fun ofCreditBalanceLowRoundtrip() {
      val jsonMapper = jsonMapper()
      val unwrapWebhookEvent = UnwrapWebhookEvent.ofCreditBalanceLow(CreditBalanceLowWebhookEvent.builder()
          .businessId("business_id")
          .data(CreditBalanceLowWebhookEvent.Data.builder()
              .availableBalance("available_balance")
              .creditEntitlementId("credit_entitlement_id")
    ...
    fun ofCreditDeductedRoundtrip() {
      val jsonMapper = jsonMapper()
      val unwrapWebhookEvent = UnwrapWebhookEvent.ofCreditDeducted(CreditDeductedWebhookEvent.builder()
          .businessId("business_id")
          .data(CreditLedgerEntry.builder()
              .id("id")
              .amount("amount")
    ...
    fun ofCreditExpiredRoundtrip() {
      val jsonMapper = jsonMapper()
      val unwrapWebhookEvent = UnwrapWebhookEvent.ofCreditExpired(CreditExpiredWebhookEvent.builder()
          .businessId("business_id")
          .data(CreditLedgerEntry.builder()
              .id("id")
              .amount("amount")
    ...
    fun ofCreditManualAdjustmentRoundtrip() {
      val jsonMapper = jsonMapper()
      val unwrapWebhookEvent = UnwrapWebhookEvent.ofCreditManualAdjustment(CreditManualAdjustmentWebhookEvent.builder()
          .businessId("business_id")
          .data(CreditLedgerEntry.builder()
              .id("id")
              .amount("amount")
    ...
    fun ofCreditOverageChargedRoundtrip() {
      val jsonMapper = jsonMapper()
      val unwrapWebhookEvent = UnwrapWebhookEvent.ofCreditOverageCharged(CreditOverageChargedWebhookEvent.builder()
          .businessId("business_id")
          .data(CreditLedgerEntry.builder()
              .id("id")
              .amount("amount")
    ...
    fun ofCreditOverageResetRoundtrip() {
      val jsonMapper = jsonMapper()
      val unwrapWebhookEvent = UnwrapWebhookEvent.ofCreditOverageReset(CreditOverageResetWebhookEvent.builder()
          .businessId("business_id")
          .data(CreditLedgerEntry.builder()
              .id("id")
              .amount("amount")
    ...
    fun ofCreditRolledOverRoundtrip() {
      val jsonMapper = jsonMapper()
      val unwrapWebhookEvent = UnwrapWebhookEvent.ofCreditRolledOver(CreditRolledOverWebhookEvent.builder()
          .businessId("business_id")
          .data(CreditLedgerEntry.builder()
              .id("id")
              .amount("amount")
    ...
    fun ofCreditRolloverForfeited() {
      ...
      val unwrapWebhookEvent = UnwrapWebhookEvent.ofCreditRolloverForfeited(creditRolloverForfeited)
    ...
    fun ofCreditRolloverForfeitedRoundtrip() {
      val jsonMapper = jsonMapper()
      val unwrapWebhookEvent = UnwrapWebhookEvent.ofCreditRolloverForfeited(CreditRolloverForfeitedWebhookEvent.builder()
          .businessId("business_id")
          .data(CreditLedgerEntry.builder()
              .id("id")
              .amount("amount")
    ...
    fun ofDisputeAcceptedRoundtrip() {
      val jsonMapper = jsonMapper()
      val unwrapWebhookEvent = UnwrapWebhookEvent.ofDisputeAccepted(DisputeAcceptedWebhookEvent.builder()
          .businessId("business_id")
          .data(Dispute.builder()
              .amount("amount")
              .businessId("business_id")
    ...
    fun ofDisputeCancelledRoundtrip() {
      val jsonMapper = jsonMapper()
      val unwrapWebhookEvent = UnwrapWebhookEvent.ofDisputeCancelled(DisputeCancelledWebhookEvent.builder()
          .businessId("business_id")
          .data(Dispute.builder()
              .amount("amount")
              .businessId("business_id")
    ...
    fun ofDisputeChallengedRoundtrip() {
      val jsonMapper = jsonMapper()
      val unwrapWebhookEvent = UnwrapWebhookEvent.ofDisputeChallenged(DisputeChallengedWebhookEvent.builder()
          .businessId("business_id")
          .data(Dispute.builder()
              .amount("amount")
              .businessId("business_id")
    ...
    fun ofDisputeExpiredRoundtrip() {
      val jsonMapper = jsonMapper()
      val unwrapWebhookEvent = UnwrapWebhookEvent.ofDisputeExpired(DisputeExpiredWebhookEvent.builder()
          .businessId("business_id")
          .data(Dispute.builder()
              .amount("amount")
              .businessId("business_id")
    ...
    fun ofDisputeLostRoundtrip() {
      val jsonMapper = jsonMapper()
      val unwrapWebhookEvent = UnwrapWebhookEvent.ofDisputeLost(DisputeLostWebhookEvent.builder()
          .businessId("business_id")
          .data(Dispute.builder()
              .amount("amount")
              .businessId("business_id")
    ...
    fun ofDisputeOpenedRoundtrip() {
      val jsonMapper = jsonMapper()
      val unwrapWebhookEvent = UnwrapWebhookEvent.ofDisputeOpened(DisputeOpenedWebhookEvent.builder()
          .businessId("business_id")
          .data(Dispute.builder()
              .amount("amount")
              .businessId("business_id")
    ...
    fun ofDisputeWonRoundtrip() {
      val jsonMapper = jsonMapper()
      val unwrapWebhookEvent = UnwrapWebhookEvent.ofDisputeWon(DisputeWonWebhookEvent.builder()
          .businessId("business_id")
          .data(Dispute.builder()
              .amount("amount")
              .businessId("business_id")
    ...
    fun ofDunningRecoveredRoundtrip() {
      val jsonMapper = jsonMapper()
      val unwrapWebhookEvent = UnwrapWebhookEvent.ofDunningRecovered(DunningRecoveredWebhookEvent.builder()
          .businessId("business_id")
          .data(DunningRecoveredWebhookEvent.Data.builder()
              .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
              .customerId("customer_id")
    ...
    fun ofDunningStartedRoundtrip() {
      val jsonMapper = jsonMapper()
      val unwrapWebhookEvent = UnwrapWebhookEvent.ofDunningStarted(DunningStartedWebhookEvent.builder()
          .businessId("business_id")
          .data(DunningStartedWebhookEvent.Data.builder()
              .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
              .customerId("customer_id")
    ...
    fun ofEntitlementGrantCreated() {
      ...
      val unwrapWebhookEvent = UnwrapWebhookEvent.ofEntitlementGrantCreated(entitlementGrantCreated)
    ...
    fun ofEntitlementGrantCreatedRoundtrip() {
      val jsonMapper = jsonMapper()
      val unwrapWebhookEvent = UnwrapWebhookEvent.ofEntitlementGrantCreated(EntitlementGrantCreatedWebhookEvent.builder()
          .businessId("business_id")
          .data(EntitlementGrant.builder()
              .id("id")
              .businessId("business_id")
    ...
    fun ofEntitlementGrantDelivered() {
      ...
      val unwrapWebhookEvent = UnwrapWebhookEvent.ofEntitlementGrantDelivered(entitlementGrantDelivered)
      ...
      assertThat(unwrapWebhookEvent.dunningStarted()).isEmpty
      assertThat(unwrapWebhookEvent.entitlementGrantCreated()).isEmpty
      assertThat(unwrapWebhookEvent.entitlementGrantDelivered()).contains(entitlementGrantDelivered)
      assertThat(unwrapWebhookEvent.entitlementGrantFailed()).isEmpty
      assertThat(unwrapWebhookEvent.entitlementGrantRevoked()).isEmpty
      assertThat(unwrapWebhookEvent.licenseKeyCreated()).isEmpty
      assertThat(unwrapWebhookEvent.paymentCancelled()).isEmpty
    ...
    fun ofEntitlementGrantDeliveredRoundtrip() {
      val jsonMapper = jsonMapper()
      val unwrapWebhookEvent = UnwrapWebhookEvent.ofEntitlementGrantDelivered(EntitlementGrantDeliveredWebhookEvent.builder()
          .businessId("business_id")
          .data(EntitlementGrant.builder()
              .id("id")
              .businessId("business_id")
    ...
    fun ofEntitlementGrantFailedRoundtrip() {
      val jsonMapper = jsonMapper()
      val unwrapWebhookEvent = UnwrapWebhookEvent.ofEntitlementGrantFailed(EntitlementGrantFailedWebhookEvent.builder()
          .businessId("business_id")
          .data(EntitlementGrant.builder()
              .id("id")
              .businessId("business_id")
    ...
    fun ofEntitlementGrantRevoked() {
      ...
      val unwrapWebhookEvent = UnwrapWebhookEvent.ofEntitlementGrantRevoked(entitlementGrantRevoked)
    ...
    fun ofEntitlementGrantRevokedRoundtrip() {
      val jsonMapper = jsonMapper()
      val unwrapWebhookEvent = UnwrapWebhookEvent.ofEntitlementGrantRevoked(EntitlementGrantRevokedWebhookEvent.builder()
          .businessId("business_id")
          .data(EntitlementGrant.builder()
              .id("id")
              .businessId("business_id")
    ...
    fun ofLicenseKeyCreatedRoundtrip() {
      val jsonMapper = jsonMapper()
      val unwrapWebhookEvent = UnwrapWebhookEvent.ofLicenseKeyCreated(LicenseKeyCreatedWebhookEvent.builder()
          .businessId("business_id")
          .data(LicenseKey.builder()
              .id("lic_123")
              .businessId("business_id")
    ...
    fun ofPaymentCancelledRoundtrip() {
      val jsonMapper = jsonMapper()
      val unwrapWebhookEvent = UnwrapWebhookEvent.ofPaymentCancelled(PaymentCancelledWebhookEvent.builder()
          .businessId("business_id")
          .data(Payment.builder()
              .billing(BillingAddress.builder()
                  .country(CountryCode.AF)
    ...
    fun ofPaymentFailedRoundtrip() {
      val jsonMapper = jsonMapper()
      val unwrapWebhookEvent = UnwrapWebhookEvent.ofPaymentFailed(PaymentFailedWebhookEvent.builder()
          .businessId("business_id")
          .data(Payment.builder()
              .billing(BillingAddress.builder()
                  .country(CountryCode.AF)
    ...
    fun ofPaymentProcessingRoundtrip() {
      val jsonMapper = jsonMapper()
      val unwrapWebhookEvent = UnwrapWebhookEvent.ofPaymentProcessing(PaymentProcessingWebhookEvent.builder()
          .businessId("business_id")
          .data(Payment.builder()
              .billing(BillingAddress.builder()
                  .country(CountryCode.AF)
    ...
    fun ofPaymentSucceededRoundtrip() {
      val jsonMapper = jsonMapper()
      val unwrapWebhookEvent = UnwrapWebhookEvent.ofPaymentSucceeded(PaymentSucceededWebhookEvent.builder()
          .businessId("business_id")
          .data(Payment.builder()
              .billing(BillingAddress.builder()
                  .country(CountryCode.AF)
    ...
    fun ofRefundFailedRoundtrip() {
      val jsonMapper = jsonMapper()
      val unwrapWebhookEvent = UnwrapWebhookEvent.ofRefundFailed(RefundFailedWebhookEvent.builder()
          .businessId("business_id")
          .data(Refund.builder()
              .businessId("business_id")
              .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    ...
    fun ofRefundSucceededRoundtrip() {
      val jsonMapper = jsonMapper()
      val unwrapWebhookEvent = UnwrapWebhookEvent.ofRefundSucceeded(RefundSucceededWebhookEvent.builder()
          .businessId("business_id")
          .data(Refund.builder()
              .businessId("business_id")
              .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    ...
    fun ofSubscriptionActiveRoundtrip() {
      val jsonMapper = jsonMapper()
      val unwrapWebhookEvent = UnwrapWebhookEvent.ofSubscriptionActive(SubscriptionActiveWebhookEvent.builder()
          .businessId("business_id")
          .data(Subscription.builder()
              .addAddon(AddonCartResponseItem.builder()
                  .addonId("addon_id")
    ...
    fun ofSubscriptionCancelledRoundtrip() {
      val jsonMapper = jsonMapper()
      val unwrapWebhookEvent = UnwrapWebhookEvent.ofSubscriptionCancelled(SubscriptionCancelledWebhookEvent.builder()
          .businessId("business_id")
          .data(Subscription.builder()
              .addAddon(AddonCartResponseItem.builder()
                  .addonId("addon_id")
    ...
    fun ofSubscriptionExpiredRoundtrip() {
      val jsonMapper = jsonMapper()
      val unwrapWebhookEvent = UnwrapWebhookEvent.ofSubscriptionExpired(SubscriptionExpiredWebhookEvent.builder()
          .businessId("business_id")
          .data(Subscription.builder()
              .addAddon(AddonCartResponseItem.builder()
                  .addonId("addon_id")
    ...
    fun ofSubscriptionFailedRoundtrip() {
      val jsonMapper = jsonMapper()
      val unwrapWebhookEvent = UnwrapWebhookEvent.ofSubscriptionFailed(SubscriptionFailedWebhookEvent.builder()
          .businessId("business_id")
          .data(Subscription.builder()
              .addAddon(AddonCartResponseItem.builder()
                  .addonId("addon_id")
    ...
    fun ofSubscriptionOnHoldRoundtrip() {
      val jsonMapper = jsonMapper()
      val unwrapWebhookEvent = UnwrapWebhookEvent.ofSubscriptionOnHold(SubscriptionOnHoldWebhookEvent.builder()
          .businessId("business_id")
          .data(Subscription.builder()
              .addAddon(AddonCartResponseItem.builder()
                  .addonId("addon_id")
    ...
    fun ofSubscriptionPlanChanged() {
      ...
      val unwrapWebhookEvent = UnwrapWebhookEvent.ofSubscriptionPlanChanged(subscriptionPlanChanged)
    ...
    fun ofSubscriptionPlanChangedRoundtrip() {
      val jsonMapper = jsonMapper()
      val unwrapWebhookEvent = UnwrapWebhookEvent.ofSubscriptionPlanChanged(SubscriptionPlanChangedWebhookEvent.builder()
          .businessId("business_id")
          .data(Subscription.builder()
              .addAddon(AddonCartResponseItem.builder()
                  .addonId("addon_id")
    ...
    fun ofSubscriptionRenewedRoundtrip() {
      val jsonMapper = jsonMapper()
      val unwrapWebhookEvent = UnwrapWebhookEvent.ofSubscriptionRenewed(SubscriptionRenewedWebhookEvent.builder()
          .businessId("business_id")
          .data(Subscription.builder()
              .addAddon(AddonCartResponseItem.builder()
                  .addonId("addon_id")
    ...
    fun ofSubscriptionUpdatedRoundtrip() {
      val jsonMapper = jsonMapper()
      val unwrapWebhookEvent = UnwrapWebhookEvent.ofSubscriptionUpdated(SubscriptionUpdatedWebhookEvent.builder()
          .businessId("business_id")
          .data(Subscription.builder()
              .addAddon(AddonCartResponseItem.builder()
                  .addonId("addon_id")
