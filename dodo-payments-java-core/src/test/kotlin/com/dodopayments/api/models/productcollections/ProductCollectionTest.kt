...
internal class ProductCollectionTest {
    ...
    @Test
    fun create() {
      val productCollection = ProductCollection.builder()
          .id("id")
          .brandId("brand_id")
          .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .addGroup(ProductCollectionGroupResponse.builder()
              .groupId("group_id")
      ...
      assertThat(productCollection.createdAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(productCollection.groups()).containsExactly(ProductCollectionGroupResponse.builder()
          .groupId("group_id")
          .addProduct(ProductCollectionProduct.builder()
              .id("id")
              .addonsCount(0L)
      ...
      assertThat(productCollection.updatedAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    ...
    fun roundtrip() {
      ...
      val roundtrippedProductCollection = jsonMapper.readValue(jsonMapper.writeValueAsString(productCollection), jacksonTypeRef<ProductCollection>())
