...
internal class CreditExpiredWebhookEventTest {
    ...
    @Test
    fun create() {
      val creditExpiredWebhookEvent = CreditExpiredWebhookEvent.builder()
      ...
      assertThat(creditExpiredWebhookEvent.data()).isEqualTo(CreditLedgerEntry.builder()
          .id("id")
          .amount("amount")
          .balanceAfter("balance_after")
          .balanceBefore("balance_before")
          ...
          .referenceType("reference_type")
          .build())
      assertThat(creditExpiredWebhookEvent.timestamp()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedCreditExpiredWebhookEvent = jsonMapper.readValue(jsonMapper.writeValueAsString(creditExpiredWebhookEvent), jacksonTypeRef<CreditExpiredWebhookEvent>())
