...
internal class WebhookCreateResponseTest {
    ...
    fun create() {
        ...
        assertThat(webhookCreateResponse.disabled()).contains(true)
        assertThat(webhookCreateResponse.filterTypes().getOrNull()).containsExactly("string")
        assertThat(webhookCreateResponse.rateLimit()).contains(0)
    }
