...
internal class AddonCartResponseItemTest {
    ...
    @Test
    fun create() {
      val addonCartResponseItem = AddonCartResponseItem.builder()
          .addonId("addon_id")
          .quantity(0)
          .build()
    ...
    fun roundtrip() {
      ...
      val roundtrippedAddonCartResponseItem = jsonMapper.readValue(jsonMapper.writeValueAsString(addonCartResponseItem), jacksonTypeRef<AddonCartResponseItem>())
