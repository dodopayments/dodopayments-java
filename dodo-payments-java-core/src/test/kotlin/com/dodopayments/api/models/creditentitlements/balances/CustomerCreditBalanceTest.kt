...
internal class CustomerCreditBalanceTest {
    ...
    @Test
    fun create() {
      val customerCreditBalance = CustomerCreditBalance.builder()
          .id("id")
          .balance("balance")
      ...
      assertThat(customerCreditBalance.createdAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      assertThat(customerCreditBalance.updatedAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(customerCreditBalance.lastTransactionAt()).contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedCustomerCreditBalance = jsonMapper.readValue(jsonMapper.writeValueAsString(customerCreditBalance), jacksonTypeRef<CustomerCreditBalance>())
