...
internal class SubscriptionExpiredWebhookEventTest {
    ...
    @Test
    fun create() {
      val subscriptionExpiredWebhookEvent = SubscriptionExpiredWebhookEvent.builder()
      ...
      assertThat(subscriptionExpiredWebhookEvent.data()).isEqualTo(Subscription.builder()
          .addAddon(AddonCartResponseItem.builder()
              .addonId("addon_id")
              .quantity(0)
              .build())
          ...
          .taxId("tax_id")
          .build())
      assertThat(subscriptionExpiredWebhookEvent.timestamp()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedSubscriptionExpiredWebhookEvent = jsonMapper.readValue(jsonMapper.writeValueAsString(subscriptionExpiredWebhookEvent), jacksonTypeRef<SubscriptionExpiredWebhookEvent>())

      assertThat(roundtrippedSubscriptionExpiredWebhookEvent).isEqualTo(subscriptionExpiredWebhookEvent)
    }
}
