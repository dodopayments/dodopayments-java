...
internal class SubscriptionActiveWebhookEventTest {
    ...
    @Test
    fun create() {
      val subscriptionActiveWebhookEvent = SubscriptionActiveWebhookEvent.builder()
      ...
      assertThat(subscriptionActiveWebhookEvent.data()).isEqualTo(Subscription.builder()
          .addAddon(AddonCartResponseItem.builder()
              .addonId("addon_id")
              .quantity(0)
              .build())
          ...
          .taxId("tax_id")
          .build())
      assertThat(subscriptionActiveWebhookEvent.timestamp()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedSubscriptionActiveWebhookEvent = jsonMapper.readValue(jsonMapper.writeValueAsString(subscriptionActiveWebhookEvent), jacksonTypeRef<SubscriptionActiveWebhookEvent>())

      assertThat(roundtrippedSubscriptionActiveWebhookEvent).isEqualTo(subscriptionActiveWebhookEvent)
    }
}
