...
internal class BalanceCreateLedgerEntryResponseTest {
    ...
    @Test
    fun create() {
      val balanceCreateLedgerEntryResponse = BalanceCreateLedgerEntryResponse.builder()
          .id("id")
          .amount("amount")
      ...
      assertThat(balanceCreateLedgerEntryResponse.createdAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(balanceCreateLedgerEntryResponse.creditEntitlementId()).isEqualTo("credit_entitlement_id")
    ...
    fun roundtrip() {
      ...
      val roundtrippedBalanceCreateLedgerEntryResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(balanceCreateLedgerEntryResponse), jacksonTypeRef<BalanceCreateLedgerEntryResponse>())

      assertThat(roundtrippedBalanceCreateLedgerEntryResponse).isEqualTo(balanceCreateLedgerEntryResponse)
    }
}
