...
internal class DisputeExpiredWebhookEventTest {
    ...
    @Test
    fun create() {
      val disputeExpiredWebhookEvent = DisputeExpiredWebhookEvent.builder()
      ...
      assertThat(disputeExpiredWebhookEvent.data()).isEqualTo(Dispute.builder()
          .amount("amount")
          .businessId("business_id")
          .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .currency("currency")
          ...
          .remarks("remarks")
          .build())
      assertThat(disputeExpiredWebhookEvent.timestamp()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedDisputeExpiredWebhookEvent = jsonMapper.readValue(jsonMapper.writeValueAsString(disputeExpiredWebhookEvent), jacksonTypeRef<DisputeExpiredWebhookEvent>())
