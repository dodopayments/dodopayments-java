...
internal class ProductListResponseTest {
    ...
    fun create() {
      val productListResponse = ProductListResponse.builder()
          ...
          .addEntitlement(ProductEntitlementSummary.builder()
              .id("id")
              ...
              .build())
          .isRecurring(true)
          .metadata(ProductListResponse.Metadata.builder()
      ...
      assertThat(productListResponse.createdAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(productListResponse.entitlements()).containsExactly(ProductEntitlementSummary.builder()
          .id("id")
          .integrationConfig(IntegrationConfigResponse.GitHubConfig.builder()
              .permission(GitHubPermission.PULL)
              .targetId("target_id")
      ...
      assertThat(productListResponse.metadata()).isEqualTo(ProductListResponse.Metadata.builder()
          .putAdditionalProperty("foo", JsonValue.from("string"))
          .build())
      ...
      assertThat(productListResponse.updatedAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      assertThat(productListResponse.priceDetail()).contains(Price.ofOneTime(Price.OneTimePrice.builder()
          .currency(Currency.AED)
          .discount(0L)
          .price(0)
          .purchasingPowerParity(true)
    ...
    fun roundtrip() {
      ...
      val roundtrippedProductListResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(productListResponse), jacksonTypeRef<ProductListResponse>())
