...
internal class FileUploadResponseTest {
    ...
    @Test
    fun create() {
      val fileUploadResponse = FileUploadResponse.builder()
          .fileId("file_id")
          .build()
    ...
    fun roundtrip() {
      ...
      val roundtrippedFileUploadResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(fileUploadResponse), jacksonTypeRef<FileUploadResponse>())
