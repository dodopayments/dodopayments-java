...
internal class EmailLogItemTest {
    ...
    fun create() {
        ...
        assertThat(emailLogItem.failureCode()).contains(EmailFailureCode.MAILBOX_NOT_FOUND)
        assertThat(emailLogItem.failureReason()).contains("failure_reason")
        assertThat(emailLogItem.from()).contains("from")
        assertThat(emailLogItem.intendedRecipient()).contains("intended_recipient")
        assertThat(emailLogItem.recipient()).contains("recipient")
        assertThat(emailLogItem.subject()).contains("subject")
    }
