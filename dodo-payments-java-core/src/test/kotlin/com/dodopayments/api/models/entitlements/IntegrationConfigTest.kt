...
internal class IntegrationConfigTest {
    ...
    @Test
    fun ofGitHub() {
      val github = IntegrationConfig.GitHubConfig.builder()
    ...
    fun ofGitHubRoundtrip() {
      ...
      val integrationConfig = IntegrationConfig.ofGitHub(IntegrationConfig.GitHubConfig.builder()
          .permission(GitHubPermission.PULL)
          .targetId("target_id")
          .build())

      val roundtrippedIntegrationConfig = jsonMapper.readValue(jsonMapper.writeValueAsString(integrationConfig), jacksonTypeRef<IntegrationConfig>())
    ...
    @Test
    fun ofDiscord() {
      val discord = IntegrationConfig.DiscordConfig.builder()
          .guildId("guild_id")
          .roleId("role_id")
          .build()
    ...
    fun ofDiscordRoundtrip() {
      val jsonMapper = jsonMapper()
      val integrationConfig = IntegrationConfig.ofDiscord(IntegrationConfig.DiscordConfig.builder()
          .guildId("guild_id")
          .roleId("role_id")
          .build())
    ...
    @Test
    fun ofTelegram() {
      val telegram = IntegrationConfig.TelegramConfig.builder()
          .chatId("chat_id")
          .build()
    ...
    fun ofTelegramRoundtrip() {
      val jsonMapper = jsonMapper()
      val integrationConfig = IntegrationConfig.ofTelegram(IntegrationConfig.TelegramConfig.builder()
          .chatId("chat_id")
          .build())
    ...
    @Test
    fun ofFigma() {
      val figma = IntegrationConfig.FigmaConfig.builder()
    ...
    fun ofFigmaRoundtrip() {
      val jsonMapper = jsonMapper()
      val integrationConfig = IntegrationConfig.ofFigma(IntegrationConfig.FigmaConfig.builder()
          .figmaFileId("figma_file_id")
          .build())
    ...
    @Test
    fun ofFramer() {
      val framer = IntegrationConfig.FramerConfig.builder()
    ...
    fun ofFramerRoundtrip() {
      val jsonMapper = jsonMapper()
      val integrationConfig = IntegrationConfig.ofFramer(IntegrationConfig.FramerConfig.builder()
          .framerTemplateId("framer_template_id")
          .build())
    ...
    @Test
    fun ofNotion() {
      val notion = IntegrationConfig.NotionConfig.builder()
    ...
    fun ofNotionRoundtrip() {
      val jsonMapper = jsonMapper()
      val integrationConfig = IntegrationConfig.ofNotion(IntegrationConfig.NotionConfig.builder()
          .notionTemplateId("notion_template_id")
          .build())
    ...
    @Test
    fun ofDigitalFiles() {
      val digitalFiles = IntegrationConfig.DigitalFilesConfig.builder()
    ...
    fun ofDigitalFilesRoundtrip() {
      val jsonMapper = jsonMapper()
      val integrationConfig = IntegrationConfig.ofDigitalFiles(IntegrationConfig.DigitalFilesConfig.builder()
          .addDigitalFileId("string")
          .externalUrl("external_url")
          .instructions("instructions")
          .addLegacyFileId("string")
    ...
    @Test
    fun ofLicenseKey() {
      val licenseKey = IntegrationConfig.LicenseKeyConfig.builder()
    ...
    fun ofLicenseKeyRoundtrip() {
      val jsonMapper = jsonMapper()
      val integrationConfig = IntegrationConfig.ofLicenseKey(IntegrationConfig.LicenseKeyConfig.builder()
          .activationMessage("activation_message")
          .activationsLimit(0)
          .durationCount(0)
          .durationInterval(TimeInterval.DAY)
    ...
    fun incompatibleJsonShapeDeserializesToUnknown(testCase: IncompatibleJsonShapeTestCase) {
      val integrationConfig = jsonMapper().convertValue(testCase.value, jacksonTypeRef<IntegrationConfig>())
