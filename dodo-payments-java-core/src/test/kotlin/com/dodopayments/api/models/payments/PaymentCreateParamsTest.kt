...
internal class PaymentCreateParamsTest {
    ...
    fun body() {
      ...
      assertThat(body.billing()).isEqualTo(BillingAddress.builder()
          .country(CountryCode.AF)
          .city("city")
          .state("state")
          .street("street")
          .zipcode("zipcode")
          .build())
      assertThat(body.customer()).isEqualTo(CustomerRequest.ofAttachExistingCustomer(AttachExistingCustomer.builder()
          .customerId("customer_id")
          .build()))
      assertThat(body.productCart()).containsExactly(OneTimeProductCartItem.builder()
          .productId("product_id")
          .quantity(0)
          .amount(0)
          .build())
      assertThat(body.adaptiveCurrencyFeesInclusive()).contains(true)
      assertThat(body.allowedPaymentMethodTypes().getOrNull()).containsExactly(PaymentMethodTypes.ACH)
      ...
      assertThat(body.metadata()).contains(PaymentCreateParams.Metadata.builder()
          .putAdditionalProperty("foo", JsonValue.from("string"))
          .build())
