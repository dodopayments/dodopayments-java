...
internal class SubscriptionOnHoldWebhookEventTest {
    ...
    @Test
    fun create() {
      val subscriptionOnHoldWebhookEvent = SubscriptionOnHoldWebhookEvent.builder()
      ...
      assertThat(subscriptionOnHoldWebhookEvent.data()).isEqualTo(Subscription.builder()
          .addAddon(AddonCartResponseItem.builder()
              .addonId("addon_id")
              .quantity(0)
              .build())
          ...
          .taxId("tax_id")
          .build())
      assertThat(subscriptionOnHoldWebhookEvent.timestamp()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedSubscriptionOnHoldWebhookEvent = jsonMapper.readValue(jsonMapper.writeValueAsString(subscriptionOnHoldWebhookEvent), jacksonTypeRef<SubscriptionOnHoldWebhookEvent>())

      assertThat(roundtrippedSubscriptionOnHoldWebhookEvent).isEqualTo(subscriptionOnHoldWebhookEvent)
    }
}
