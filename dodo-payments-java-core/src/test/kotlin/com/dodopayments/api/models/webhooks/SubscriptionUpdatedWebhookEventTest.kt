...
internal class SubscriptionUpdatedWebhookEventTest {
    ...
    @Test
    fun create() {
      val subscriptionUpdatedWebhookEvent = SubscriptionUpdatedWebhookEvent.builder()
      ...
      assertThat(subscriptionUpdatedWebhookEvent.data()).isEqualTo(Subscription.builder()
          .addAddon(AddonCartResponseItem.builder()
              .addonId("addon_id")
              .quantity(0)
              .build())
          ...
          .taxId("tax_id")
          .build())
      assertThat(subscriptionUpdatedWebhookEvent.timestamp()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedSubscriptionUpdatedWebhookEvent = jsonMapper.readValue(jsonMapper.writeValueAsString(subscriptionUpdatedWebhookEvent), jacksonTypeRef<SubscriptionUpdatedWebhookEvent>())

      assertThat(roundtrippedSubscriptionUpdatedWebhookEvent).isEqualTo(subscriptionUpdatedWebhookEvent)
    }
}
