...
internal class ProductUpdateParamsTest {
    ...
    @Test
    fun pathParams() {
      val params = ProductUpdateParams.builder()
          .id("id")
          .build()
    ...
    fun body() {
      ...
      assertThat(body.creditEntitlements().getOrNull()).containsExactly(AttachCreditEntitlement.builder()
          .creditEntitlementId("credit_entitlement_id")
          .creditsAmount("credits_amount")
          .currency(Currency.AED)
          .expiresAfterDays(0)
      ...
      assertThat(body.digitalProductDelivery()).contains(ProductUpdateParams.DigitalProductDelivery.builder()
          .externalUrl("external_url")
          .addFile("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .instructions("instructions")
          .build())
      assertThat(body.entitlements().getOrNull()).containsExactly(AttachProductEntitlement.builder()
          .entitlementId("entitlement_id")
          .build())
      ...
      assertThat(body.licenseKeyDuration()).contains(LicenseKeyDuration.builder()
          .count(0)
          .interval(TimeInterval.DAY)
          .build())
      assertThat(body.licenseKeyEnabled()).contains(true)
      assertThat(body.metadata()).contains(ProductUpdateParams.Metadata.builder()
          .putAdditionalProperty("foo", JsonValue.from("string"))
          .build())
      assertThat(body.name()).contains("name")
      assertThat(body.price()).contains(Price.ofOneTime(Price.OneTimePrice.builder()
          .currency(Currency.AED)
          .discount(0L)
          .price(0)
          .purchasingPowerParity(true)
