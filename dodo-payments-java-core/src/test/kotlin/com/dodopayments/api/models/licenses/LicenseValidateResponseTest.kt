...
internal class LicenseValidateResponseTest {
    ...
    @Test
    fun create() {
      val licenseValidateResponse = LicenseValidateResponse.builder()
          .valid(true)
          .build()
    ...
    fun roundtrip() {
      ...
      val roundtrippedLicenseValidateResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(licenseValidateResponse), jacksonTypeRef<LicenseValidateResponse>())
