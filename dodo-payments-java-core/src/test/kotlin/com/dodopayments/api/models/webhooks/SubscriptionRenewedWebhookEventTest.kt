...
internal class SubscriptionRenewedWebhookEventTest {
    ...
    @Test
    fun create() {
      val subscriptionRenewedWebhookEvent = SubscriptionRenewedWebhookEvent.builder()
      ...
      assertThat(subscriptionRenewedWebhookEvent.data()).isEqualTo(Subscription.builder()
          .addAddon(AddonCartResponseItem.builder()
              .addonId("addon_id")
              .quantity(0)
              .build())
          ...
          .taxId("tax_id")
          .build())
      assertThat(subscriptionRenewedWebhookEvent.timestamp()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedSubscriptionRenewedWebhookEvent = jsonMapper.readValue(jsonMapper.writeValueAsString(subscriptionRenewedWebhookEvent), jacksonTypeRef<SubscriptionRenewedWebhookEvent>())

      assertThat(roundtrippedSubscriptionRenewedWebhookEvent).isEqualTo(subscriptionRenewedWebhookEvent)
    }
}
