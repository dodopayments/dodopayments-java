...
internal class DunningStartedWebhookEventTest {
    ...
    @Test
    fun create() {
      val dunningStartedWebhookEvent = DunningStartedWebhookEvent.builder()
      ...
      assertThat(dunningStartedWebhookEvent.data()).isEqualTo(DunningStartedWebhookEvent.Data.builder()
          .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .customerId("customer_id")
          .status(DunningStartedWebhookEvent.Data.Status.RECOVERING)
          .subscriptionId("subscription_id")
          ...
          .paymentId("payment_id")
          .build())
      assertThat(dunningStartedWebhookEvent.timestamp()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedDunningStartedWebhookEvent = jsonMapper.readValue(jsonMapper.writeValueAsString(dunningStartedWebhookEvent), jacksonTypeRef<DunningStartedWebhookEvent>())
