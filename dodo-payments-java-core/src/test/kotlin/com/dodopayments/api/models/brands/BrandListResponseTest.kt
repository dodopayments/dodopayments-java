...
internal class BrandListResponseTest {
    ...
    @Test
    fun create() {
      val brandListResponse = BrandListResponse.builder()
          .addItem(Brand.builder()
              .brandId("brand_id")
      ...
      assertThat(brandListResponse.items()).containsExactly(Brand.builder()
          .brandId("brand_id")
          .businessId("business_id")
          .enabled(true)
          .statementDescriptor("statement_descriptor")
    ...
    fun roundtrip() {
      ...
      val roundtrippedBrandListResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(brandListResponse), jacksonTypeRef<BrandListResponse>())
