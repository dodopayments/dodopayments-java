...
internal class CreditEntitlementCartResponseTest {
    ...
    @Test
    fun create() {
      val creditEntitlementCartResponse = CreditEntitlementCartResponse.builder()
      ...
      assertThat(creditEntitlementCartResponse.creditEntitlementId()).isEqualTo("credit_entitlement_id")
      assertThat(creditEntitlementCartResponse.creditEntitlementName()).isEqualTo("credit_entitlement_name")
      ...
      assertThat(creditEntitlementCartResponse.overageBehavior()).isEqualTo(CbbOverageBehavior.FORGIVE_AT_RESET)
      ...
      assertThat(creditEntitlementCartResponse.rolloverTimeframeInterval()).contains(TimeInterval.DAY)
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedCreditEntitlementCartResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(creditEntitlementCartResponse), jacksonTypeRef<CreditEntitlementCartResponse>())

      assertThat(roundtrippedCreditEntitlementCartResponse).isEqualTo(creditEntitlementCartResponse)
    }
}
