...
internal class CheckoutSessionStatusTest {
    ...
    @Test
    fun create() {
      val checkoutSessionStatus = CheckoutSessionStatus.builder()
          .id("id")
      ...
      assertThat(checkoutSessionStatus.createdAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    ...
    fun roundtrip() {
      ...
      val roundtrippedCheckoutSessionStatus = jsonMapper.readValue(jsonMapper.writeValueAsString(checkoutSessionStatus), jacksonTypeRef<CheckoutSessionStatus>())
