...
internal class EntitlementGrantRevokedWebhookEventTest {
    ...
    @Test
    fun create() {
      val entitlementGrantRevokedWebhookEvent = EntitlementGrantRevokedWebhookEvent.builder()
      ...
      assertThat(entitlementGrantRevokedWebhookEvent.data()).isEqualTo(EntitlementGrant.builder()
          .id("id")
          .businessId("business_id")
          .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .customerId("customer_id")
          ...
          .subscriptionId("subscription_id")
          .build())
      assertThat(entitlementGrantRevokedWebhookEvent.timestamp()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedEntitlementGrantRevokedWebhookEvent = jsonMapper.readValue(jsonMapper.writeValueAsString(entitlementGrantRevokedWebhookEvent), jacksonTypeRef<EntitlementGrantRevokedWebhookEvent>())

      assertThat(roundtrippedEntitlementGrantRevokedWebhookEvent).isEqualTo(entitlementGrantRevokedWebhookEvent)
    }
}
