...
internal class RefundFailedWebhookEventTest {
    ...
    @Test
    fun create() {
      val refundFailedWebhookEvent = RefundFailedWebhookEvent.builder()
      ...
      assertThat(refundFailedWebhookEvent.data()).isEqualTo(Refund.builder()
          .businessId("business_id")
          .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .customer(CustomerLimitedDetails.builder()
              .customerId("customer_id")
          ...
          .reason("reason")
          .build())
      assertThat(refundFailedWebhookEvent.timestamp()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedRefundFailedWebhookEvent = jsonMapper.readValue(jsonMapper.writeValueAsString(refundFailedWebhookEvent), jacksonTypeRef<RefundFailedWebhookEvent>())
