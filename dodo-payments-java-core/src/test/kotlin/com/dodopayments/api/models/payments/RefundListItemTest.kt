...
internal class RefundListItemTest {
    ...
    @Test
    fun create() {
      val refundListItem = RefundListItem.builder()
      ...
      assertThat(refundListItem.createdAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    ...
    fun roundtrip() {
      ...
      val roundtrippedRefundListItem = jsonMapper.readValue(jsonMapper.writeValueAsString(refundListItem), jacksonTypeRef<RefundListItem>())
