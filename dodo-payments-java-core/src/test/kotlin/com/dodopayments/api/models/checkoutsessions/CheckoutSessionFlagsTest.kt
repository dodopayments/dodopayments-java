...
internal class CheckoutSessionFlagsTest {
    ...
    fun create() {
        ...
        assertThat(checkoutSessionFlags.allowEditingAddons()).contains(true)
        ...
        assertThat(checkoutSessionFlags.requireCardholderName()).contains(true)
        assertThat(checkoutSessionFlags.requirePhoneNumber()).contains(true)
        assertThat(checkoutSessionFlags.requireTaxId()).contains(true)
        assertThat(checkoutSessionFlags.singlePage()).contains(true)
    }
