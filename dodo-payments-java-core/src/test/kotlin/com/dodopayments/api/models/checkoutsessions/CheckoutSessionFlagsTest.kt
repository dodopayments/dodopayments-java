...
internal class CheckoutSessionFlagsTest {
    ...
    @Test
    fun create() {
      val checkoutSessionFlags = CheckoutSessionFlags.builder()
    ...
    fun roundtrip() {
      ...
      val roundtrippedCheckoutSessionFlags = jsonMapper.readValue(jsonMapper.writeValueAsString(checkoutSessionFlags), jacksonTypeRef<CheckoutSessionFlags>())
