...
internal class BreakupRetrieveResponseTest {
    ...
    @Test
    fun create() {
      val breakupRetrieveResponse = BreakupRetrieveResponse.builder()
    ...
    fun roundtrip() {
      ...
      val roundtrippedBreakupRetrieveResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(breakupRetrieveResponse), jacksonTypeRef<BreakupRetrieveResponse>())
