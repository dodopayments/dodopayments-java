...
internal class CustomerWalletTransactionTest {
    ...
    @Test
    fun create() {
      val customerWalletTransaction = CustomerWalletTransaction.builder()
          .id("id")
          .afterBalance(0L)
          .amount(0L)
          .beforeBalance(0L)
      ...
      assertThat(customerWalletTransaction.createdAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      assertThat(customerWalletTransaction.eventType()).isEqualTo(CustomerWalletTransaction.EventType.PAYMENT)
    ...
    fun roundtrip() {
      ...
      val roundtrippedCustomerWalletTransaction = jsonMapper.readValue(jsonMapper.writeValueAsString(customerWalletTransaction), jacksonTypeRef<CustomerWalletTransaction>())
