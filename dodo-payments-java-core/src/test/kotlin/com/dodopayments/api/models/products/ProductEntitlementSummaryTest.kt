...
internal class ProductEntitlementSummaryTest {
    ...
    @Test
    fun create() {
      val productEntitlementSummary = ProductEntitlementSummary.builder()
          .id("id")
      ...
      assertThat(productEntitlementSummary.integrationConfig()).isEqualTo(IntegrationConfigResponse.ofGitHubConfig(IntegrationConfigResponse.GitHubConfig.builder()
          .permission(GitHubPermission.PULL)
          .targetId("target_id")
          .build()))
      assertThat(productEntitlementSummary.integrationType()).isEqualTo(EntitlementIntegrationType.DISCORD)
    ...
    fun roundtrip() {
      ...
      val roundtrippedProductEntitlementSummary = jsonMapper.readValue(jsonMapper.writeValueAsString(productEntitlementSummary), jacksonTypeRef<ProductEntitlementSummary>())
