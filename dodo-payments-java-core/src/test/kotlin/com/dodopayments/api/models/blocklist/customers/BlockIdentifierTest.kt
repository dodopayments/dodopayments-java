...
internal class BlockIdentifierTest {
    ...
    fun ofByCustomerId() {
        ...
        assertThat(blockIdentifier.byCustomerId()).contains(byCustomerId)
        assertThat(blockIdentifier.byEmail()).isEmpty
    }
    ...
    fun ofByEmail() {
        ...
        assertThat(blockIdentifier.byCustomerId()).isEmpty
        assertThat(blockIdentifier.byEmail()).contains(byEmail)
    }
