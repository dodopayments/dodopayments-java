...
internal class PaymentProcessingWebhookEventTest {
    ...
    @Test
    fun create() {
      val paymentProcessingWebhookEvent = PaymentProcessingWebhookEvent.builder()
      ...
      assertThat(paymentProcessingWebhookEvent.data()).isEqualTo(Payment.builder()
          .billing(BillingAddress.builder()
              .country(CountryCode.AF)
              .city("city")
              .state("state")
          ...
          .updatedAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .build())
      assertThat(paymentProcessingWebhookEvent.timestamp()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedPaymentProcessingWebhookEvent = jsonMapper.readValue(jsonMapper.writeValueAsString(paymentProcessingWebhookEvent), jacksonTypeRef<PaymentProcessingWebhookEvent>())

      assertThat(roundtrippedPaymentProcessingWebhookEvent).isEqualTo(paymentProcessingWebhookEvent)
    }
}
