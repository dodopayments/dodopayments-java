...
internal class AddMeterToPriceTest {
    ...
    @Test
    fun create() {
      val addMeterToPrice = AddMeterToPrice.builder()
          .meterId("meter_id")
    ...
    fun roundtrip() {
      ...
      val roundtrippedAddMeterToPrice = jsonMapper.readValue(jsonMapper.writeValueAsString(addMeterToPrice), jacksonTypeRef<AddMeterToPrice>())
