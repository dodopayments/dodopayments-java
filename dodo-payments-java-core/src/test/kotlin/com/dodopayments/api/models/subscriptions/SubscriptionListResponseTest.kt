...
internal class SubscriptionListResponseTest {
    ...
    fun create() {
      val subscriptionListResponse = SubscriptionListResponse.builder()
          ...
          .customer(CustomerLimitedDetails.builder()
              ...
              .build())
          .addDiscount(SubscriptionListResponse.Discount.builder()
              .discountId("discount_id")
              .discountCyclesRemaining(0)
              .build())
          .metadata(SubscriptionListResponse.Metadata.builder()
              .putAdditionalProperty("foo", JsonValue.from("string"))
              .build())
      ...
      assertThat(subscriptionListResponse.billing()).isEqualTo(BillingAddress.builder()
          .country(CountryCode.AF)
          .city("city")
          .state("state")
          .street("street")
      ...
      assertThat(subscriptionListResponse.createdAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(subscriptionListResponse.currency()).isEqualTo(Currency.AED)
      assertThat(subscriptionListResponse.customer()).isEqualTo(CustomerLimitedDetails.builder()
          .customerId("customer_id")
          .email("email")
          .name("name")
          .metadata(CustomerLimitedDetails.Metadata.builder()
          ...
          .phoneNumber("phone_number")
          .build())
      assertThat(subscriptionListResponse.discounts()).containsExactly(SubscriptionListResponse.Discount.builder()
          .discountId("discount_id")
          .discountCyclesRemaining(0)
          .build())
      assertThat(subscriptionListResponse.metadata()).isEqualTo(SubscriptionListResponse.Metadata.builder()
          .putAdditionalProperty("foo", JsonValue.from("string"))
          .build())
      assertThat(subscriptionListResponse.nextBillingDate()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      assertThat(subscriptionListResponse.previousBillingDate()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      assertThat(subscriptionListResponse.subscriptionPeriodInterval()).isEqualTo(TimeInterval.DAY)
      ...
      assertThat(subscriptionListResponse.cancelledAt()).contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(subscriptionListResponse.customerBusinessName()).contains("customer_business_name")
      ...
      assertThat(subscriptionListResponse.scheduledChange()).contains(ScheduledPlanChange.builder()
          .id("id")
          .addAddon(ScheduledPlanChange.Addon.builder()
              .addonId("addon_id")
              .name("name")
    ...
    fun roundtrip() {
      ...
      val roundtrippedSubscriptionListResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(subscriptionListResponse), jacksonTypeRef<SubscriptionListResponse>())
