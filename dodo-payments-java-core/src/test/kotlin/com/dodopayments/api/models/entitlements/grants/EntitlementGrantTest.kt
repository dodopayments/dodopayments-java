...
internal class EntitlementGrantTest {
    ...
    @Test
    fun create() {
      val entitlementGrant = EntitlementGrant.builder()
          .id("id")
      ...
      assertThat(entitlementGrant.createdAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      assertThat(entitlementGrant.metadata()).isEqualTo(EntitlementGrant.Metadata.builder()
          .putAdditionalProperty("foo", JsonValue.from("string"))
          .build())
      assertThat(entitlementGrant.status()).isEqualTo(EntitlementGrant.Status.PENDING)
      assertThat(entitlementGrant.updatedAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(entitlementGrant.deliveredAt()).contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(entitlementGrant.digitalProductDelivery()).contains(DigitalProductDelivery.builder()
          .addFile(DigitalProductDeliveryFile.builder()
              .downloadUrl("download_url")
              .expiresIn(0L)
              .fileId("file_id")
      ...
      assertThat(entitlementGrant.licenseKey()).contains(LicenseKeyGrant.builder()
          .activationsUsed(0)
          .key("key")
          .activationsLimit(0)
          .expiresAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .build())
      assertThat(entitlementGrant.oauthExpiresAt()).contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      assertThat(entitlementGrant.revokedAt()).contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    ...
    fun roundtrip() {
      ...
      val roundtrippedEntitlementGrant = jsonMapper.readValue(jsonMapper.writeValueAsString(entitlementGrant), jacksonTypeRef<EntitlementGrant>())
