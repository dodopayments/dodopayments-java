...
internal class GrantListPageResponseTest {
    ...
    @Test
    fun create() {
      val grantListPageResponse = GrantListPageResponse.builder()
          .addItem(EntitlementGrant.builder()
              .id("id")
      ...
      assertThat(grantListPageResponse.items()).containsExactly(EntitlementGrant.builder()
          .id("id")
          .businessId("business_id")
          .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .customerId("customer_id")
    ...
    fun roundtrip() {
      ...
      val roundtrippedGrantListPageResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(grantListPageResponse), jacksonTypeRef<GrantListPageResponse>())
