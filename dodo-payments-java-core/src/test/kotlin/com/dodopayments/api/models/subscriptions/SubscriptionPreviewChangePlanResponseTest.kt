...
internal class SubscriptionPreviewChangePlanResponseTest {
    ...
    @Test
    fun create() {
      val subscriptionPreviewChangePlanResponse = SubscriptionPreviewChangePlanResponse.builder()
          .immediateCharge(SubscriptionPreviewChangePlanResponse.ImmediateCharge.builder()
              .effectiveAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
              .addLineItem(SubscriptionPreviewChangePlanResponse.ImmediateCharge.LineItem.Subscription.builder()
                  .id("id")
                  ...
                  .taxRate(0.0f)
                  .build())
              .summary(SubscriptionPreviewChangePlanResponse.ImmediateCharge.Summary.builder()
                  .currency(Currency.AED)
                  .customerCredits(0L)
                  .settlementAmount(0)
      ...
      assertThat(subscriptionPreviewChangePlanResponse.immediateCharge()).isEqualTo(SubscriptionPreviewChangePlanResponse.ImmediateCharge.builder()
          .effectiveAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .addLineItem(SubscriptionPreviewChangePlanResponse.ImmediateCharge.LineItem.Subscription.builder()
              .id("id")
              .currency(Currency.AED)
          ...
          .summary(SubscriptionPreviewChangePlanResponse.ImmediateCharge.Summary.builder()
              ...
              .build())
          .build())
      assertThat(subscriptionPreviewChangePlanResponse.newPlan()).isEqualTo(Subscription.builder()
          .addAddon(AddonCartResponseItem.builder()
              .addonId("addon_id")
              .quantity(0)
              .build())
    ...
    fun roundtrip() {
      ...
      val roundtrippedSubscriptionPreviewChangePlanResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(subscriptionPreviewChangePlanResponse), jacksonTypeRef<SubscriptionPreviewChangePlanResponse>())

      assertThat(roundtrippedSubscriptionPreviewChangePlanResponse).isEqualTo(subscriptionPreviewChangePlanResponse)
    }
}
