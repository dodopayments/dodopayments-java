...
internal class PayoutListResponseTest {
    ...
    @Test
    fun create() {
      val payoutListResponse = PayoutListResponse.builder()
          .amount(0L)
      ...
      assertThat(payoutListResponse.createdAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      assertThat(payoutListResponse.updatedAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(payoutListResponse.name()).contains("name")
      assertThat(payoutListResponse.payoutDocumentUrl()).contains("payout_document_url")
      assertThat(payoutListResponse.remarks()).contains("remarks")
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedPayoutListResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(payoutListResponse), jacksonTypeRef<PayoutListResponse>())
