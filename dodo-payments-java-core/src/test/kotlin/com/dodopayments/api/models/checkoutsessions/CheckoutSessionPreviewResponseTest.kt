...
internal class CheckoutSessionPreviewResponseTest {
    ...
    fun create() {
        ...
        assertThat(checkoutSessionPreviewResponse.taxIdFormatName()).contains("tax_id_format_name")
        assertThat(checkoutSessionPreviewResponse.totalTax()).contains(0)
        assertThat(checkoutSessionPreviewResponse.trialAmount()).contains(0)
        assertThat(checkoutSessionPreviewResponse.trialPeriodDays()).contains(0)
    }
