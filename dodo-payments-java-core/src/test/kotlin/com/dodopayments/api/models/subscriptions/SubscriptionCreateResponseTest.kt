...
internal class SubscriptionCreateResponseTest {
    ...
    fun create() {
      val subscriptionCreateResponse = SubscriptionCreateResponse.builder()
          ...
          .addOneTimeProductCart(SubscriptionCreateResponse.OneTimeProductCart.builder()
      ...
      assertThat(subscriptionCreateResponse.addons()).containsExactly(AddonCartResponseItem.builder()
          .addonId("addon_id")
          .quantity(0)
          .build())
      assertThat(subscriptionCreateResponse.customer()).isEqualTo(CustomerLimitedDetails.builder()
          .customerId("customer_id")
          .email("email")
          .name("name")
          .metadata(CustomerLimitedDetails.Metadata.builder()
      ...
      assertThat(subscriptionCreateResponse.expiresOn()).contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(subscriptionCreateResponse.oneTimeProductCart().getOrNull()).containsExactly(SubscriptionCreateResponse.OneTimeProductCart.builder()
          .productId("product_id")
          .quantity(0)
          .build())
    ...
    fun roundtrip() {
      ...
      val roundtrippedSubscriptionCreateResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(subscriptionCreateResponse), jacksonTypeRef<SubscriptionCreateResponse>())
