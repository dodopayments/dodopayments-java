...
internal class PaymentSucceededWebhookEventTest {
    ...
    @Test
    fun create() {
      val paymentSucceededWebhookEvent = PaymentSucceededWebhookEvent.builder()
      ...
      assertThat(paymentSucceededWebhookEvent.data()).isEqualTo(Payment.builder()
          .billing(BillingAddress.builder()
              .country(CountryCode.AF)
              .city("city")
              .state("state")
          ...
          .updatedAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .build())
      assertThat(paymentSucceededWebhookEvent.timestamp()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedPaymentSucceededWebhookEvent = jsonMapper.readValue(jsonMapper.writeValueAsString(paymentSucceededWebhookEvent), jacksonTypeRef<PaymentSucceededWebhookEvent>())
