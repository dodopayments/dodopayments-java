...
internal class ShortLinkListResponseTest {
    ...
    @Test
    fun create() {
      val shortLinkListResponse = ShortLinkListResponse.builder()
      ...
      assertThat(shortLinkListResponse.createdAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    ...
    fun roundtrip() {
      ...
      val roundtrippedShortLinkListResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(shortLinkListResponse), jacksonTypeRef<ShortLinkListResponse>())
