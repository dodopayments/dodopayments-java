...
internal class EntitlementGrantCreatedWebhookEventTest {
    ...
    @Test
    fun create() {
      val entitlementGrantCreatedWebhookEvent = EntitlementGrantCreatedWebhookEvent.builder()
      ...
      assertThat(entitlementGrantCreatedWebhookEvent.data()).isEqualTo(EntitlementGrant.builder()
          .id("id")
          .businessId("business_id")
          .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .customerId("customer_id")
          ...
          .subscriptionId("subscription_id")
          .build())
      assertThat(entitlementGrantCreatedWebhookEvent.timestamp()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedEntitlementGrantCreatedWebhookEvent = jsonMapper.readValue(jsonMapper.writeValueAsString(entitlementGrantCreatedWebhookEvent), jacksonTypeRef<EntitlementGrantCreatedWebhookEvent>())

      assertThat(roundtrippedEntitlementGrantCreatedWebhookEvent).isEqualTo(entitlementGrantCreatedWebhookEvent)
    }
}
