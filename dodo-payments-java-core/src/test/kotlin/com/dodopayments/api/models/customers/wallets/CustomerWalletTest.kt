...
internal class CustomerWalletTest {
    ...
    @Test
    fun create() {
      val customerWallet = CustomerWallet.builder()
          .balance(0L)
      ...
      assertThat(customerWallet.createdAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(customerWallet.currency()).isEqualTo(Currency.AED)
      assertThat(customerWallet.customerId()).isEqualTo("customer_id")
      assertThat(customerWallet.updatedAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedCustomerWallet = jsonMapper.readValue(jsonMapper.writeValueAsString(customerWallet), jacksonTypeRef<CustomerWallet>())
