...
internal class BrandCreateResponseTest {
    ...
    fun create() {
        ...
        assertThat(brandCreateResponse.description()).contains("description")
        assertThat(brandCreateResponse.image()).contains("image")
        assertThat(brandCreateResponse.name()).contains("name")
        assertThat(brandCreateResponse.reasonForHold()).contains("reason_for_hold")
        assertThat(brandCreateResponse.supportEmail()).contains("support_email")
        assertThat(brandCreateResponse.url()).contains("url")
    }
