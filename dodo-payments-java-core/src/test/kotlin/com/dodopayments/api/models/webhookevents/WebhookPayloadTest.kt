...
internal class WebhookPayloadTest {
    ...
    @Test
    fun create() {
      val webhookPayload = WebhookPayload.builder()
      ...
      assertThat(webhookPayload.data()).isEqualTo(WebhookPayload.Data.ofPayment(WebhookPayload.Data.Payment.builder()
          .billing(BillingAddress.builder()
              .country(CountryCode.AF)
              .city("city")
              .state("state")
          ...
          .updatedAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .build()))
      assertThat(webhookPayload.timestamp()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    ...
    fun roundtrip() {
      ...
      val roundtrippedWebhookPayload = jsonMapper.readValue(jsonMapper.writeValueAsString(webhookPayload), jacksonTypeRef<WebhookPayload>())
