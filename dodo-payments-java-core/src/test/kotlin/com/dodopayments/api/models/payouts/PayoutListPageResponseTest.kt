...
internal class PayoutListPageResponseTest {
    ...
    @Test
    fun create() {
      val payoutListPageResponse = PayoutListPageResponse.builder()
          .addItem(PayoutListResponse.builder()
              .amount(0L)
      ...
      assertThat(payoutListPageResponse.items()).containsExactly(PayoutListResponse.builder()
          .amount(0L)
          .businessId("business_id")
          .chargebacks(0L)
          .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    ...
    fun roundtrip() {
      ...
      val roundtrippedPayoutListPageResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(payoutListPageResponse), jacksonTypeRef<PayoutListPageResponse>())
