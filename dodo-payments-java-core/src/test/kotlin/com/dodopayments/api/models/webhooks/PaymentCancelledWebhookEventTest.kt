...
internal class PaymentCancelledWebhookEventTest {
    ...
    @Test
    fun create() {
      val paymentCancelledWebhookEvent = PaymentCancelledWebhookEvent.builder()
      ...
      assertThat(paymentCancelledWebhookEvent.data()).isEqualTo(Payment.builder()
          .billing(BillingAddress.builder()
              .country(CountryCode.AF)
              .city("city")
              .state("state")
          ...
          .updatedAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .build())
      assertThat(paymentCancelledWebhookEvent.timestamp()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedPaymentCancelledWebhookEvent = jsonMapper.readValue(jsonMapper.writeValueAsString(paymentCancelledWebhookEvent), jacksonTypeRef<PaymentCancelledWebhookEvent>())
