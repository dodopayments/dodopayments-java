...
internal class ThemeModeConfigTest {
    ...
    @Test
    fun create() {
      val themeModeConfig = ThemeModeConfig.builder()
    ...
    fun roundtrip() {
      ...
      val roundtrippedThemeModeConfig = jsonMapper.readValue(jsonMapper.writeValueAsString(themeModeConfig), jacksonTypeRef<ThemeModeConfig>())
