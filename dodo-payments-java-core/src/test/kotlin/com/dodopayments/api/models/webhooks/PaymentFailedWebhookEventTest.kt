...
internal class PaymentFailedWebhookEventTest {
    ...
    @Test
    fun create() {
      val paymentFailedWebhookEvent = PaymentFailedWebhookEvent.builder()
      ...
      assertThat(paymentFailedWebhookEvent.data()).isEqualTo(Payment.builder()
          .billing(BillingAddress.builder()
              .country(CountryCode.AF)
              .city("city")
              .state("state")
          ...
          .updatedAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .build())
      assertThat(paymentFailedWebhookEvent.timestamp()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedPaymentFailedWebhookEvent = jsonMapper.readValue(jsonMapper.writeValueAsString(paymentFailedWebhookEvent), jacksonTypeRef<PaymentFailedWebhookEvent>())
