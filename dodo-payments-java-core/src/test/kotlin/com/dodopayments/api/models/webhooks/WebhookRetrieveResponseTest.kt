...
internal class WebhookRetrieveResponseTest {
    ...
    fun create() {
        ...
        assertThat(webhookRetrieveResponse.disabled()).contains(true)
        assertThat(webhookRetrieveResponse.filterTypes().getOrNull()).containsExactly("string")
        assertThat(webhookRetrieveResponse.rateLimit()).contains(0)
    }
