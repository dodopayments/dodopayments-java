...
internal class RefundTest {
    ...
    fun create() {
      ...
      assertThat(refund.customer()).isEqualTo(CustomerLimitedDetails.builder()
          .customerId("customer_id")
          .email("email")
          .name("name")
          .metadata(CustomerLimitedDetails.Metadata.builder()
      ...
      assertThat(refund.metadata()).isEqualTo(Refund.Metadata.builder()
          .putAdditionalProperty("foo", JsonValue.from("string"))
          .build())
    ...
    fun roundtrip() {
      ...
      val roundtrippedRefund = jsonMapper.readValue(jsonMapper.writeValueAsString(refund), jacksonTypeRef<Refund>())
