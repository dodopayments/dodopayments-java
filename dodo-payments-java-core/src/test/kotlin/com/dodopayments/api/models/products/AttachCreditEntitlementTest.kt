...
internal class AttachCreditEntitlementTest {
    ...
    @Test
    fun create() {
      val attachCreditEntitlement = AttachCreditEntitlement.builder()
      ...
      assertThat(attachCreditEntitlement.overageBehavior()).contains(CbbOverageBehavior.FORGIVE_AT_RESET)
      ...
      assertThat(attachCreditEntitlement.prorationBehavior()).contains(CbbProrationBehavior.PRORATE)
    ...
    fun roundtrip() {
      ...
      val roundtrippedAttachCreditEntitlement = jsonMapper.readValue(jsonMapper.writeValueAsString(attachCreditEntitlement), jacksonTypeRef<AttachCreditEntitlement>())
