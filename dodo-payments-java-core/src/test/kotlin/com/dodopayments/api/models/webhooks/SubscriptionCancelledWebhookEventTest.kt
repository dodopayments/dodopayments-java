...
internal class SubscriptionCancelledWebhookEventTest {
    ...
    @Test
    fun create() {
      val subscriptionCancelledWebhookEvent = SubscriptionCancelledWebhookEvent.builder()
      ...
      assertThat(subscriptionCancelledWebhookEvent.data()).isEqualTo(Subscription.builder()
          .addAddon(AddonCartResponseItem.builder()
              .addonId("addon_id")
              .quantity(0)
              .build())
          ...
          .taxId("tax_id")
          .build())
      assertThat(subscriptionCancelledWebhookEvent.timestamp()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedSubscriptionCancelledWebhookEvent = jsonMapper.readValue(jsonMapper.writeValueAsString(subscriptionCancelledWebhookEvent), jacksonTypeRef<SubscriptionCancelledWebhookEvent>())

      assertThat(roundtrippedSubscriptionCancelledWebhookEvent).isEqualTo(subscriptionCancelledWebhookEvent)
    }
}
