...
internal class RefundSucceededWebhookEventTest {
    ...
    @Test
    fun create() {
      val refundSucceededWebhookEvent = RefundSucceededWebhookEvent.builder()
      ...
      assertThat(refundSucceededWebhookEvent.data()).isEqualTo(Refund.builder()
          .businessId("business_id")
          .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .customer(CustomerLimitedDetails.builder()
              .customerId("customer_id")
          ...
          .reason("reason")
          .build())
      assertThat(refundSucceededWebhookEvent.timestamp()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedRefundSucceededWebhookEvent = jsonMapper.readValue(jsonMapper.writeValueAsString(refundSucceededWebhookEvent), jacksonTypeRef<RefundSucceededWebhookEvent>())
