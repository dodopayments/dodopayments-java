...
internal class LicenseKeyGrantTest {
    ...
    @Test
    fun create() {
      val licenseKeyGrant = LicenseKeyGrant.builder()
          .activationsUsed(0)
          .key("key")
          .activationsLimit(0)
      ...
      assertThat(licenseKeyGrant.expiresAt()).contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedLicenseKeyGrant = jsonMapper.readValue(jsonMapper.writeValueAsString(licenseKeyGrant), jacksonTypeRef<LicenseKeyGrant>())
