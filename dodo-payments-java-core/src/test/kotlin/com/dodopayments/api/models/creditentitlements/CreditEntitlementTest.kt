...
internal class CreditEntitlementTest {
    ...
    @Test
    fun create() {
      val creditEntitlement = CreditEntitlement.builder()
          .id("id")
      ...
      assertThat(creditEntitlement.createdAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(creditEntitlement.name()).isEqualTo("name")
      assertThat(creditEntitlement.overageBehavior()).isEqualTo(CbbOverageBehavior.FORGIVE_AT_RESET)
      ...
      assertThat(creditEntitlement.updatedAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    ...
    fun roundtrip() {
      ...
      val roundtrippedCreditEntitlement = jsonMapper.readValue(jsonMapper.writeValueAsString(creditEntitlement), jacksonTypeRef<CreditEntitlement>())
