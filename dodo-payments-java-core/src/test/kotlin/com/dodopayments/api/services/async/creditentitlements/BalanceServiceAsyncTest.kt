...
internal class BalanceServiceAsyncTest {
    ...
    fun retrieve() {
      ...
      val customerCreditBalanceFuture = balanceServiceAsync.retrieve(BalanceRetrieveParams.builder()
    ...
    fun createLedgerEntry() {
      ...
      val responseFuture = balanceServiceAsync.createLedgerEntry(BalanceCreateLedgerEntryParams.builder()
          .creditEntitlementId("credit_entitlement_id")
          .customerId("customer_id")
          .amount("amount")
          ...
          .metadata(BalanceCreateLedgerEntryParams.Metadata.builder()
    ...
    fun listGrants() {
      ...
      val pageFuture = balanceServiceAsync.listGrants(BalanceListGrantsParams.builder()
          .creditEntitlementId("credit_entitlement_id")
          .customerId("customer_id")
          .build())
    ...
    fun listLedger() {
      ...
      val pageFuture = balanceServiceAsync.listLedger(BalanceListLedgerParams.builder()
          .creditEntitlementId("credit_entitlement_id")
          .customerId("customer_id")
          .build())
