...
internal class EntitlementServiceAsyncTest {
    ...
    fun create() {
      ...
      val entitlementFuture = entitlementServiceAsync.create(EntitlementCreateParams.builder()
    ...
    fun update() {
      ...
      val entitlementFuture = entitlementServiceAsync.update(EntitlementUpdateParams.builder()
          .id("id")
          .description("description")
          .integrationConfig(IntegrationConfig.GitHubConfig.builder()
              .permission(GitHubPermission.PULL)
