...
internal class DiscountServiceAsyncTest {
    ...
    fun create() {
      ...
      val discountFuture = discountServiceAsync.create(DiscountCreateParams.builder()
          .amount(0)
    ...
    fun retrieve() {
      ...
      val discountFuture = discountServiceAsync.retrieve("discount_id")
    ...
    fun update() {
      ...
      val discountFuture = discountServiceAsync.update(DiscountUpdateParams.builder()
    ...
    fun delete() {
      ...
      val future = discountServiceAsync.delete("discount_id")
