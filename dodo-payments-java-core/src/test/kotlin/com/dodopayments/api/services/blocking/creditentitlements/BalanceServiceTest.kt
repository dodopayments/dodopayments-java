...
internal class BalanceServiceTest {
    ...
    fun retrieve() {
      ...
      val customerCreditBalance = balanceService.retrieve(BalanceRetrieveParams.builder()
    ...
    fun createLedgerEntry() {
      ...
      val response = balanceService.createLedgerEntry(BalanceCreateLedgerEntryParams.builder()
          .creditEntitlementId("credit_entitlement_id")
          .customerId("customer_id")
          .amount("amount")
    ...
    fun listGrants() {
      ...
      val page = balanceService.listGrants(BalanceListGrantsParams.builder()
          .creditEntitlementId("credit_entitlement_id")
          .customerId("customer_id")
          .build())
    ...
    fun listLedger() {
      ...
      val page = balanceService.listLedger(BalanceListLedgerParams.builder()
          .creditEntitlementId("credit_entitlement_id")
          .customerId("customer_id")
          .build())
