...
internal class ProductCollectionServiceAsyncTest {
    ...
    fun create() {
      ...
      val productCollectionFuture = productCollectionServiceAsync.create(ProductCollectionCreateParams.builder()
    ...
    fun update() {
      ...
      val future = productCollectionServiceAsync.update(ProductCollectionUpdateParams.builder()
          .id("id")
          .brandId("brand_id")
          .description("description")
    ...
    fun updateImages() {
      ...
      val responseFuture = productCollectionServiceAsync.updateImages(ProductCollectionUpdateImagesParams.builder()
          .id("id")
          .forceUpdate(true)
          .build())
