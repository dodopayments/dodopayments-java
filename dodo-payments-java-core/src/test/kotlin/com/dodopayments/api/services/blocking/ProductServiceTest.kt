...
internal class ProductServiceTest {
    ...
    fun create() {
      ...
      val product = productService.create(ProductCreateParams.builder()
          .name("name")
    ...
    fun update() {
      ...
      productService.update(ProductUpdateParams.builder()
          .id("id")
          .addAddon("string")
          .brandId("brand_id")
          .addCreditEntitlement(AttachCreditEntitlement.builder()
    ...
    fun updateFiles() {
      ...
      val response = productService.updateFiles(ProductUpdateFilesParams.builder()
          .id("id")
          .fileName("file_name")
          .build())
