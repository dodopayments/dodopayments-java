...
internal class CheckoutSessionServiceTest {
    ...
    fun create() {
      ...
      val checkoutSessionResponse = checkoutSessionService.create(CheckoutSessionRequest.builder()
    ...
    fun preview() {
      ...
      val response = checkoutSessionService.preview(CheckoutSessionRequest.builder()
          .addProductCart(ProductItemReq.builder()
              .productId("product_id")
              .quantity(0)
              .addAddon(AttachAddon.builder()
