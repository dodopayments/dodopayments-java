...
internal class CreditEntitlementServiceAsyncTest {
    ...
    fun create() {
      ...
      val creditEntitlementFuture = creditEntitlementServiceAsync.create(CreditEntitlementCreateParams.builder()
          .name("name")
          .overageEnabled(true)
          .precision(0)
    ...
    fun update() {
      ...
      val future = creditEntitlementServiceAsync.update(CreditEntitlementUpdateParams.builder()
          .id("id")
          .currency(Currency.AED)
          .description("description")
          .expiresAfterDays(0)
