...
internal class LicenseServiceAsyncTest {
    ...
    fun activate() {
      ...
      val responseFuture = licenseServiceAsync.activate(LicenseActivateParams.builder()
    ...
    fun deactivate() {
      ...
      val future = licenseServiceAsync.deactivate(LicenseDeactivateParams.builder()
          .licenseKey("license_key")
    ...
    fun validate() {
      ...
      val responseFuture = licenseServiceAsync.validate(LicenseValidateParams.builder()
