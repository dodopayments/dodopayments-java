...
internal class CheckoutSessionServiceAsyncTest {
    ...
    fun create() {
      ...
      val checkoutSessionResponseFuture = checkoutSessionServiceAsync.create(CheckoutSessionRequest.builder()
    ...
    fun preview() {
      ...
      val responseFuture = checkoutSessionServiceAsync.preview(CheckoutSessionRequest.builder()
          .addProductCart(ProductItemReq.builder()
              .productId("product_id")
              .quantity(0)
              .addAddon(AttachAddon.builder()
