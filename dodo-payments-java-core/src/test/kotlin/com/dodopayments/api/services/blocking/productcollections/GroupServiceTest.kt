...
internal class GroupServiceTest {
    ...
    fun create() {
      ...
      val productCollectionGroupResponse = groupService.create(GroupCreateParams.builder()
          .id("id")
    ...
    fun update() {
      ...
      groupService.update(GroupUpdateParams.builder()
          .id("id")
    ...
    fun delete() {
      ...
      groupService.delete(GroupDeleteParams.builder()
          .id("id")
          .groupId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .build())
    }
